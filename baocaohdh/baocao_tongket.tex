...
\textbf{Sinh viên:}             & Nguyễn Sỹ Tuấn  & 20224191 \\
                                & Lê Huy Sơn      & 20224128 \\
                                & Vũ Tiến Long    & 20224046 \\[0.8em]
\textbf{Lớp:}                  & 169227           & \\[0.3em]
\textbf{Giảng viên hướng dẫn:} & Phạm Văn Tiến   & \\[0.3em]
...
\begin{tabularx}{\textwidth}{|c|p{3.6cm}|X|c|}
\hline
\rowcolor{gray!18}
\textbf{STT} & \textbf{Thành viên} & \textbf{Nội dung công việc} & \textbf{Tiến độ} \\
\hline
1  & \multirow{3}{*}{\shortstack[c]{\textbf{Nguyễn Sỹ Tuấn}\\[2pt]{\small 20224191}}}
   & v2 -- Bulk Copy                                         & 15\% \\
\cline{1-1}\cline{3-4}
...
\hline
5  & \multirow{3}{*}{\shortstack[c]{\textbf{Lê Huy Sơn}\\[2pt]{\small 20224128}}}
...
\hline
8  & \multirow{3}{*}{\shortstack[c]{\textbf{Vũ Tiến Long}\\[2pt]{\small 20224046}}}
   & v5 -- Lazy Wakeup                                       & 15\% \\
\cline{1-1}\cline{3-4}
...
Source code: \url{https://github.com/Tuan17012004/Increase-IPC-throughput-by-optimizing-pipe-implementation-25236-/tree/riscv} \\
Design thinking: \url{https://www.figma.com/design/KCMP6KrnhMfDr0ih8MzO8K/Tu%E1%BA%A5n-Nguy%E1%BB%85n-S%E1%BB%B9-s-team-library?node-id=3326-2&t=HB3l9eBAuJUoaSYp-1} \\
Project Management: \url{https://tuanns1701.atlassian.net/jira/software/projects/KAN/list?jql=project+%3D+KAN+ORDER+BY+created+DESC&atlOrigin=eyJpIjoiN2NmNGVhYTJkZmI2NDkzYWFkNTI0MmRhNmVlNmUyYmIiLCJwIjoiaiJ9}
\newpage

...
0000000080000060 <start>:
{
  ...
  x &= ~MSTATUS_MPP_MASK;
    ...
    8000006e:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffdda97>
...
consoleinit(void)
{
  ...
  devsw[CONSOLE].read = consoleread;
    ...
    80000448:	78c78793          	addi	a5,a5,1932 # 8001fbd0 <devsw>
...
kfree(void *pa)
{
  ...
  if(((uint64)pa % PGSIZE) != 0 || (char*)pa < end || (uint64)pa >= PHYSTOP)
    ...
    80000a34:	33878793          	addi	a5,a5,824 # 80020d68 <end>
...
0000000080000aca <kinit>:
{
  ...
  freerange(end, (void*)PHYSTOP);
    ...
    80000aee:	27e50513          	addi	a0,a0,638 # 80020d68 <end>
    ...
    80000d0e:	00c587b3          	add	a5,a1,a2
{
    ...
    80000d16:	0705                	addi	a4,a4,1 # fffffffffffff001 <end+0xffffffff7ffde299>
...
main()
{
  ...
  scheduler();        
    ...
    binit();         // buffer cache
    80000eca:	3d5010ef          	jal	80002a9e <binit>
    iinit();         // inode table
    80000ece:	15a020ef          	jal	80003028 <iinit>
    fileinit();      // file table
    80000ed2:	04c030ef          	jal	80003f1e <fileinit>
    virtio_disk_init(); // emulated hard disk
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  for(int level = 2; level > 0; level--) {
    80000f6a:	3a5d                	addiw	s4,s4,-9 # ffffffffffffeff7 <end+0xffffffff7ffde28f>
...
proc_mapstacks(pagetable_t kpgtbl)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001778:	9bd90913          	addi	s2,s2,-1603 # ffffffffff4de9bd <end+0xffffffff7f4bdc55>
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000179a:	1f2a8a93          	addi	s5,s5,498 # 80015988 <tickslock>
    char *pa = kalloc();
...
procinit(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000183e:	9bd90913          	addi	s2,s2,-1603 # ffffffffff4de9bd <end+0xffffffff7f4bdc55>
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001860:	12ca0a13          	addi	s4,s4,300 # 80015988 <tickslock>
      initlock(&p->lock, "proc");
    ...
    8000187a:	2785                	addiw	a5,a5,1 # fffffffffffff001 <end+0xffffffff7ffde299>
...
forkret(void)
{
  ...
  if (first) {
    ...
    8000191e:	3c7010ef          	jal	800034e4 <fsinit>
    ...
    80001942:	4a3020ef          	jal	800045e4 <kexec>
  ...
  prepare_return();
    80001954:	2cd000ef          	jal	80002420 <prepare_return>
...
0000000080001a9e <freeproc>:
{
  ...
  p->priority = PRIORITY_BASE;  // Cơ chế 11: reset priority khi free
    80001ae0:	1604a423          	sw	zero,360(s1)
  p->state = UNUSED;
...
0000000080001af2 <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001b02:	28a48493          	addi	s1,s1,650 # 8000fd88 <proc>
    80001b06:	00014917          	auipc	s2,0x14
    80001b0a:	e8290913          	addi	s2,s2,-382 # 80015988 <tickslock>
    acquire(&p->lock);
  ...
  p->priority = PRIORITY_BASE;
    80001b34:	1604a423          	sw	zero,360(s1)
...
0000000080001b9c <userinit>:
{
  ...
  initproc = p;
    ...
    80001bb0:	caa7b223          	sd	a0,-860(a5) # 80007850 <initproc>
  p->cwd = namei("/");
    80001bb4:	00005517          	auipc	a0,0x5
    80001bb8:	5dc50513          	addi	a0,a0,1500 # 80007190 <etext+0x190>
    80001bbc:	64b010ef          	jal	80003a06 <namei>
...
0000000080001c3a <kfork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  acquire(&wait_lock);
    ...
    80001d0a:	c6a48493          	addi	s1,s1,-918 # 8000f970 <wait_lock>
...
0000000080001d48 <scheduler>:
{
  ...
  c->proc = 0;
    ...
    80001d6c:	bf070713          	addi	a4,a4,-1040 # 8000f958 <pid_lock>
    80001d70:	975a                	add	a4,a4,s6
    80001d72:	02073823          	sd	zero,48(a4)
        swtch(&c->context, &p->context);
    80001d76:	0000e717          	auipc	a4,0xe
    80001d7a:	c1a70713          	addi	a4,a4,-998 # 8000f990 <cpus+0x8>
    ...
    80001d88:	bd4a0a13          	addi	s4,s4,-1068 # 8000f958 <pid_lock>
    80001d8c:	9a3e                	add	s4,s4,a5
        found = 1;
    80001d8e:	4b85                	li	s7,1
    for(p = proc; p < &proc[NPROC]; p++) {
    80001d90:	00014997          	auipc	s3,0x14
    80001d94:	bf898993          	addi	s3,s3,-1032 # 80015988 <tickslock>
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001df2:	f9a48493          	addi	s1,s1,-102 # 8000fd88 <proc>
      if(p->state == RUNNABLE) {
...
0000000080001dfa <sched>:
{
  ...
  if(mycpu()->noff != 1)
    ...
    80001e1e:	b3e70713          	addi	a4,a4,-1218 # 8000f958 <pid_lock>
  ...
  intena = mycpu()->intena;
    ...
    80001e44:	b1890913          	addi	s2,s2,-1256 # 8000f958 <pid_lock>
  ...
  swtch(&p->context, &mycpu()->context);
    ...
    80001e5c:	b3858593          	addi	a1,a1,-1224 # 8000f990 <cpus+0x8>
  ...
  mycpu()->intena = intena;
    ...
    80001e88:	31450513          	addi	a0,a0,788 # 80007198 <etext+0x198>
    80001e8c:	955fe0ef          	jal	800007e0 <panic>
    panic("sched locks");
    80001e90:	00005517          	auipc	a0,0x5
    80001e94:	31850513          	addi	a0,a0,792 # 800071a8 <etext+0x1a8>
    80001e98:	949fe0ef          	jal	800007e0 <panic>
    panic("sched RUNNING");
    80001e9c:	00005517          	auipc	a0,0x5
    80001ea0:	31c50513          	addi	a0,a0,796 # 800071b8 <etext+0x1b8>
    80001ea4:	93dfe0ef          	jal	800007e0 <panic>
    panic("sched interruptible");
    80001ea8:	00005517          	auipc	a0,0x5
    80001eac:	32050513          	addi	a0,a0,800 # 800071c8 <etext+0x1c8>
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001f44:	e4848493          	addi	s1,s1,-440 # 8000fd88 <proc>
    if(p != myproc()){
      acquire(&p->lock);
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001f50:	a3c90913          	addi	s2,s2,-1476 # 80015988 <tickslock>
...
0000000080001f96 <reparent>:
{
  ...
  for(pp = proc; pp < &proc[NPROC]; pp++){
    ...
    80001fac:	de048493          	addi	s1,s1,-544 # 8000fd88 <proc>
      pp->parent = initproc;
    80001fb0:	00006a17          	auipc	s4,0x6
    80001fb4:	8a0a0a13          	addi	s4,s4,-1888 # 80007850 <initproc>
  for(pp = proc; pp < &proc[NPROC]; pp++){
    80001fb8:	00014997          	auipc	s3,0x14
    80001fbc:	9d098993          	addi	s3,s3,-1584 # 80015988 <tickslock>
...
0000000080001fec <kexit>:
{
  ...
  if(p == initproc)
    ...
    80002008:	84c7b783          	ld	a5,-1972(a5) # 80007850 <initproc>
    ...
    8000201c:	1c850513          	addi	a0,a0,456 # 800071e0 <etext+0x1e0>
    80002020:	fc0fe0ef          	jal	800007e0 <panic>
      fileclose(f);
    80002024:	7c3010ef          	jal	80003fe6 <fileclose>
      p->ofile[fd] = 0;
  ...
  begin_op();
    80002038:	3a3010ef          	jal	80003bda <begin_op>
  iput(p->cwd);
    8000203c:	1509b503          	ld	a0,336(s3)
    80002040:	332010ef          	jal	80003372 <iput>
  end_op();
    80002044:	401010ef          	jal	80003c44 <end_op>
  p->cwd = 0;
    80002048:	1409b823          	sd	zero,336(s3)
  acquire(&wait_lock);
    8000204c:	0000e497          	auipc	s1,0xe
    80002050:	92448493          	addi	s1,s1,-1756 # 8000f970 <wait_lock>
  ...
  panic("zombie exit");
    ...
    80002086:	16e50513          	addi	a0,a0,366 # 800071f0 <etext+0x1f0>
...
kkill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800020a2:	cea48493          	addi	s1,s1,-790 # 8000fd88 <proc>
    800020a6:	00014997          	auipc	s3,0x14
    800020aa:	8e298993          	addi	s3,s3,-1822 # 80015988 <tickslock>
    acquire(&p->lock);
...
0000000080002142 <kwait>:
{
  ...
  acquire(&wait_lock);
    ...
    80002166:	80e50513          	addi	a0,a0,-2034 # 8000f970 <wait_lock>
    ...
    80002178:	81498993          	addi	s3,s3,-2028 # 80015988 <tickslock>
    sleep(p, &wait_lock);  //DOC: wait-sleep
    8000217c:	0000dc17          	auipc	s8,0xd
    80002180:	7f4c0c13          	addi	s8,s8,2036 # 8000f970 <wait_lock>
    ...
    800021b2:	7c250513          	addi	a0,a0,1986 # 8000f970 <wait_lock>
    ...
    800021de:	79650513          	addi	a0,a0,1942 # 8000f970 <wait_lock>
    ...
    80002226:	b6648493          	addi	s1,s1,-1178 # 8000fd88 <proc>
    8000222a:	b7e1                	j	800021f2 <kwait+0xb0>
      release(&wait_lock);
    8000222c:	0000d517          	auipc	a0,0xd
    80002230:	74450513          	addi	a0,a0,1860 # 8000f970 <wait_lock>
...
procdump(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800022f6:	bee48493          	addi	s1,s1,-1042 # 8000fee0 <proc+0x158>
    800022fa:	00013917          	auipc	s2,0x13
    800022fe:	7e690913          	addi	s2,s2,2022 # 80015ae0 <bcache+0x140>
    if(p->state == UNUSED)
      continue;
    ...
    80002308:	efc98993          	addi	s3,s3,-260 # 80007200 <etext+0x200>
    printf("%d %s %s", p->pid, state, p->name);
    8000230c:	00005a97          	auipc	s5,0x5
    80002310:	efca8a93          	addi	s5,s5,-260 # 80007208 <etext+0x208>
    printf("\n");
    80002314:	00005a17          	auipc	s4,0x5
    80002318:	d64a0a13          	addi	s4,s4,-668 # 80007078 <etext+0x78>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
    8000231c:	00005b97          	auipc	s7,0x5
    80002320:	40cb8b93          	addi	s7,s7,1036 # 80007728 <states.0>
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    800023ea:	e6258593          	addi	a1,a1,-414 # 80007248 <etext+0x248>
    800023ee:	00013517          	auipc	a0,0x13
    800023f2:	59a50513          	addi	a0,a0,1434 # 80015988 <tickslock>
...
prepare_return(void)
{
  ...
  struct proc *p = myproc();
    80002428:	ca6ff0ef          	jal	800018ce <myproc>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    8000242c:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() & ~SSTATUS_SIE);
    80002430:	9bf5                	andi	a5,a5,-3
  asm volatile("csrw sstatus, %0" : : "r" (x));
...
clockintr()
{
  ...
  if(cpuid() == 0){
    800024a2:	c00ff0ef          	jal	800018a2 <cpuid>
  ...
  asm volatile("csrw 0x14d, %0" : : "r" (x));
    ...
    acquire(&tickslock);
    800024c4:	00013497          	auipc	s1,0x13
    800024c8:	4c448493          	addi	s1,s1,1220 # 80015988 <tickslock>
    800024cc:	8526                	mv	a0,s1
    800024ce:	f00fe0ef          	jal	80000bce <acquire>
    ticks++;
    800024d2:	00005517          	auipc	a0,0x5
    800024d6:	38650513          	addi	a0,a0,902 # 80007858 <ticks>
    800024da:	411c                	lw	a5,0(a0)
    800024dc:	2785                	addiw	a5,a5,1
    800024de:	c11c                	sw	a5,0(a0)
    wakeup(&ticks);
    800024e0:	a4dff0ef          	jal	80001f2c <wakeup>
    release(&tickslock);
    800024e4:	8526                	mv	a0,s1
    800024e6:	f80fe0ef          	jal	80000c66 <release>
...
devintr()
{
  ...
  if(scause == 0x8000000000000009L){
    ...
    int irq = plic_claim();
    8000251a:	6e3020ef          	jal	800053fc <plic_claim>
...
0000000080002562 <usertrap>:
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    8000257c:	dd878793          	addi	a5,a5,-552 # 80005350 <kernelvec>
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    800025d6:	cee50513          	addi	a0,a0,-786 # 800072c0 <etext+0x2c0>
    800025da:	f21fd0ef          	jal	800004fa <printf>
    setkilled(p);
    800025de:	8526                	mv	a0,s1
    800025e0:	b15ff0ef          	jal	800020f4 <setkilled>
    800025e4:	a035                	j	80002610 <usertrap+0xae>
    panic("usertrap: not from user mode");
    800025e6:	00005517          	auipc	a0,0x5
    800025ea:	c8a50513          	addi	a0,a0,-886 # 80007270 <etext+0x270>
    800025ee:	9f2fe0ef          	jal	800007e0 <panic>
    if(killed(p))
    800025f2:	b27ff0ef          	jal	80002118 <killed>
    800025f6:	ed15                	bnez	a0,80002632 <usertrap+0xd0>
    p->trapframe->epc += 4;
  ...
  w_sstatus(r_sstatus() | SSTATUS_SIE);
    80002604:	0027e793          	ori	a5,a5,2
  asm volatile("csrw sstatus, %0" : : "r" (x));
    80002608:	10079073          	csrw	sstatus,a5
    syscall();
    8000260c:	246000ef          	jal	80002852 <syscall>
  if(killed(p))
    80002610:	8526                	mv	a0,s1
    80002612:	b07ff0ef          	jal	80002118 <killed>
    80002616:	e139                	bnez	a0,8000265c <usertrap+0xfa>
  prepare_return();
    80002618:	e09ff0ef          	jal	80002420 <prepare_return>
  uint64 satp = MAKE_SATP(p->pagetable);
    8000261c:	68a8                	ld	a0,80(s1)
    8000261e:	8131                	srli	a0,a0,0xc
    80002620:	57fd                	li	a5,-1
    80002622:	17fe                	slli	a5,a5,0x3f
    80002624:	8d5d                	or	a0,a0,a5
}
    ...
    80002630:	8082                	ret
      kexit(-1);
    80002632:	557d                	li	a0,-1
    80002634:	9b9ff0ef          	jal	80001fec <kexit>
    80002638:	b7c1                	j	800025f8 <usertrap+0x96>
  asm volatile("csrr %0, stval" : "=r" (x) );
    8000263a:	143025f3          	csrr	a1,stval
  asm volatile("csrr %0, scause" : "=r" (x) );
    8000263e:	14202673          	csrr	a2,scause
            vmfault(p->pagetable, r_stval(), (r_scause() == 13)? 1 : 0) != 0) {
    80002642:	164d                	addi	a2,a2,-13 # ff3 <_entry-0x7ffff00d>
    80002644:	00163613          	seqz	a2,a2
    80002648:	68a8                	ld	a0,80(s1)
    8000264a:	f17fe0ef          	jal	80001560 <vmfault>
  } else if((r_scause() == 15 || r_scause() == 13) &&
    8000264e:	f169                	bnez	a0,80002610 <usertrap+0xae>
    80002650:	b7a5                	j	800025b8 <usertrap+0x56>
  if(killed(p))
    80002652:	8526                	mv	a0,s1
    80002654:	ac5ff0ef          	jal	80002118 <killed>
    80002658:	c511                	beqz	a0,80002664 <usertrap+0x102>
    8000265a:	a011                	j	8000265e <usertrap+0xfc>
    8000265c:	4901                	li	s2,0
    kexit(-1);
    8000265e:	557d                	li	a0,-1
    80002660:	98dff0ef          	jal	80001fec <kexit>
  if(which_dev == 2)
    80002664:	4789                	li	a5,2
    80002666:	faf919e3          	bne	s2,a5,80002618 <usertrap+0xb6>
    yield();
    8000266a:	84bff0ef          	jal	80001eb4 <yield>
    8000266e:	b76d                	j	80002618 <usertrap+0xb6>

0000000080002670 <kerneltrap>:
{
  ...
  asm volatile("csrr %0, sepc" : "=r" (x) );
    8000267e:	14102973          	csrr	s2,sepc
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80002682:	100024f3          	csrr	s1,sstatus
  asm volatile("csrr %0, scause" : "=r" (x) );
    80002686:	142029f3          	csrr	s3,scause
  if((sstatus & SSTATUS_SPP) == 0)
    8000268a:	1004f793          	andi	a5,s1,256
    8000268e:	c795                	beqz	a5,800026ba <kerneltrap+0x4a>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80002690:	100027f3          	csrr	a5,sstatus
  return (x & SSTATUS_SIE) != 0;
    80002694:	8b89                	andi	a5,a5,2
  if(intr_get() != 0)
    80002696:	eb85                	bnez	a5,800026c6 <kerneltrap+0x56>
  if((which_dev = devintr()) == 0){
    80002698:	e57ff0ef          	jal	800024ee <devintr>
    8000269c:	c91d                	beqz	a0,800026d2 <kerneltrap+0x62>
  if(which_dev == 2 && myproc() != 0)
    8000269e:	4789                	li	a5,2
    800026a0:	04f50a63          	beq	a0,a5,800026f4 <kerneltrap+0x84>
  asm volatile("csrw sepc, %0" : : "r" (x));
    800026a4:	14191073          	csrw	sepc,s2
  asm volatile("csrw sstatus, %0" : : "r" (x));
    800026a8:	10049073          	csrw	sstatus,s1
}
    ...
    800026be:	c2e50513          	addi	a0,a0,-978 # 800072e8 <etext+0x2e8>
    800026c2:	91efe0ef          	jal	800007e0 <panic>
    panic("kerneltrap: interrupts enabled");
    800026c6:	00005517          	auipc	a0,0x5
    800026ca:	c4a50513          	addi	a0,a0,-950 # 80007310 <etext+0x310>
    800026ce:	912fe0ef          	jal	800007e0 <panic>
  asm volatile("csrr %0, sepc" : "=r" (x) );
    800026d2:	14102673          	csrr	a2,sepc
  asm volatile("csrr %0, stval" : "=r" (x) );
    800026d6:	143026f3          	csrr	a3,stval
    printf("scause=0x%lx sepc=0x%lx stval=0x%lx\n", scause, r_sepc(), r_stval());
    800026da:	85ce                	mv	a1,s3
    800026dc:	00005517          	auipc	a0,0x5
    800026e0:	c5450513          	addi	a0,a0,-940 # 80007330 <etext+0x330>
    800026e4:	e17fd0ef          	jal	800004fa <printf>
    panic("kerneltrap");
    800026e8:	00005517          	auipc	a0,0x5
    800026ec:	c7050513          	addi	a0,a0,-912 # 80007358 <etext+0x358>
    800026f0:	8f0fe0ef          	jal	800007e0 <panic>
  if(which_dev == 2 && myproc() != 0)
    800026f4:	9daff0ef          	jal	800018ce <myproc>
    800026f8:	d555                	beqz	a0,800026a4 <kerneltrap+0x34>
    yield();
    800026fa:	fbaff0ef          	jal	80001eb4 <yield>
    800026fe:	b75d                	j	800026a4 <kerneltrap+0x34>

0000000080002700 <argraw>:
  return strlen(buf);
}
...
argraw(int n)
{
  ...
  struct proc *p = myproc();
    8000270c:	9c2ff0ef          	jal	800018ce <myproc>
  switch (n) {
    80002710:	4795                	li	a5,5
    80002712:	0497e163          	bltu	a5,s1,80002754 <argraw+0x54>
    80002716:	048a                	slli	s1,s1,0x2
    80002718:	00005717          	auipc	a4,0x5
    8000271c:	04070713          	addi	a4,a4,64 # 80007758 <states.0+0x30>
    80002720:	94ba                	add	s1,s1,a4
  ...
  return -1;
    ...
    80002738:	7fa8                	ld	a0,120(a5)
    8000273a:	bfcd                	j	8000272c <argraw+0x2c>
    return p->trapframe->a2;
    8000273c:	6d3c                	ld	a5,88(a0)
    8000273e:	63c8                	ld	a0,128(a5)
    80002740:	b7f5                	j	8000272c <argraw+0x2c>
    return p->trapframe->a3;
    80002742:	6d3c                	ld	a5,88(a0)
    80002744:	67c8                	ld	a0,136(a5)
    80002746:	b7dd                	j	8000272c <argraw+0x2c>
    return p->trapframe->a4;
    80002748:	6d3c                	ld	a5,88(a0)
    8000274a:	6bc8                	ld	a0,144(a5)
    8000274c:	b7c5                	j	8000272c <argraw+0x2c>
    return p->trapframe->a5;
    8000274e:	6d3c                	ld	a5,88(a0)
    80002750:	6fc8                	ld	a0,152(a5)
    80002752:	bfe9                	j	8000272c <argraw+0x2c>
  panic("argraw");
    80002754:	00005517          	auipc	a0,0x5
    80002758:	c1450513          	addi	a0,a0,-1004 # 80007368 <etext+0x368>
    8000275c:	884fe0ef          	jal	800007e0 <panic>

0000000080002760 <fetchaddr>:
{
  ...
  struct proc *p = myproc();
    80002770:	95eff0ef          	jal	800018ce <myproc>
  if(addr >= p->sz || addr+sizeof(uint64) > p->sz) // both tests needed, in case of overflow
    80002774:	653c                	ld	a5,72(a0)
    80002776:	02f4f663          	bgeu	s1,a5,800027a2 <fetchaddr+0x42>
    8000277a:	00848713          	addi	a4,s1,8
    8000277e:	02e7e463          	bltu	a5,a4,800027a6 <fetchaddr+0x46>
  if(copyin(p->pagetable, (char *)ip, addr, sizeof(*ip)) != 0)
    80002782:	46a1                	li	a3,8
    80002784:	8626                	mv	a2,s1
    80002786:	85ca                	mv	a1,s2
    80002788:	6928                	ld	a0,80(a0)
    8000278a:	f3dfe0ef          	jal	800016c6 <copyin>
    8000278e:	00a03533          	snez	a0,a0
    80002792:	40a00533          	neg	a0,a0
}
    ...
    800027a4:	bfcd                	j	80002796 <fetchaddr+0x36>
    800027a6:	557d                	li	a0,-1
    800027a8:	b7fd                	j	80002796 <fetchaddr+0x36>

00000000800027aa <fetchstr>:
{
  ...
  struct proc *p = myproc();
    800027be:	910ff0ef          	jal	800018ce <myproc>
  if(copyinstr(p->pagetable, buf, addr, max) < 0)
    800027c2:	86ce                	mv	a3,s3
    800027c4:	864a                	mv	a2,s2
    800027c6:	85a6                	mv	a1,s1
    800027c8:	6928                	ld	a0,80(a0)
    800027ca:	cbffe0ef          	jal	80001488 <copyinstr>
    800027ce:	00054c63          	bltz	a0,800027e6 <fetchstr+0x3c>
  return strlen(buf);
    800027d2:	8526                	mv	a0,s1
    800027d4:	e3efe0ef          	jal	80000e12 <strlen>
}
    ...
    800027e8:	bfc5                	j	800027d8 <fetchstr+0x2e>

00000000800027ea <argint>:
...
argint(int n, int *ip)
{
  ...
  *ip = argraw(n);
    800027f6:	f0bff0ef          	jal	80002700 <argraw>
    800027fa:	c088                	sw	a0,0(s1)
}
...
argaddr(int n, uint64 *ip)
{
  ...
  *ip = argraw(n);
    80002812:	eefff0ef          	jal	80002700 <argraw>
    80002816:	e088                	sd	a0,0(s1)
}
...
syscall(void)
{
  ...
  int num;
  struct proc *p = myproc();
    8000285e:	870ff0ef          	jal	800018ce <myproc>
    80002862:	84aa                	mv	s1,a0

  num = p->trapframe->a7;
    80002864:	05853903          	ld	s2,88(a0)
    80002868:	0a893783          	ld	a5,168(s2)
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    80002872:	4751                	li	a4,20
    80002874:	00f76f63          	bltu	a4,a5,80002892 <syscall+0x40>
    80002878:	00369713          	slli	a4,a3,0x3
    8000287c:	00005797          	auipc	a5,0x5
    80002880:	ef478793          	addi	a5,a5,-268 # 80007770 <syscalls>
    80002884:	97ba                	add	a5,a5,a4
    80002886:	639c                	ld	a5,0(a5)
    80002888:	c789                	beqz	a5,80002892 <syscall+0x40>
    // Use num to lookup the system call function for num, call it,
    // and store its return value in p->trapframe->a0
    p->trapframe->a0 = syscalls[num]();
    8000288a:	9782                	jalr	a5
    8000288c:	06a93823          	sd	a0,112(s2)
    80002890:	a829                	j	800028aa <syscall+0x58>
  } else {
    printf("%d %s: unknown sys call %d\n",
    80002892:	15848613          	addi	a2,s1,344
    80002896:	588c                	lw	a1,48(s1)
    80002898:	00005517          	auipc	a0,0x5
    8000289c:	ad850513          	addi	a0,a0,-1320 # 80007370 <etext+0x370>
...
sys_exit(void)
{
  ...
  argint(0, &n);
    ...
    800028c4:	f27ff0ef          	jal	800027ea <argint>
  kexit(n);
    800028c8:	fec42503          	lw	a0,-20(s0)
    800028cc:	f20ff0ef          	jal	80001fec <kexit>
...
sys_getpid(void)
{
  ...
  return myproc()->pid;
    800028e2:	fedfe0ef          	jal	800018ce <myproc>
}
    800028e6:	5908                	lw	a0,48(a0)
    800028e8:	60a2                	ld	ra,8(sp)
    800028ea:	6402                	ld	s0,0(sp)
    800028ec:	0141                	addi	sp,sp,16
    800028ee:	8082                	ret

00000000800028f0 <sys_fork>:
...
sys_fork(void)
{
  ...
  return kfork();
    800028f8:	b42ff0ef          	jal	80001c3a <kfork>
}
...
sys_wait(void)
{
  ...
  uint64 p;
  argaddr(0, &p);
    8000290c:	fe840593          	addi	a1,s0,-24
    80002910:	4501                	li	a0,0
    80002912:	ef5ff0ef          	jal	80002806 <argaddr>
  return kwait(p);
    80002916:	fe843503          	ld	a0,-24(s0)
    8000291a:	829ff0ef          	jal	80002142 <kwait>
}
...
sys_sbrk(void)
{
  ...
  argint(0, &n);
    80002930:	fd840593          	addi	a1,s0,-40
    80002934:	4501                	li	a0,0
    80002936:	eb5ff0ef          	jal	800027ea <argint>
  argint(1, &t);
    8000293a:	fdc40593          	addi	a1,s0,-36
    8000293e:	4505                	li	a0,1
    80002940:	eabff0ef          	jal	800027ea <argint>
  addr = myproc()->sz;
    80002944:	f8bfe0ef          	jal	800018ce <myproc>
    80002948:	6524                	ld	s1,72(a0)

  if(t == SBRK_EAGER || n < 0) {
    8000294a:	fdc42703          	lw	a4,-36(s0)
    8000294e:	4785                	li	a5,1
    80002950:	02f70763          	beq	a4,a5,8000297e <sys_sbrk+0x58>
    80002954:	fd842783          	lw	a5,-40(s0)
    80002958:	0207c363          	bltz	a5,8000297e <sys_sbrk+0x58>
    }
  } else {
    ...
    if(addr + n < addr)
    8000295c:	97a6                	add	a5,a5,s1
    8000295e:	0297ee63          	bltu	a5,s1,8000299a <sys_sbrk+0x74>
      return -1;
    if(addr + n > TRAPFRAME)
    80002962:	02000737          	lui	a4,0x2000
    80002966:	177d                	addi	a4,a4,-1 # 1ffffff <_entry-0x7e000001>
    80002968:	0736                	slli	a4,a4,0xd
    8000296a:	02f76a63          	bltu	a4,a5,8000299e <sys_sbrk+0x78>
      return -1;
    myproc()->sz += n;
    8000296e:	f61fe0ef          	jal	800018ce <myproc>
    80002972:	fd842703          	lw	a4,-40(s0)
    80002976:	653c                	ld	a5,72(a0)
    80002978:	97ba                	add	a5,a5,a4
    8000297a:	e53c                	sd	a5,72(a0)
    8000297c:	a039                	j	8000298a <sys_sbrk+0x64>
    if(growproc(n) < 0) {
    8000297e:	fd842503          	lw	a0,-40(s0)
    80002982:	a56ff0ef          	jal	80001bd8 <growproc>
    80002986:	00054863          	bltz	a0,80002996 <sys_sbrk+0x70>
  }
  return addr;
}
    ...
    80002998:	bfcd                	j	8000298a <sys_sbrk+0x64>
      return -1;
    8000299a:	54fd                	li	s1,-1
    8000299c:	b7fd                	j	8000298a <sys_sbrk+0x64>
      return -1;
    8000299e:	54fd                	li	s1,-1
    800029a0:	b7ed                	j	8000298a <sys_sbrk+0x64>

00000000800029a2 <sys_pause>:
...
sys_pause(void)
{
  ...
  argint(0, &n);
    800029ac:	fcc40593          	addi	a1,s0,-52
    800029b0:	4501                	li	a0,0
    800029b2:	e39ff0ef          	jal	800027ea <argint>
  if(n < 0)
    800029b6:	fcc42783          	lw	a5,-52(s0)
    800029ba:	0607c763          	bltz	a5,80002a28 <sys_pause+0x86>
    n = 0;
  acquire(&tickslock);
    800029be:	00013517          	auipc	a0,0x13
    800029c2:	fca50513          	addi	a0,a0,-54 # 80015988 <tickslock>
    800029c6:	a08fe0ef          	jal	80000bce <acquire>
  ticks0 = ticks;
    800029ca:	00005917          	auipc	s2,0x5
    800029ce:	e8e92903          	lw	s2,-370(s2) # 80007858 <ticks>
  while(ticks - ticks0 < n){
    800029d2:	fcc42783          	lw	a5,-52(s0)
    800029d6:	cf8d                	beqz	a5,80002a10 <sys_pause+0x6e>
    800029d8:	f426                	sd	s1,40(sp)
    800029da:	ec4e                	sd	s3,24(sp)
    if(killed(myproc())){
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
    800029dc:	00013997          	auipc	s3,0x13
    800029e0:	fac98993          	addi	s3,s3,-84 # 80015988 <tickslock>
    800029e4:	00005497          	auipc	s1,0x5
    800029e8:	e7448493          	addi	s1,s1,-396 # 80007858 <ticks>
    if(killed(myproc())){
    800029ec:	ee3fe0ef          	jal	800018ce <myproc>
    800029f0:	f28ff0ef          	jal	80002118 <killed>
    800029f4:	ed0d                	bnez	a0,80002a2e <sys_pause+0x8c>
    sleep(&ticks, &tickslock);
    800029f6:	85ce                	mv	a1,s3
    800029f8:	8526                	mv	a0,s1
    800029fa:	ce6ff0ef          	jal	80001ee0 <sleep>
  while(ticks - ticks0 < n){
    800029fe:	409c                	lw	a5,0(s1)
    80002a00:	412787bb          	subw	a5,a5,s2
    80002a04:	fcc42703          	lw	a4,-52(s0)
    80002a08:	fee7e2e3          	bltu	a5,a4,800029ec <sys_pause+0x4a>
    80002a0c:	74a2                	ld	s1,40(sp)
    80002a0e:	69e2                	ld	s3,24(sp)
  }
  release(&tickslock);
    80002a10:	00013517          	auipc	a0,0x13
    80002a14:	f7850513          	addi	a0,a0,-136 # 80015988 <tickslock>
    80002a18:	a4efe0ef          	jal	80000c66 <release>
  return 0;
    ...
    80002a26:	8082                	ret
    n = 0;
    80002a28:	fc042623          	sw	zero,-52(s0)
    80002a2c:	bf49                	j	800029be <sys_pause+0x1c>
      release(&tickslock);
    80002a2e:	00013517          	auipc	a0,0x13
    80002a32:	f5a50513          	addi	a0,a0,-166 # 80015988 <tickslock>
    80002a36:	a30fe0ef          	jal	80000c66 <release>
      return -1;
    80002a3a:	557d                	li	a0,-1
    80002a3c:	74a2                	ld	s1,40(sp)
    80002a3e:	69e2                	ld	s3,24(sp)
    80002a40:	bff9                	j	80002a1e <sys_pause+0x7c>
...
sys_kill(void)
{
  ...
  argint(0, &pid);
    ...
    80002a50:	d9bff0ef          	jal	800027ea <argint>
  return kkill(pid);
    80002a54:	fec42503          	lw	a0,-20(s0)
    80002a58:	e36ff0ef          	jal	8000208e <kkill>
}
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002a72:	f1a50513          	addi	a0,a0,-230 # 80015988 <tickslock>
    80002a76:	958fe0ef          	jal	80000bce <acquire>
  xticks = ticks;
    80002a7a:	00005497          	auipc	s1,0x5
    80002a7e:	dde4a483          	lw	s1,-546(s1) # 80007858 <ticks>
  release(&tickslock);
    80002a82:	00013517          	auipc	a0,0x13
    80002a86:	f0650513          	addi	a0,a0,-250 # 80015988 <tickslock>
    80002a8a:	9dcfe0ef          	jal	80000c66 <release>
  return xticks;
}
    80002a8e:	02049513          	slli	a0,s1,0x20
    80002a92:	9101                	srli	a0,a0,0x20
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    80002aae:	00005597          	auipc	a1,0x5
    80002ab2:	8e258593          	addi	a1,a1,-1822 # 80007390 <etext+0x390>
    80002ab6:	00013517          	auipc	a0,0x13
    80002aba:	eea50513          	addi	a0,a0,-278 # 800159a0 <bcache>
    80002abe:	890fe0ef          	jal	80000b4e <initlock>

  // Create linked list of buffers
  bcache.head.prev = &bcache.head;
    80002ac2:	0001b797          	auipc	a5,0x1b
    80002ac6:	ede78793          	addi	a5,a5,-290 # 8001d9a0 <bcache+0x8000>
    80002aca:	0001b717          	auipc	a4,0x1b
    80002ace:	13e70713          	addi	a4,a4,318 # 8001dc08 <bcache+0x8268>
    80002ad2:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    80002ad6:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80002ada:	00013497          	auipc	s1,0x13
    80002ade:	ede48493          	addi	s1,s1,-290 # 800159b8 <bcache+0x18>
    b->next = bcache.head.next;
    80002ae2:	893e                	mv	s2,a5
    b->prev = &bcache.head;
    80002ae4:	89ba                	mv	s3,a4
    initsleeplock(&b->lock, "buffer");
    80002ae6:	00005a17          	auipc	s4,0x5
    80002aea:	8b2a0a13          	addi	s4,s4,-1870 # 80007398 <etext+0x398>
    b->next = bcache.head.next;
    80002aee:	2b893783          	ld	a5,696(s2)
    80002af2:	e8bc                	sd	a5,80(s1)
    b->prev = &bcache.head;
    80002af4:	0534b423          	sd	s3,72(s1)
    initsleeplock(&b->lock, "buffer");
    80002af8:	85d2                	mv	a1,s4
    80002afa:	01048513          	addi	a0,s1,16
    80002afe:	322010ef          	jal	80003e20 <initsleeplock>
    bcache.head.next->prev = b;
    80002b02:	2b893783          	ld	a5,696(s2)
    80002b06:	e7a4                	sd	s1,72(a5)
    bcache.head.next = b;
    80002b08:	2a993c23          	sd	s1,696(s2)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80002b0c:	45848493          	addi	s1,s1,1112
    80002b10:	fd349fe3          	bne	s1,s3,80002aee <binit+0x50>
  }
}
    ...
    80002b1e:	6a02                	ld	s4,0(sp)
    80002b20:	6145                	addi	sp,sp,48
    80002b22:	8082                	ret

0000000080002b24 <bread>:
}
...
bread(uint dev, uint blockno)
{
    ...
    80002b34:	89ae                	mv	s3,a1
  acquire(&bcache.lock);
    80002b36:	00013517          	auipc	a0,0x13
    80002b3a:	e6a50513          	addi	a0,a0,-406 # 800159a0 <bcache>
    80002b3e:	890fe0ef          	jal	80000bce <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    80002b42:	0001b497          	auipc	s1,0x1b
    80002b46:	1164b483          	ld	s1,278(s1) # 8001dc58 <bcache+0x82b8>
    80002b4a:	0001b797          	auipc	a5,0x1b
    80002b4e:	0be78793          	addi	a5,a5,190 # 8001dc08 <bcache+0x8268>
    80002b52:	02f48b63          	beq	s1,a5,80002b88 <bread+0x64>
    80002b56:	873e                	mv	a4,a5
    80002b58:	a021                	j	80002b60 <bread+0x3c>
    80002b5a:	68a4                	ld	s1,80(s1)
    80002b5c:	02e48663          	beq	s1,a4,80002b88 <bread+0x64>
    if(b->dev == dev && b->blockno == blockno){
    80002b60:	449c                	lw	a5,8(s1)
    80002b62:	ff279ce3          	bne	a5,s2,80002b5a <bread+0x36>
    80002b66:	44dc                	lw	a5,12(s1)
    80002b68:	ff3799e3          	bne	a5,s3,80002b5a <bread+0x36>
      b->refcnt++;
    ...
    80002b76:	e2e50513          	addi	a0,a0,-466 # 800159a0 <bcache>
    80002b7a:	8ecfe0ef          	jal	80000c66 <release>
      acquiresleep(&b->lock);
    80002b7e:	01048513          	addi	a0,s1,16
    80002b82:	2d4010ef          	jal	80003e56 <acquiresleep>
      return b;
    80002b86:	a889                	j	80002bd8 <bread+0xb4>
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    80002b88:	0001b497          	auipc	s1,0x1b
    80002b8c:	0c84b483          	ld	s1,200(s1) # 8001dc50 <bcache+0x82b0>
    80002b90:	0001b797          	auipc	a5,0x1b
    80002b94:	07878793          	addi	a5,a5,120 # 8001dc08 <bcache+0x8268>
    80002b98:	00f48863          	beq	s1,a5,80002ba8 <bread+0x84>
    80002b9c:	873e                	mv	a4,a5
    if(b->refcnt == 0) {
    80002b9e:	40bc                	lw	a5,64(s1)
    80002ba0:	cb91                	beqz	a5,80002bb4 <bread+0x90>
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    80002ba2:	64a4                	ld	s1,72(s1)
    80002ba4:	fee49de3          	bne	s1,a4,80002b9e <bread+0x7a>
  panic("bget: no buffers");
    80002ba8:	00004517          	auipc	a0,0x4
    80002bac:	7f850513          	addi	a0,a0,2040 # 800073a0 <etext+0x3a0>
    80002bb0:	c31fd0ef          	jal	800007e0 <panic>
      b->dev = dev;
    80002bb4:	0124a423          	sw	s2,8(s1)
      b->blockno = blockno;
    80002bb8:	0134a623          	sw	s3,12(s1)
      b->valid = 0;
    80002bbc:	0004a023          	sw	zero,0(s1)
      b->refcnt = 1;
    80002bc0:	4785                	li	a5,1
    80002bc2:	c0bc                	sw	a5,64(s1)
      release(&bcache.lock);
    80002bc4:	00013517          	auipc	a0,0x13
    80002bc8:	ddc50513          	addi	a0,a0,-548 # 800159a0 <bcache>
    80002bcc:	89afe0ef          	jal	80000c66 <release>
      acquiresleep(&b->lock);
    80002bd0:	01048513          	addi	a0,s1,16
    80002bd4:	282010ef          	jal	80003e56 <acquiresleep>
  struct buf *b;

  b = bget(dev, blockno);
  if(!b->valid) {
    80002bd8:	409c                	lw	a5,0(s1)
    80002bda:	cb89                	beqz	a5,80002bec <bread+0xc8>
    virtio_disk_rw(b, 0);
    b->valid = 1;
  }
  return b;
    ...
    80002bf0:	2c1020ef          	jal	800056b0 <virtio_disk_rw>
    b->valid = 1;
    80002bf4:	4785                	li	a5,1
    80002bf6:	c09c                	sw	a5,0(s1)
  return b;
    80002bf8:	b7d5                	j	80002bdc <bread+0xb8>

0000000080002bfa <bwrite>:
...
bwrite(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    80002c06:	0541                	addi	a0,a0,16
    80002c08:	2cc010ef          	jal	80003ed4 <holdingsleep>
    80002c0c:	c911                	beqz	a0,80002c20 <bwrite+0x26>
    panic("bwrite");
  virtio_disk_rw(b, 1);
    80002c0e:	4585                	li	a1,1
    80002c10:	8526                	mv	a0,s1
    80002c12:	29f020ef          	jal	800056b0 <virtio_disk_rw>
}
    ...
    80002c24:	79850513          	addi	a0,a0,1944 # 800073b8 <etext+0x3b8>
    80002c28:	bb9fd0ef          	jal	800007e0 <panic>

0000000080002c2c <brelse>:
...
brelse(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    ...
    80002c40:	294010ef          	jal	80003ed4 <holdingsleep>
    80002c44:	c135                	beqz	a0,80002ca8 <brelse+0x7c>
    panic("brelse");

  releasesleep(&b->lock);
    80002c46:	854a                	mv	a0,s2
    80002c48:	254010ef          	jal	80003e9c <releasesleep>

  acquire(&bcache.lock);
    80002c4c:	00013517          	auipc	a0,0x13
    80002c50:	d5450513          	addi	a0,a0,-684 # 800159a0 <bcache>
    80002c54:	f7bfd0ef          	jal	80000bce <acquire>
  b->refcnt--;
    80002c58:	40bc                	lw	a5,64(s1)
    80002c5a:	37fd                	addiw	a5,a5,-1
    80002c5c:	0007871b          	sext.w	a4,a5
    80002c60:	c0bc                	sw	a5,64(s1)
  if (b->refcnt == 0) {
    80002c62:	e71d                	bnez	a4,80002c90 <brelse+0x64>
    // no one is waiting for it.
    b->next->prev = b->prev;
    80002c64:	68b8                	ld	a4,80(s1)
    80002c66:	64bc                	ld	a5,72(s1)
    80002c68:	e73c                	sd	a5,72(a4)
    b->prev->next = b->next;
    80002c6a:	68b8                	ld	a4,80(s1)
    80002c6c:	ebb8                	sd	a4,80(a5)
    b->next = bcache.head.next;
    80002c6e:	0001b797          	auipc	a5,0x1b
    80002c72:	d3278793          	addi	a5,a5,-718 # 8001d9a0 <bcache+0x8000>
    80002c76:	2b87b703          	ld	a4,696(a5)
    80002c7a:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    80002c7c:	0001b717          	auipc	a4,0x1b
    80002c80:	f8c70713          	addi	a4,a4,-116 # 8001dc08 <bcache+0x8268>
  ...
  release(&bcache.lock);
    ...
    80002c94:	d1050513          	addi	a0,a0,-752 # 800159a0 <bcache>
    ...
    80002cac:	71850513          	addi	a0,a0,1816 # 800073c0 <etext+0x3c0>
    80002cb0:	b31fd0ef          	jal	800007e0 <panic>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80002cc4:	ce050513          	addi	a0,a0,-800 # 800159a0 <bcache>
    80002cc8:	f07fd0ef          	jal	80000bce <acquire>
  b->refcnt++;
  ...
  release(&bcache.lock);
    ...
    80002cd6:	cce50513          	addi	a0,a0,-818 # 800159a0 <bcache>
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80002cf8:	cac50513          	addi	a0,a0,-852 # 800159a0 <bcache>
    80002cfc:	ed3fd0ef          	jal	80000bce <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    80002d0a:	c9a50513          	addi	a0,a0,-870 # 800159a0 <bcache>
    80002d0e:	f59fd0ef          	jal	80000c66 <release>
}
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    ...
    80002d2e:	0001b797          	auipc	a5,0x1b
    80002d32:	34e7a783          	lw	a5,846(a5) # 8001e07c <sb+0x1c>
    80002d36:	9dbd                	addw	a1,a1,a5
    80002d38:	dedff0ef          	jal	80002b24 <bread>
  bi = b % BPB;
  m = 1 << (bi % 8);
  ...
  bp->data[bi/8] &= ~m;
    ...
    80002d60:	8f7d                	and	a4,a4,a5
    80002d62:	04e48c23          	sb	a4,88(s1)
  log_write(bp);
    80002d66:	7f9000ef          	jal	80003d5e <log_write>
  brelse(bp);
    80002d6a:	854a                	mv	a0,s2
    80002d6c:	ec1ff0ef          	jal	80002c2c <brelse>
}
    ...
    80002d80:	64c50513          	addi	a0,a0,1612 # 800073c8 <etext+0x3c8>
...
0000000080002d88 <balloc>:
{
    ...
    80002d90:	1080                	addi	s0,sp,96
  for(b = 0; b < sb.size; b += BPB){
    80002d92:	0001b797          	auipc	a5,0x1b
    80002d96:	2d27a783          	lw	a5,722(a5) # 8001e064 <sb+0x4>
    80002d9a:	0e078f63          	beqz	a5,80002e98 <balloc+0x110>
    80002d9e:	e0ca                	sd	s2,64(sp)
    80002da0:	fc4e                	sd	s3,56(sp)
    80002da2:	f852                	sd	s4,48(sp)
    80002da4:	f456                	sd	s5,40(sp)
    80002da6:	f05a                	sd	s6,32(sp)
    80002da8:	ec5e                	sd	s7,24(sp)
    80002daa:	e862                	sd	s8,16(sp)
    80002dac:	e466                	sd	s9,8(sp)
    80002dae:	8baa                	mv	s7,a0
    80002db0:	4a81                	li	s5,0
    bp = bread(dev, BBLOCK(b, sb));
    80002db2:	0001bb17          	auipc	s6,0x1b
    80002db6:	2aeb0b13          	addi	s6,s6,686 # 8001e060 <sb>
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    80002dc4:	97ca                	add	a5,a5,s2
    80002dc6:	8e55                	or	a2,a2,a3
    80002dc8:	04c78c23          	sb	a2,88(a5)
        log_write(bp);
    80002dcc:	854a                	mv	a0,s2
    80002dce:	791000ef          	jal	80003d5e <log_write>
        brelse(bp);
    80002dd2:	854a                	mv	a0,s2
    80002dd4:	e59ff0ef          	jal	80002c2c <brelse>
  bp = bread(dev, bno);
    80002dd8:	85a6                	mv	a1,s1
    80002dda:	855e                	mv	a0,s7
    80002ddc:	d49ff0ef          	jal	80002b24 <bread>
    80002de0:	892a                	mv	s2,a0
  memset(bp->data, 0, BSIZE);
    80002de2:	40000613          	li	a2,1024
    80002de6:	4581                	li	a1,0
    80002de8:	05850513          	addi	a0,a0,88
    80002dec:	eb7fd0ef          	jal	80000ca2 <memset>
  log_write(bp);
    80002df0:	854a                	mv	a0,s2
    80002df2:	76d000ef          	jal	80003d5e <log_write>
  brelse(bp);
    80002df6:	854a                	mv	a0,s2
    80002df8:	e35ff0ef          	jal	80002c2c <brelse>
}
    ...
    80002e0e:	60e6                	ld	ra,88(sp)
    80002e10:	6446                	ld	s0,80(sp)
    80002e12:	64a6                	ld	s1,72(sp)
    80002e14:	6125                	addi	sp,sp,96
    80002e16:	8082                	ret
    brelse(bp);
    80002e18:	854a                	mv	a0,s2
    80002e1a:	e13ff0ef          	jal	80002c2c <brelse>
  for(b = 0; b < sb.size; b += BPB){
    80002e1e:	015c87bb          	addw	a5,s9,s5
    80002e22:	00078a9b          	sext.w	s5,a5
    80002e26:	004b2703          	lw	a4,4(s6)
    80002e2a:	04eaff63          	bgeu	s5,a4,80002e88 <balloc+0x100>
    bp = bread(dev, BBLOCK(b, sb));
    ...
    80002e7c:	d5a1                	beqz	a1,80002dc4 <balloc+0x3c>
    for(bi = 0; bi < BPB && b + bi < sb.size; bi++){
    80002e7e:	2705                	addiw	a4,a4,1
    80002e80:	2485                	addiw	s1,s1,1
    80002e82:	fd471ae3          	bne	a4,s4,80002e56 <balloc+0xce>
    80002e86:	bf49                	j	80002e18 <balloc+0x90>
    80002e88:	6906                	ld	s2,64(sp)
    80002e8a:	79e2                	ld	s3,56(sp)
    80002e8c:	7a42                	ld	s4,48(sp)
    80002e8e:	7aa2                	ld	s5,40(sp)
    80002e90:	7b02                	ld	s6,32(sp)
    80002e92:	6be2                	ld	s7,24(sp)
    80002e94:	6c42                	ld	s8,16(sp)
    80002e96:	6ca2                	ld	s9,8(sp)
  printf("balloc: out of blocks\n");
    80002e98:	00004517          	auipc	a0,0x4
    80002e9c:	54850513          	addi	a0,a0,1352 # 800073e0 <etext+0x3e0>
    80002ea0:	e5afd0ef          	jal	800004fa <printf>
  return 0;
    80002ea4:	4481                	li	s1,0
    80002ea6:	b79d                	j	80002e0c <balloc+0x84>

0000000080002ea8 <bmap>:
...
bmap(struct inode *ip, uint bn)
{
  ...
  if(bn < NDIRECT){
    ...
    80002eba:	02b7e663          	bltu	a5,a1,80002ee6 <bmap+0x3e>
    ...
    80002ece:	06091a63          	bnez	s2,80002f42 <bmap+0x9a>
      addr = balloc(ip->dev);
    80002ed2:	4108                	lw	a0,0(a0)
    80002ed4:	eb5ff0ef          	jal	80002d88 <balloc>
    80002ed8:	0005091b          	sext.w	s2,a0
      if(addr == 0)
    80002edc:	06090363          	beqz	s2,80002f42 <bmap+0x9a>
        return 0;
      ip->addrs[bn] = addr;
    80002ee0:	0524a823          	sw	s2,80(s1)
    80002ee4:	a8b9                	j	80002f42 <bmap+0x9a>
    }
    return addr;
  }
  bn -= NDIRECT;
  ...
  if(bn < NINDIRECT){
    ...
    80002ef2:	06e7ee63          	bltu	a5,a4,80002f6e <bmap+0xc6>
    // Load indirect block, allocating if necessary.
    if((addr = ip->addrs[NDIRECT]) == 0){
    80002ef6:	08052903          	lw	s2,128(a0)
    80002efa:	00091d63          	bnez	s2,80002f14 <bmap+0x6c>
      addr = balloc(ip->dev);
    80002efe:	4108                	lw	a0,0(a0)
    80002f00:	e89ff0ef          	jal	80002d88 <balloc>
    80002f04:	0005091b          	sext.w	s2,a0
      if(addr == 0)
    80002f08:	02090d63          	beqz	s2,80002f42 <bmap+0x9a>
    80002f0c:	e052                	sd	s4,0(sp)
        return 0;
      ip->addrs[NDIRECT] = addr;
    80002f0e:	0929a023          	sw	s2,128(s3)
    80002f12:	a011                	j	80002f16 <bmap+0x6e>
    80002f14:	e052                	sd	s4,0(sp)
    }
    bp = bread(ip->dev, addr);
    80002f16:	85ca                	mv	a1,s2
    80002f18:	0009a503          	lw	a0,0(s3)
    80002f1c:	c09ff0ef          	jal	80002b24 <bread>
    80002f20:	8a2a                	mv	s4,a0
    a = (uint*)bp->data;
    80002f22:	05850793          	addi	a5,a0,88
    if((addr = a[bn]) == 0){
    80002f26:	02049713          	slli	a4,s1,0x20
    80002f2a:	01e75593          	srli	a1,a4,0x1e
    80002f2e:	00b784b3          	add	s1,a5,a1
    80002f32:	0004a903          	lw	s2,0(s1)
    80002f36:	00090e63          	beqz	s2,80002f52 <bmap+0xaa>
      if(addr){
        a[bn] = addr;
        log_write(bp);
      }
    ...
    80002f3c:	cf1ff0ef          	jal	80002c2c <brelse>
    return addr;
  ...
  panic("bmap: out of range");
    ...
    80002f56:	e33ff0ef          	jal	80002d88 <balloc>
    80002f5a:	0005091b          	sext.w	s2,a0
      if(addr){
    80002f5e:	fc090ee3          	beqz	s2,80002f3a <bmap+0x92>
        a[bn] = addr;
    80002f62:	0124a023          	sw	s2,0(s1)
        log_write(bp);
    80002f66:	8552                	mv	a0,s4
    80002f68:	5f7000ef          	jal	80003d5e <log_write>
    80002f6c:	b7f9                	j	80002f3a <bmap+0x92>
    80002f6e:	e052                	sd	s4,0(sp)
  panic("bmap: out of range");
    80002f70:	00004517          	auipc	a0,0x4
    80002f74:	48850513          	addi	a0,a0,1160 # 800073f8 <etext+0x3f8>
    80002f78:	869fd0ef          	jal	800007e0 <panic>

0000000080002f7c <iget>:
{
    ...
    80002f8e:	8a2e                	mv	s4,a1
  acquire(&itable.lock);
    80002f90:	0001b517          	auipc	a0,0x1b
    80002f94:	0f050513          	addi	a0,a0,240 # 8001e080 <itable>
    80002f98:	c37fd0ef          	jal	80000bce <acquire>
  empty = 0;
    80002f9c:	4901                	li	s2,0
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    80002f9e:	0001b497          	auipc	s1,0x1b
    80002fa2:	0fa48493          	addi	s1,s1,250 # 8001e098 <itable+0x18>
    80002fa6:	0001d697          	auipc	a3,0x1d
    80002faa:	b8268693          	addi	a3,a3,-1150 # 8001fb28 <log>
    80002fae:	a039                	j	80002fbc <iget+0x40>
    if(empty == 0 && ip->ref == 0)    // Remember empty slot.
    80002fb0:	02090963          	beqz	s2,80002fe2 <iget+0x66>
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    80002fb4:	08848493          	addi	s1,s1,136
    80002fb8:	02d48863          	beq	s1,a3,80002fe8 <iget+0x6c>
    if(ip->ref > 0 && ip->dev == dev && ip->inum == inum){
    80002fbc:	449c                	lw	a5,8(s1)
    80002fbe:	fef059e3          	blez	a5,80002fb0 <iget+0x34>
    80002fc2:	4098                	lw	a4,0(s1)
    80002fc4:	ff3716e3          	bne	a4,s3,80002fb0 <iget+0x34>
    80002fc8:	40d8                	lw	a4,4(s1)
    80002fca:	ff4713e3          	bne	a4,s4,80002fb0 <iget+0x34>
      ip->ref++;
    80002fce:	2785                	addiw	a5,a5,1
    80002fd0:	c49c                	sw	a5,8(s1)
      release(&itable.lock);
    80002fd2:	0001b517          	auipc	a0,0x1b
    80002fd6:	0ae50513          	addi	a0,a0,174 # 8001e080 <itable>
    80002fda:	c8dfd0ef          	jal	80000c66 <release>
      return ip;
    80002fde:	8926                	mv	s2,s1
    80002fe0:	a02d                	j	8000300a <iget+0x8e>
    if(empty == 0 && ip->ref == 0)    // Remember empty slot.
    80002fe2:	fbe9                	bnez	a5,80002fb4 <iget+0x38>
      empty = ip;
    80002fe4:	8926                	mv	s2,s1
    80002fe6:	b7f9                	j	80002fb4 <iget+0x38>
  if(empty == 0)
    80002fe8:	02090a63          	beqz	s2,8000301c <iget+0xa0>
  ip->dev = dev;
    80002fec:	01392023          	sw	s3,0(s2)
  ip->inum = inum;
    80002ff0:	01492223          	sw	s4,4(s2)
  ip->ref = 1;
    80002ff4:	4785                	li	a5,1
    80002ff6:	00f92423          	sw	a5,8(s2)
  ip->valid = 0;
    80002ffa:	04092023          	sw	zero,64(s2)
  release(&itable.lock);
    80002ffe:	0001b517          	auipc	a0,0x1b
    80003002:	08250513          	addi	a0,a0,130 # 8001e080 <itable>
    80003006:	c61fd0ef          	jal	80000c66 <release>
}
    ...
    80003020:	3f450513          	addi	a0,a0,1012 # 80007410 <etext+0x410>
    80003024:	fbcfd0ef          	jal	800007e0 <panic>

0000000080003028 <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    80003036:	00004597          	auipc	a1,0x4
    8000303a:	3ea58593          	addi	a1,a1,1002 # 80007420 <etext+0x420>
    8000303e:	0001b517          	auipc	a0,0x1b
    80003042:	04250513          	addi	a0,a0,66 # 8001e080 <itable>
    80003046:	b09fd0ef          	jal	80000b4e <initlock>
  for(i = 0; i < NINODE; i++) {
    8000304a:	0001b497          	auipc	s1,0x1b
    8000304e:	05e48493          	addi	s1,s1,94 # 8001e0a8 <itable+0x28>
    80003052:	0001d997          	auipc	s3,0x1d
    80003056:	ae698993          	addi	s3,s3,-1306 # 8001fb38 <log+0x10>
    initsleeplock(&itable.inode[i].lock, "inode");
    8000305a:	00004917          	auipc	s2,0x4
    8000305e:	3ce90913          	addi	s2,s2,974 # 80007428 <etext+0x428>
    80003062:	85ca                	mv	a1,s2
    80003064:	8526                	mv	a0,s1
    80003066:	5bb000ef          	jal	80003e20 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
    8000306a:	08848493          	addi	s1,s1,136
    8000306e:	ff349ae3          	bne	s1,s3,80003062 <iinit+0x3a>
}
...
0000000080003080 <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    80003088:	0001b717          	auipc	a4,0x1b
    8000308c:	fe472703          	lw	a4,-28(a4) # 8001e06c <sb+0xc>
    80003090:	4785                	li	a5,1
    80003092:	06e7f063          	bgeu	a5,a4,800030f2 <ialloc+0x72>
    80003096:	f426                	sd	s1,40(sp)
    80003098:	f04a                	sd	s2,32(sp)
    8000309a:	ec4e                	sd	s3,24(sp)
    8000309c:	e852                	sd	s4,16(sp)
    8000309e:	e456                	sd	s5,8(sp)
    800030a0:	e05a                	sd	s6,0(sp)
    800030a2:	8aaa                	mv	s5,a0
    800030a4:	8b2e                	mv	s6,a1
    800030a6:	4905                	li	s2,1
    bp = bread(dev, IBLOCK(inum, sb));
    800030a8:	0001ba17          	auipc	s4,0x1b
    800030ac:	fb8a0a13          	addi	s4,s4,-72 # 8001e060 <sb>
    800030b0:	00495593          	srli	a1,s2,0x4
    800030b4:	018a2783          	lw	a5,24(s4)
    800030b8:	9dbd                	addw	a1,a1,a5
    800030ba:	8556                	mv	a0,s5
    800030bc:	a69ff0ef          	jal	80002b24 <bread>
    800030c0:	84aa                	mv	s1,a0
    dip = (struct dinode*)bp->data + inum%IPB;
    800030c2:	05850993          	addi	s3,a0,88
    800030c6:	00f97793          	andi	a5,s2,15
    800030ca:	079a                	slli	a5,a5,0x6
    800030cc:	99be                	add	s3,s3,a5
    if(dip->type == 0){  // a free inode
    800030ce:	00099783          	lh	a5,0(s3)
    800030d2:	cb9d                	beqz	a5,80003108 <ialloc+0x88>
    brelse(bp);
    800030d4:	b59ff0ef          	jal	80002c2c <brelse>
  for(inum = 1; inum < sb.ninodes; inum++){
    800030d8:	0905                	addi	s2,s2,1
    800030da:	00ca2703          	lw	a4,12(s4)
    800030de:	0009079b          	sext.w	a5,s2
    800030e2:	fce7e7e3          	bltu	a5,a4,800030b0 <ialloc+0x30>
    800030e6:	74a2                	ld	s1,40(sp)
    800030e8:	7902                	ld	s2,32(sp)
    800030ea:	69e2                	ld	s3,24(sp)
    800030ec:	6a42                	ld	s4,16(sp)
    800030ee:	6aa2                	ld	s5,8(sp)
    800030f0:	6b02                	ld	s6,0(sp)
  printf("ialloc: no inodes\n");
    800030f2:	00004517          	auipc	a0,0x4
    800030f6:	33e50513          	addi	a0,a0,830 # 80007430 <etext+0x430>
    800030fa:	c00fd0ef          	jal	800004fa <printf>
  return 0;
    800030fe:	4501                	li	a0,0
}
    80003100:	70e2                	ld	ra,56(sp)
    80003102:	7442                	ld	s0,48(sp)
    80003104:	6121                	addi	sp,sp,64
    80003106:	8082                	ret
      memset(dip, 0, sizeof(*dip));
    80003108:	04000613          	li	a2,64
    8000310c:	4581                	li	a1,0
    8000310e:	854e                	mv	a0,s3
    80003110:	b93fd0ef          	jal	80000ca2 <memset>
      dip->type = type;
    80003114:	01699023          	sh	s6,0(s3)
      log_write(bp);   // mark it allocated on the disk
    80003118:	8526                	mv	a0,s1
    8000311a:	445000ef          	jal	80003d5e <log_write>
      brelse(bp);
    8000311e:	8526                	mv	a0,s1
    80003120:	b0dff0ef          	jal	80002c2c <brelse>
      return iget(dev, inum);
    80003124:	0009059b          	sext.w	a1,s2
    80003128:	8556                	mv	a0,s5
    8000312a:	e53ff0ef          	jal	80002f7c <iget>
    8000312e:	74a2                	ld	s1,40(sp)
    80003130:	7902                	ld	s2,32(sp)
    80003132:	69e2                	ld	s3,24(sp)
    80003134:	6a42                	ld	s4,16(sp)
    80003136:	6aa2                	ld	s5,8(sp)
    80003138:	6b02                	ld	s6,0(sp)
    8000313a:	b7d9                	j	80003100 <ialloc+0x80>

000000008000313c <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    8000314a:	415c                	lw	a5,4(a0)
    8000314c:	0047d79b          	srliw	a5,a5,0x4
    80003150:	0001b597          	auipc	a1,0x1b
    80003154:	f285a583          	lw	a1,-216(a1) # 8001e078 <sb+0x18>
    80003158:	9dbd                	addw	a1,a1,a5
    8000315a:	4108                	lw	a0,0(a0)
    8000315c:	9c9ff0ef          	jal	80002b24 <bread>
    80003160:	892a                	mv	s2,a0
  dip = (struct dinode*)bp->data + ip->inum%IPB;
    80003162:	05850793          	addi	a5,a0,88
    80003166:	40d8                	lw	a4,4(s1)
    80003168:	8b3d                	andi	a4,a4,15
    8000316a:	071a                	slli	a4,a4,0x6
    8000316c:	97ba                	add	a5,a5,a4
  dip->type = ip->type;
    8000316e:	04449703          	lh	a4,68(s1)
    80003172:	00e79023          	sh	a4,0(a5)
  dip->major = ip->major;
    80003176:	04649703          	lh	a4,70(s1)
    8000317a:	00e79123          	sh	a4,2(a5)
  dip->minor = ip->minor;
    8000317e:	04849703          	lh	a4,72(s1)
    80003182:	00e79223          	sh	a4,4(a5)
  dip->nlink = ip->nlink;
    80003186:	04a49703          	lh	a4,74(s1)
    8000318a:	00e79323          	sh	a4,6(a5)
  dip->size = ip->size;
    8000318e:	44f8                	lw	a4,76(s1)
    80003190:	c798                	sw	a4,8(a5)
  memmove(dip->addrs, ip->addrs, sizeof(ip->addrs));
    80003192:	03400613          	li	a2,52
    80003196:	05048593          	addi	a1,s1,80
    8000319a:	00c78513          	addi	a0,a5,12
    8000319e:	b61fd0ef          	jal	80000cfe <memmove>
  log_write(bp);
    800031a2:	854a                	mv	a0,s2
    800031a4:	3bb000ef          	jal	80003d5e <log_write>
  brelse(bp);
    800031a8:	854a                	mv	a0,s2
    800031aa:	a83ff0ef          	jal	80002c2c <brelse>
}
...
00000000800031ba <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    800031ca:	eba50513          	addi	a0,a0,-326 # 8001e080 <itable>
    800031ce:	a01fd0ef          	jal	80000bce <acquire>
  ip->ref++;
  ...
  release(&itable.lock);
    ...
    800031dc:	ea850513          	addi	a0,a0,-344 # 8001e080 <itable>
...
00000000800031f0 <ilock>:
{
  ...
  if(ip == 0 || ip->ref < 1)
    800031fa:	cd19                	beqz	a0,80003218 <ilock+0x28>
    800031fc:	84aa                	mv	s1,a0
    800031fe:	451c                	lw	a5,8(a0)
    80003200:	00f05c63          	blez	a5,80003218 <ilock+0x28>
  acquiresleep(&ip->lock);
    80003204:	0541                	addi	a0,a0,16
    80003206:	451000ef          	jal	80003e56 <acquiresleep>
  if(ip->valid == 0){
    8000320a:	40bc                	lw	a5,64(s1)
    8000320c:	cf89                	beqz	a5,80003226 <ilock+0x36>
}
    ...
    8000321e:	22e50513          	addi	a0,a0,558 # 80007448 <etext+0x448>
    80003222:	dbefd0ef          	jal	800007e0 <panic>
    80003226:	e04a                	sd	s2,0(sp)
    bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    80003228:	40dc                	lw	a5,4(s1)
    8000322a:	0047d79b          	srliw	a5,a5,0x4
    8000322e:	0001b597          	auipc	a1,0x1b
    80003232:	e4a5a583          	lw	a1,-438(a1) # 8001e078 <sb+0x18>
    80003236:	9dbd                	addw	a1,a1,a5
    80003238:	4088                	lw	a0,0(s1)
    8000323a:	8ebff0ef          	jal	80002b24 <bread>
    8000323e:	892a                	mv	s2,a0
    dip = (struct dinode*)bp->data + ip->inum%IPB;
    80003240:	05850593          	addi	a1,a0,88
    80003244:	40dc                	lw	a5,4(s1)
    80003246:	8bbd                	andi	a5,a5,15
    80003248:	079a                	slli	a5,a5,0x6
    8000324a:	95be                	add	a1,a1,a5
    ip->type = dip->type;
    8000324c:	00059783          	lh	a5,0(a1)
    80003250:	04f49223          	sh	a5,68(s1)
    ip->major = dip->major;
    80003254:	00259783          	lh	a5,2(a1)
    80003258:	04f49323          	sh	a5,70(s1)
    ip->minor = dip->minor;
    8000325c:	00459783          	lh	a5,4(a1)
    80003260:	04f49423          	sh	a5,72(s1)
    ip->nlink = dip->nlink;
    80003264:	00659783          	lh	a5,6(a1)
    80003268:	04f49523          	sh	a5,74(s1)
    ip->size = dip->size;
    8000326c:	459c                	lw	a5,8(a1)
    8000326e:	c4fc                	sw	a5,76(s1)
    memmove(ip->addrs, dip->addrs, sizeof(ip->addrs));
    80003270:	03400613          	li	a2,52
    80003274:	05b1                	addi	a1,a1,12
    80003276:	05048513          	addi	a0,s1,80
    8000327a:	a85fd0ef          	jal	80000cfe <memmove>
    brelse(bp);
    8000327e:	854a                	mv	a0,s2
    80003280:	9adff0ef          	jal	80002c2c <brelse>
    ip->valid = 1;
    80003284:	4785                	li	a5,1
    80003286:	c0bc                	sw	a5,64(s1)
    if(ip->type == 0)
    80003288:	04449783          	lh	a5,68(s1)
    8000328c:	c399                	beqz	a5,80003292 <ilock+0xa2>
    8000328e:	6902                	ld	s2,0(sp)
    80003290:	bfbd                	j	8000320e <ilock+0x1e>
      panic("ilock: no type");
    80003292:	00004517          	auipc	a0,0x4
    80003296:	1be50513          	addi	a0,a0,446 # 80007450 <etext+0x450>
    8000329a:	d46fd0ef          	jal	800007e0 <panic>

000000008000329e <iunlock>:
{
  ...
  if(ip == 0 || !holdingsleep(&ip->lock) || ip->ref < 1)
    800032aa:	c505                	beqz	a0,800032d2 <iunlock+0x34>
    800032ac:	84aa                	mv	s1,a0
    800032ae:	01050913          	addi	s2,a0,16
    800032b2:	854a                	mv	a0,s2
    800032b4:	421000ef          	jal	80003ed4 <holdingsleep>
    800032b8:	cd09                	beqz	a0,800032d2 <iunlock+0x34>
    800032ba:	449c                	lw	a5,8(s1)
    800032bc:	00f05b63          	blez	a5,800032d2 <iunlock+0x34>
  releasesleep(&ip->lock);
    800032c0:	854a                	mv	a0,s2
    800032c2:	3db000ef          	jal	80003e9c <releasesleep>
}
    ...
    800032d6:	18e50513          	addi	a0,a0,398 # 80007460 <etext+0x460>
    800032da:	d06fd0ef          	jal	800007e0 <panic>

00000000800032de <itrunc>:
...
itrunc(struct inode *ip)
{
  ...
  for(i = 0; i < NDIRECT; i++){
    800032ee:	05050493          	addi	s1,a0,80
    800032f2:	08050913          	addi	s2,a0,128
    800032f6:	a021                	j	800032fe <itrunc+0x20>
    800032f8:	0491                	addi	s1,s1,4
    800032fa:	01248b63          	beq	s1,s2,80003310 <itrunc+0x32>
    if(ip->addrs[i]){
    800032fe:	408c                	lw	a1,0(s1)
    80003300:	dde5                	beqz	a1,800032f8 <itrunc+0x1a>
      bfree(ip->dev, ip->addrs[i]);
    80003302:	0009a503          	lw	a0,0(s3)
    80003306:	a17ff0ef          	jal	80002d1c <bfree>
      ip->addrs[i] = 0;
    8000330a:	0004a023          	sw	zero,0(s1)
    8000330e:	b7ed                	j	800032f8 <itrunc+0x1a>
    }
  }

  if(ip->addrs[NDIRECT]){
    80003310:	0809a583          	lw	a1,128(s3)
    80003314:	ed89                	bnez	a1,8000332e <itrunc+0x50>
    brelse(bp);
  ...
  ip->size = 0;
    80003316:	0409a623          	sw	zero,76(s3)
  iupdate(ip);
    8000331a:	854e                	mv	a0,s3
    8000331c:	e21ff0ef          	jal	8000313c <iupdate>
}
    ...
    80003334:	ff0ff0ef          	jal	80002b24 <bread>
    80003338:	8a2a                	mv	s4,a0
    for(j = 0; j < NINDIRECT; j++){
    8000333a:	05850493          	addi	s1,a0,88
    8000333e:	45850913          	addi	s2,a0,1112
    80003342:	a021                	j	8000334a <itrunc+0x6c>
    80003344:	0491                	addi	s1,s1,4
    80003346:	01248963          	beq	s1,s2,80003358 <itrunc+0x7a>
      if(a[j])
    8000334a:	408c                	lw	a1,0(s1)
    8000334c:	dde5                	beqz	a1,80003344 <itrunc+0x66>
        bfree(ip->dev, a[j]);
    8000334e:	0009a503          	lw	a0,0(s3)
    80003352:	9cbff0ef          	jal	80002d1c <bfree>
    80003356:	b7fd                	j	80003344 <itrunc+0x66>
    brelse(bp);
    80003358:	8552                	mv	a0,s4
    8000335a:	8d3ff0ef          	jal	80002c2c <brelse>
    bfree(ip->dev, ip->addrs[NDIRECT]);
    8000335e:	0809a583          	lw	a1,128(s3)
    80003362:	0009a503          	lw	a0,0(s3)
    80003366:	9b7ff0ef          	jal	80002d1c <bfree>
    ip->addrs[NDIRECT] = 0;
    8000336a:	0809a023          	sw	zero,128(s3)
    8000336e:	6a02                	ld	s4,0(sp)
    80003370:	b75d                	j	80003316 <itrunc+0x38>

0000000080003372 <iput>:
{
  ...
  acquire(&itable.lock);
    8000337e:	0001b517          	auipc	a0,0x1b
    80003382:	d0250513          	addi	a0,a0,-766 # 8001e080 <itable>
    80003386:	849fd0ef          	jal	80000bce <acquire>
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    8000338a:	4498                	lw	a4,8(s1)
    8000338c:	4785                	li	a5,1
    8000338e:	02f70063          	beq	a4,a5,800033ae <iput+0x3c>
  ip->ref--;
  ...
  release(&itable.lock);
    ...
    8000339c:	ce850513          	addi	a0,a0,-792 # 8001e080 <itable>
    800033a0:	8c7fd0ef          	jal	80000c66 <release>
}
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    800033b0:	d3ed                	beqz	a5,80003392 <iput+0x20>
    800033b2:	04a49783          	lh	a5,74(s1)
    800033b6:	fff1                	bnez	a5,80003392 <iput+0x20>
    800033b8:	e04a                	sd	s2,0(sp)
    acquiresleep(&ip->lock);
    800033ba:	01048913          	addi	s2,s1,16
    800033be:	854a                	mv	a0,s2
    800033c0:	297000ef          	jal	80003e56 <acquiresleep>
    release(&itable.lock);
    800033c4:	0001b517          	auipc	a0,0x1b
    800033c8:	cbc50513          	addi	a0,a0,-836 # 8001e080 <itable>
    800033cc:	89bfd0ef          	jal	80000c66 <release>
    itrunc(ip);
    800033d0:	8526                	mv	a0,s1
    800033d2:	f0dff0ef          	jal	800032de <itrunc>
    ip->type = 0;
    800033d6:	04049223          	sh	zero,68(s1)
    iupdate(ip);
    800033da:	8526                	mv	a0,s1
    800033dc:	d61ff0ef          	jal	8000313c <iupdate>
    ip->valid = 0;
    800033e0:	0404a023          	sw	zero,64(s1)
    releasesleep(&ip->lock);
    800033e4:	854a                	mv	a0,s2
    800033e6:	2b7000ef          	jal	80003e9c <releasesleep>
    acquire(&itable.lock);
    800033ea:	0001b517          	auipc	a0,0x1b
    800033ee:	c9650513          	addi	a0,a0,-874 # 8001e080 <itable>
    800033f2:	fdcfd0ef          	jal	80000bce <acquire>
    800033f6:	6902                	ld	s2,0(sp)
    800033f8:	bf69                	j	80003392 <iput+0x20>

00000000800033fa <iunlockput>:
{
  ...
  iunlock(ip);
    80003406:	e99ff0ef          	jal	8000329e <iunlock>
  iput(ip);
    8000340a:	8526                	mv	a0,s1
    8000340c:	f67ff0ef          	jal	80003372 <iput>
}
...
000000008000341a <ireclaim>:
  for (int inum = 1; inum < sb.ninodes; inum++) {
    8000341a:	0001b717          	auipc	a4,0x1b
    8000341e:	c5272703          	lw	a4,-942(a4) # 8001e06c <sb+0xc>
    80003422:	4785                	li	a5,1
    80003424:	0ae7ff63          	bgeu	a5,a4,800034e2 <ireclaim+0xc8>
{
    80003428:	7139                	addi	sp,sp,-64
    ...
    80003438:	e05a                	sd	s6,0(sp)
    8000343a:	0080                	addi	s0,sp,64
  for (int inum = 1; inum < sb.ninodes; inum++) {
    8000343c:	4485                	li	s1,1
    struct buf *bp = bread(dev, IBLOCK(inum, sb));
    8000343e:	00050a1b          	sext.w	s4,a0
    80003442:	0001ba97          	auipc	s5,0x1b
    80003446:	c1ea8a93          	addi	s5,s5,-994 # 8001e060 <sb>
      printf("ireclaim: orphaned inode %d\n", inum);
    8000344a:	00004b17          	auipc	s6,0x4
    8000344e:	01eb0b13          	addi	s6,s6,30 # 80007468 <etext+0x468>
    80003452:	a099                	j	80003498 <ireclaim+0x7e>
    80003454:	85ce                	mv	a1,s3
    80003456:	855a                	mv	a0,s6
    80003458:	8a2fd0ef          	jal	800004fa <printf>
      ip = iget(dev, inum);
    8000345c:	85ce                	mv	a1,s3
    8000345e:	8552                	mv	a0,s4
    80003460:	b1dff0ef          	jal	80002f7c <iget>
    80003464:	89aa                	mv	s3,a0
    brelse(bp);
    80003466:	854a                	mv	a0,s2
    80003468:	fc4ff0ef          	jal	80002c2c <brelse>
    if (ip) {
    8000346c:	00098f63          	beqz	s3,8000348a <ireclaim+0x70>
      begin_op();
    80003470:	76a000ef          	jal	80003bda <begin_op>
      ilock(ip);
    80003474:	854e                	mv	a0,s3
    80003476:	d7bff0ef          	jal	800031f0 <ilock>
      iunlock(ip);
    8000347a:	854e                	mv	a0,s3
    8000347c:	e23ff0ef          	jal	8000329e <iunlock>
      iput(ip);
    80003480:	854e                	mv	a0,s3
    80003482:	ef1ff0ef          	jal	80003372 <iput>
      end_op();
    80003486:	7be000ef          	jal	80003c44 <end_op>
  for (int inum = 1; inum < sb.ninodes; inum++) {
    8000348a:	0485                	addi	s1,s1,1
    8000348c:	00caa703          	lw	a4,12(s5)
    80003490:	0004879b          	sext.w	a5,s1
    80003494:	02e7fd63          	bgeu	a5,a4,800034ce <ireclaim+0xb4>
    80003498:	0004899b          	sext.w	s3,s1
    struct buf *bp = bread(dev, IBLOCK(inum, sb));
    8000349c:	0044d593          	srli	a1,s1,0x4
    800034a0:	018aa783          	lw	a5,24(s5)
    800034a4:	9dbd                	addw	a1,a1,a5
    800034a6:	8552                	mv	a0,s4
    800034a8:	e7cff0ef          	jal	80002b24 <bread>
    800034ac:	892a                	mv	s2,a0
    struct dinode *dip = (struct dinode *)bp->data + inum % IPB;
    800034ae:	05850793          	addi	a5,a0,88
    800034b2:	00f9f713          	andi	a4,s3,15
    800034b6:	071a                	slli	a4,a4,0x6
    800034b8:	97ba                	add	a5,a5,a4
    if (dip->type != 0 && dip->nlink == 0) {  // is an orphaned inode
    800034ba:	00079703          	lh	a4,0(a5)
    800034be:	c701                	beqz	a4,800034c6 <ireclaim+0xac>
    800034c0:	00679783          	lh	a5,6(a5)
    800034c4:	dbc1                	beqz	a5,80003454 <ireclaim+0x3a>
    brelse(bp);
    800034c6:	854a                	mv	a0,s2
    800034c8:	f64ff0ef          	jal	80002c2c <brelse>
    if (ip) {
    800034cc:	bf7d                	j	8000348a <ireclaim+0x70>
}
    800034ce:	70e2                	ld	ra,56(sp)
    800034d0:	7442                	ld	s0,48(sp)
...
fsinit(int dev) {
  ...
  bp = bread(dev, 1);
    ...
    800034f6:	e2eff0ef          	jal	80002b24 <bread>
    800034fa:	892a                	mv	s2,a0
  memmove(sb, bp->data, sizeof(*sb));
    800034fc:	0001b997          	auipc	s3,0x1b
    80003500:	b6498993          	addi	s3,s3,-1180 # 8001e060 <sb>
    80003504:	02000613          	li	a2,32
    80003508:	05850593          	addi	a1,a0,88
    8000350c:	854e                	mv	a0,s3
    8000350e:	ff0fd0ef          	jal	80000cfe <memmove>
  brelse(bp);
    80003512:	854a                	mv	a0,s2
    80003514:	f18ff0ef          	jal	80002c2c <brelse>
  if(sb.magic != FSMAGIC)
    80003518:	0009a703          	lw	a4,0(s3)
    8000351c:	102037b7          	lui	a5,0x10203
    80003520:	04078793          	addi	a5,a5,64 # 10203040 <_entry-0x6fdfcfc0>
    80003524:	02f71363          	bne	a4,a5,8000354a <fsinit+0x66>
  initlog(dev, &sb);
    80003528:	0001b597          	auipc	a1,0x1b
    8000352c:	b3858593          	addi	a1,a1,-1224 # 8001e060 <sb>
    80003530:	8526                	mv	a0,s1
    80003532:	62a000ef          	jal	80003b5c <initlog>
  ireclaim(dev);
    80003536:	8526                	mv	a0,s1
    80003538:	ee3ff0ef          	jal	8000341a <ireclaim>
}
    ...
    8000354e:	f3e50513          	addi	a0,a0,-194 # 80007488 <etext+0x488>
    80003552:	a8efd0ef          	jal	800007e0 <panic>

0000000080003556 <stati>:
...
stati(struct inode *ip, struct stat *st)
{
    ...
    80003558:	e422                	sd	s0,8(sp)
    8000355a:	0800                	addi	s0,sp,16
  st->dev = ip->dev;
    8000355c:	411c                	lw	a5,0(a0)
    8000355e:	c19c                	sw	a5,0(a1)
  st->ino = ip->inum;
    80003560:	415c                	lw	a5,4(a0)
    80003562:	c1dc                	sw	a5,4(a1)
  st->type = ip->type;
    80003564:	04451783          	lh	a5,68(a0)
    80003568:	00f59423          	sh	a5,8(a1)
  st->nlink = ip->nlink;
    8000356c:	04a51783          	lh	a5,74(a0)
    80003570:	00f59523          	sh	a5,10(a1)
  st->size = ip->size;
    80003574:	04c56783          	lwu	a5,76(a0)
    80003578:	e99c                	sd	a5,16(a1)
}
    8000357a:	6422                	ld	s0,8(sp)
    8000357c:	0141                	addi	sp,sp,16
    8000357e:	8082                	ret

0000000080003580 <readi>:
readi(struct inode *ip, int user_dst, uint64 dst, uint off, uint n)
{
  ...
  if(off > ip->size || off + n < off)
    ...
    80003582:	0ed7eb63          	bltu	a5,a3,80003678 <readi+0xf8>
{
    80003586:	7159                	addi	sp,sp,-112
    80003588:	f486                	sd	ra,104(sp)
    8000358a:	f0a2                	sd	s0,96(sp)
    8000358c:	eca6                	sd	s1,88(sp)
    8000358e:	e0d2                	sd	s4,64(sp)
    80003590:	fc56                	sd	s5,56(sp)
    80003592:	f85a                	sd	s6,48(sp)
    80003594:	f45e                	sd	s7,40(sp)
    80003596:	1880                	addi	s0,sp,112
    80003598:	8b2a                	mv	s6,a0
    8000359a:	8bae                	mv	s7,a1
    8000359c:	8a32                	mv	s4,a2
    8000359e:	84b6                	mv	s1,a3
    800035a0:	8aba                	mv	s5,a4
  if(off > ip->size || off + n < off)
    800035a2:	9f35                	addw	a4,a4,a3
    return 0;
    800035a4:	4501                	li	a0,0
  if(off > ip->size || off + n < off)
    800035a6:	0cd76063          	bltu	a4,a3,80003666 <readi+0xe6>
    800035aa:	e4ce                	sd	s3,72(sp)
  if(off + n > ip->size)
    800035ac:	00e7f463          	bgeu	a5,a4,800035b4 <readi+0x34>
    n = ip->size - off;
    800035b0:	40d78abb          	subw	s5,a5,a3

  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    800035b4:	080a8f63          	beqz	s5,80003652 <readi+0xd2>
    800035b8:	e8ca                	sd	s2,80(sp)
    800035ba:	f062                	sd	s8,32(sp)
    800035bc:	ec66                	sd	s9,24(sp)
    800035be:	e86a                	sd	s10,16(sp)
    800035c0:	e46e                	sd	s11,8(sp)
    ...
    800035ca:	a80d                	j	800035fc <readi+0x7c>
    800035cc:	020d1d93          	slli	s11,s10,0x20
    800035d0:	020ddd93          	srli	s11,s11,0x20
    800035d4:	05890613          	addi	a2,s2,88
    800035d8:	86ee                	mv	a3,s11
    800035da:	963a                	add	a2,a2,a4
    800035dc:	85d2                	mv	a1,s4
    800035de:	855e                	mv	a0,s7
    800035e0:	c5dfe0ef          	jal	8000223c <either_copyout>
    800035e4:	05850763          	beq	a0,s8,80003632 <readi+0xb2>
      brelse(bp);
      tot = -1;
      break;
    }
    ...
    800035ea:	e42ff0ef          	jal	80002c2c <brelse>
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    800035ee:	013d09bb          	addw	s3,s10,s3
    800035f2:	009d04bb          	addw	s1,s10,s1
    800035f6:	9a6e                	add	s4,s4,s11
    800035f8:	0559f763          	bgeu	s3,s5,80003646 <readi+0xc6>
    uint addr = bmap(ip, off/BSIZE);
    800035fc:	00a4d59b          	srliw	a1,s1,0xa
    80003600:	855a                	mv	a0,s6
    80003602:	8a7ff0ef          	jal	80002ea8 <bmap>
    80003606:	0005059b          	sext.w	a1,a0
    if(addr == 0)
    8000360a:	c5b1                	beqz	a1,80003656 <readi+0xd6>
    bp = bread(ip->dev, addr);
    8000360c:	000b2503          	lw	a0,0(s6)
    80003610:	d14ff0ef          	jal	80002b24 <bread>
    80003614:	892a                	mv	s2,a0
    m = min(n - tot, BSIZE - off%BSIZE);
    80003616:	3ff4f713          	andi	a4,s1,1023
    8000361a:	40ec87bb          	subw	a5,s9,a4
    8000361e:	413a86bb          	subw	a3,s5,s3
    80003622:	8d3e                	mv	s10,a5
    80003624:	2781                	sext.w	a5,a5
    80003626:	0006861b          	sext.w	a2,a3
    8000362a:	faf671e3          	bgeu	a2,a5,800035cc <readi+0x4c>
    8000362e:	8d36                	mv	s10,a3
    80003630:	bf71                	j	800035cc <readi+0x4c>
      brelse(bp);
    80003632:	854a                	mv	a0,s2
    80003634:	df8ff0ef          	jal	80002c2c <brelse>
      tot = -1;
    ...
    80003644:	a831                	j	80003660 <readi+0xe0>
    ...
    80003650:	a801                	j	80003660 <readi+0xe0>
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    80003652:	89d6                	mv	s3,s5
    80003654:	a031                	j	80003660 <readi+0xe0>
  ...
  return tot;
    80003660:	0009851b          	sext.w	a0,s3
    80003664:	69a6                	ld	s3,72(sp)
}
    80003666:	70a6                	ld	ra,104(sp)
    80003668:	7406                	ld	s0,96(sp)
...
writei(struct inode *ip, int user_src, uint64 src, uint off, uint n)
{
  ...
  if(off > ip->size || off + n < off)
    8000367c:	457c                	lw	a5,76(a0)
    8000367e:	10d7e063          	bltu	a5,a3,8000377e <writei+0x102>
{
    80003682:	7159                	addi	sp,sp,-112
    80003684:	f486                	sd	ra,104(sp)
    80003686:	f0a2                	sd	s0,96(sp)
    80003688:	e8ca                	sd	s2,80(sp)
    ...
    8000369a:	8936                	mv	s2,a3
    8000369c:	8b3a                	mv	s6,a4
  if(off > ip->size || off + n < off)
    8000369e:	00e687bb          	addw	a5,a3,a4
    800036a2:	0ed7e063          	bltu	a5,a3,80003782 <writei+0x106>
    return -1;
  if(off + n > MAXFILE*BSIZE)
    800036a6:	00043737          	lui	a4,0x43
    800036aa:	0cf76e63          	bltu	a4,a5,80003786 <writei+0x10a>
    800036ae:	e4ce                	sd	s3,72(sp)
    return -1;

  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    800036b0:	0a0b0f63          	beqz	s6,8000376e <writei+0xf2>
    800036b4:	eca6                	sd	s1,88(sp)
    800036b6:	f062                	sd	s8,32(sp)
    800036b8:	ec66                	sd	s9,24(sp)
    800036ba:	e86a                	sd	s10,16(sp)
    800036bc:	e46e                	sd	s11,8(sp)
    800036be:	4981                	li	s3,0
    uint addr = bmap(ip, off/BSIZE);
    if(addr == 0)
      break;
    bp = bread(ip->dev, addr);
    m = min(n - tot, BSIZE - off%BSIZE);
    800036c0:	40000c93          	li	s9,1024
    if(either_copyin(bp->data + (off % BSIZE), user_src, src, m) == -1) {
    800036c4:	5c7d                	li	s8,-1
    800036c6:	a825                	j	800036fe <writei+0x82>
    800036c8:	020d1d93          	slli	s11,s10,0x20
    800036cc:	020ddd93          	srli	s11,s11,0x20
    800036d0:	05848513          	addi	a0,s1,88
    800036d4:	86ee                	mv	a3,s11
    800036d6:	8652                	mv	a2,s4
    800036d8:	85de                	mv	a1,s7
    800036da:	953a                	add	a0,a0,a4
    800036dc:	babfe0ef          	jal	80002286 <either_copyin>
    800036e0:	05850a63          	beq	a0,s8,80003734 <writei+0xb8>
      brelse(bp);
      break;
    }
    log_write(bp);
    800036e4:	8526                	mv	a0,s1
    800036e6:	678000ef          	jal	80003d5e <log_write>
    brelse(bp);
    800036ea:	8526                	mv	a0,s1
    800036ec:	d40ff0ef          	jal	80002c2c <brelse>
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    800036f0:	013d09bb          	addw	s3,s10,s3
    800036f4:	012d093b          	addw	s2,s10,s2
    800036f8:	9a6e                	add	s4,s4,s11
    800036fa:	0569f063          	bgeu	s3,s6,8000373a <writei+0xbe>
    uint addr = bmap(ip, off/BSIZE);
    800036fe:	00a9559b          	srliw	a1,s2,0xa
    80003702:	8556                	mv	a0,s5
    80003704:	fa4ff0ef          	jal	80002ea8 <bmap>
    80003708:	0005059b          	sext.w	a1,a0
    if(addr == 0)
    8000370c:	c59d                	beqz	a1,8000373a <writei+0xbe>
    bp = bread(ip->dev, addr);
    8000370e:	000aa503          	lw	a0,0(s5)
    80003712:	c12ff0ef          	jal	80002b24 <bread>
    80003716:	84aa                	mv	s1,a0
    m = min(n - tot, BSIZE - off%BSIZE);
    80003718:	3ff97713          	andi	a4,s2,1023
    8000371c:	40ec87bb          	subw	a5,s9,a4
    80003720:	413b06bb          	subw	a3,s6,s3
    80003724:	8d3e                	mv	s10,a5
    80003726:	2781                	sext.w	a5,a5
    80003728:	0006861b          	sext.w	a2,a3
    8000372c:	f8f67ee3          	bgeu	a2,a5,800036c8 <writei+0x4c>
    80003730:	8d36                	mv	s10,a3
    80003732:	bf59                	j	800036c8 <writei+0x4c>
      brelse(bp);
    80003734:	8526                	mv	a0,s1
    80003736:	cf6ff0ef          	jal	80002c2c <brelse>
  }

  if(off > ip->size)
    8000373a:	04caa783          	lw	a5,76(s5)
    8000373e:	0327fa63          	bgeu	a5,s2,80003772 <writei+0xf6>
    ip->size = off;
    80003742:	052aa623          	sw	s2,76(s5)
    80003746:	64e6                	ld	s1,88(sp)
    80003748:	7c02                	ld	s8,32(sp)
    8000374a:	6ce2                	ld	s9,24(sp)
    8000374c:	6d42                	ld	s10,16(sp)
    8000374e:	6da2                	ld	s11,8(sp)
  ...
  iupdate(ip);
    ...
    80003752:	9ebff0ef          	jal	8000313c <iupdate>

  return tot;
    80003756:	0009851b          	sext.w	a0,s3
    8000375a:	69a6                	ld	s3,72(sp)
}
    8000375c:	70a6                	ld	ra,104(sp)
    8000375e:	7406                	ld	s0,96(sp)
    ...
    8000376c:	8082                	ret
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    8000376e:	89da                	mv	s3,s6
    80003770:	b7c5                	j	80003750 <writei+0xd4>
    80003772:	64e6                	ld	s1,88(sp)
    80003774:	7c02                	ld	s8,32(sp)
    80003776:	6ce2                	ld	s9,24(sp)
    80003778:	6d42                	ld	s10,16(sp)
    8000377a:	6da2                	ld	s11,8(sp)
    8000377c:	bfd1                	j	80003750 <writei+0xd4>
    return -1;
    ...
    80003784:	bfe1                	j	8000375c <writei+0xe0>
    return -1;
    80003786:	557d                	li	a0,-1
    80003788:	bfd1                	j	8000375c <writei+0xe0>

000000008000378a <namecmp>:
...
namecmp(const char *s, const char *t)
{
  ...
  return strncmp(s, t, DIRSIZ);
    80003792:	4639                	li	a2,14
    80003794:	ddafd0ef          	jal	80000d6e <strncmp>
}
    80003798:	60a2                	ld	ra,8(sp)
    8000379a:	6402                	ld	s0,0(sp)
    8000379c:	0141                	addi	sp,sp,16
    8000379e:	8082                	ret

00000000800037a0 <dirlookup>:
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
    ...
    800037a4:	f822                	sd	s0,48(sp)
    800037a6:	f426                	sd	s1,40(sp)
    800037a8:	f04a                	sd	s2,32(sp)
    800037aa:	ec4e                	sd	s3,24(sp)
    800037ac:	e852                	sd	s4,16(sp)
    800037ae:	0080                	addi	s0,sp,64
  uint off, inum;
  struct dirent de;

  if(dp->type != T_DIR)
    800037b0:	04451703          	lh	a4,68(a0)
    800037b4:	4785                	li	a5,1
    800037b6:	00f71a63          	bne	a4,a5,800037ca <dirlookup+0x2a>
    800037ba:	892a                	mv	s2,a0
    800037bc:	89ae                	mv	s3,a1
    800037be:	8a32                	mv	s4,a2
    panic("dirlookup not DIR");

  for(off = 0; off < dp->size; off += sizeof(de)){
    800037c0:	457c                	lw	a5,76(a0)
    800037c2:	4481                	li	s1,0
      inum = de.inum;
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    800037c6:	e39d                	bnez	a5,800037ec <dirlookup+0x4c>
    800037c8:	a095                	j	8000382c <dirlookup+0x8c>
    panic("dirlookup not DIR");
    800037ca:	00004517          	auipc	a0,0x4
    800037ce:	cd650513          	addi	a0,a0,-810 # 800074a0 <etext+0x4a0>
    800037d2:	80efd0ef          	jal	800007e0 <panic>
      panic("dirlookup read");
    800037d6:	00004517          	auipc	a0,0x4
    800037da:	ce250513          	addi	a0,a0,-798 # 800074b8 <etext+0x4b8>
    800037de:	802fd0ef          	jal	800007e0 <panic>
  for(off = 0; off < dp->size; off += sizeof(de)){
    800037e2:	24c1                	addiw	s1,s1,16
    800037e4:	04c92783          	lw	a5,76(s2)
    800037e8:	04f4f163          	bgeu	s1,a5,8000382a <dirlookup+0x8a>
    if(readi(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    800037ec:	4741                	li	a4,16
    800037ee:	86a6                	mv	a3,s1
    800037f0:	fc040613          	addi	a2,s0,-64
    800037f4:	4581                	li	a1,0
    800037f6:	854a                	mv	a0,s2
    800037f8:	d89ff0ef          	jal	80003580 <readi>
    800037fc:	47c1                	li	a5,16
    800037fe:	fcf51ce3          	bne	a0,a5,800037d6 <dirlookup+0x36>
    if(de.inum == 0)
    80003802:	fc045783          	lhu	a5,-64(s0)
    80003806:	dff1                	beqz	a5,800037e2 <dirlookup+0x42>
    if(namecmp(name, de.name) == 0){
    80003808:	fc240593          	addi	a1,s0,-62
    8000380c:	854e                	mv	a0,s3
    8000380e:	f7dff0ef          	jal	8000378a <namecmp>
    80003812:	f961                	bnez	a0,800037e2 <dirlookup+0x42>
      if(poff)
    80003814:	000a0463          	beqz	s4,8000381c <dirlookup+0x7c>
        *poff = off;
    80003818:	009a2023          	sw	s1,0(s4)
      return iget(dp->dev, inum);
    8000381c:	fc045583          	lhu	a1,-64(s0)
    80003820:	00092503          	lw	a0,0(s2)
    80003824:	f58ff0ef          	jal	80002f7c <iget>
    80003828:	a011                	j	8000382c <dirlookup+0x8c>
  return 0;
    ...
    80003834:	69e2                	ld	s3,24(sp)
    80003836:	6a42                	ld	s4,16(sp)
...
namex(char *path, int nameiparent, char *name)
{
    ...
    80003858:	8b2e                	mv	s6,a1
    8000385a:	8ab2                	mv	s5,a2
  struct inode *ip, *next;

  if(*path == '/')
    8000385c:	00054703          	lbu	a4,0(a0)
    80003860:	02f00793          	li	a5,47
    80003864:	00f70e63          	beq	a4,a5,80003880 <namex+0x44>
    ip = iget(ROOTDEV, ROOTINO);
  else
    ip = idup(myproc()->cwd);
    80003868:	866fe0ef          	jal	800018ce <myproc>
    8000386c:	15053503          	ld	a0,336(a0)
    80003870:	94bff0ef          	jal	800031ba <idup>
    80003874:	8a2a                	mv	s4,a0
  while(*path == '/')
    80003876:	02f00913          	li	s2,47
  if(len >= DIRSIZ)
    8000387a:	4c35                	li	s8,13

  while((path = skipelem(path, name)) != 0){
    ilock(ip);
    if(ip->type != T_DIR){
    8000387c:	4b85                	li	s7,1
    8000387e:	a871                	j	8000391a <namex+0xde>
    ip = iget(ROOTDEV, ROOTINO);
    80003880:	4585                	li	a1,1
    80003882:	4505                	li	a0,1
    80003884:	ef8ff0ef          	jal	80002f7c <iget>
    80003888:	8a2a                	mv	s4,a0
    8000388a:	b7f5                	j	80003876 <namex+0x3a>
      iunlockput(ip);
    8000388c:	8552                	mv	a0,s4
    8000388e:	b6dff0ef          	jal	800033fa <iunlockput>
      return 0;
    80003892:	4a01                	li	s4,0
  if(nameiparent){
    iput(ip);
    return 0;
  }
  return ip;
    ...
    800038ac:	6125                	addi	sp,sp,96
    800038ae:	8082                	ret
      iunlock(ip);
    800038b0:	8552                	mv	a0,s4
    800038b2:	9edff0ef          	jal	8000329e <iunlock>
      return ip;
    800038b6:	bff9                	j	80003894 <namex+0x58>
      iunlockput(ip);
    800038b8:	8552                	mv	a0,s4
    800038ba:	b41ff0ef          	jal	800033fa <iunlockput>
      return 0;
    800038be:	8a4e                	mv	s4,s3
    800038c0:	bfd1                	j	80003894 <namex+0x58>
  len = path - s;
    800038c2:	40998633          	sub	a2,s3,s1
    800038c6:	00060c9b          	sext.w	s9,a2
  if(len >= DIRSIZ)
    800038ca:	099c5063          	bge	s8,s9,8000394a <namex+0x10e>
    memmove(name, s, DIRSIZ);
    800038ce:	4639                	li	a2,14
    800038d0:	85a6                	mv	a1,s1
    800038d2:	8556                	mv	a0,s5
    800038d4:	c2afd0ef          	jal	80000cfe <memmove>
    800038d8:	84ce                	mv	s1,s3
  while(*path == '/')
    800038da:	0004c783          	lbu	a5,0(s1)
    800038de:	01279763          	bne	a5,s2,800038ec <namex+0xb0>
    path++;
    800038e2:	0485                	addi	s1,s1,1
  while(*path == '/')
    800038e4:	0004c783          	lbu	a5,0(s1)
    800038e8:	ff278de3          	beq	a5,s2,800038e2 <namex+0xa6>
    ilock(ip);
    800038ec:	8552                	mv	a0,s4
    800038ee:	903ff0ef          	jal	800031f0 <ilock>
    if(ip->type != T_DIR){
    800038f2:	044a1783          	lh	a5,68(s4)
    800038f6:	f9779be3          	bne	a5,s7,8000388c <namex+0x50>
    if(nameiparent && *path == '\0'){
    800038fa:	000b0563          	beqz	s6,80003904 <namex+0xc8>
    800038fe:	0004c783          	lbu	a5,0(s1)
    80003902:	d7dd                	beqz	a5,800038b0 <namex+0x74>
    if((next = dirlookup(ip, name, 0)) == 0){
    80003904:	4601                	li	a2,0
    80003906:	85d6                	mv	a1,s5
    80003908:	8552                	mv	a0,s4
    8000390a:	e97ff0ef          	jal	800037a0 <dirlookup>
    8000390e:	89aa                	mv	s3,a0
    80003910:	d545                	beqz	a0,800038b8 <namex+0x7c>
    iunlockput(ip);
    80003912:	8552                	mv	a0,s4
    80003914:	ae7ff0ef          	jal	800033fa <iunlockput>
    ip = next;
    80003918:	8a4e                	mv	s4,s3
  while(*path == '/')
    8000391a:	0004c783          	lbu	a5,0(s1)
    8000391e:	01279763          	bne	a5,s2,8000392c <namex+0xf0>
    path++;
    80003922:	0485                	addi	s1,s1,1
  while(*path == '/')
    80003924:	0004c783          	lbu	a5,0(s1)
    80003928:	ff278de3          	beq	a5,s2,80003922 <namex+0xe6>
  if(*path == 0)
    8000392c:	cb8d                	beqz	a5,8000395e <namex+0x122>
  while(*path != '/' && *path != 0)
    8000392e:	0004c783          	lbu	a5,0(s1)
    80003932:	89a6                	mv	s3,s1
  len = path - s;
    80003934:	4c81                	li	s9,0
    80003936:	4601                	li	a2,0
  while(*path != '/' && *path != 0)
    80003938:	01278963          	beq	a5,s2,8000394a <namex+0x10e>
    8000393c:	d3d9                	beqz	a5,800038c2 <namex+0x86>
    path++;
    8000393e:	0985                	addi	s3,s3,1
  while(*path != '/' && *path != 0)
    80003940:	0009c783          	lbu	a5,0(s3)
    80003944:	ff279ce3          	bne	a5,s2,8000393c <namex+0x100>
    80003948:	bfad                	j	800038c2 <namex+0x86>
    memmove(name, s, len);
    8000394a:	2601                	sext.w	a2,a2
    8000394c:	85a6                	mv	a1,s1
    8000394e:	8556                	mv	a0,s5
    80003950:	baefd0ef          	jal	80000cfe <memmove>
    name[len] = 0;
    80003954:	9cd6                	add	s9,s9,s5
    80003956:	000c8023          	sb	zero,0(s9) # 2000 <_entry-0x7fffe000>
    8000395a:	84ce                	mv	s1,s3
    8000395c:	bfbd                	j	800038da <namex+0x9e>
  if(nameiparent){
    8000395e:	f20b0be3          	beqz	s6,80003894 <namex+0x58>
    iput(ip);
    80003962:	8552                	mv	a0,s4
    80003964:	a0fff0ef          	jal	80003372 <iput>
    return 0;
    80003968:	4a01                	li	s4,0
    8000396a:	b72d                	j	80003894 <namex+0x58>

000000008000396c <dirlink>:
{
    ...
    8000397e:	89b2                	mv	s3,a2
  if((ip = dirlookup(dp, name, 0)) != 0){
    80003980:	4601                	li	a2,0
    80003982:	e1fff0ef          	jal	800037a0 <dirlookup>
    80003986:	e535                	bnez	a0,800039f2 <dirlink+0x86>
    80003988:	f426                	sd	s1,40(sp)
  for(off = 0; off < dp->size; off += sizeof(de)){
    8000398a:	04c92483          	lw	s1,76(s2)
    8000398e:	c48d                	beqz	s1,800039b8 <dirlink+0x4c>
    ...
    8000399e:	be3ff0ef          	jal	80003580 <readi>
    800039a2:	47c1                	li	a5,16
    800039a4:	04f51b63          	bne	a0,a5,800039fa <dirlink+0x8e>
    if(de.inum == 0)
    800039a8:	fc045783          	lhu	a5,-64(s0)
    800039ac:	c791                	beqz	a5,800039b8 <dirlink+0x4c>
  for(off = 0; off < dp->size; off += sizeof(de)){
    800039ae:	24c1                	addiw	s1,s1,16
    800039b0:	04c92783          	lw	a5,76(s2)
    800039b4:	fcf4efe3          	bltu	s1,a5,80003992 <dirlink+0x26>
  strncpy(de.name, name, DIRSIZ);
    800039b8:	4639                	li	a2,14
    800039ba:	85d2                	mv	a1,s4
    800039bc:	fc240513          	addi	a0,s0,-62
    800039c0:	be4fd0ef          	jal	80000da4 <strncpy>
  de.inum = inum;
    800039c4:	fd341023          	sh	s3,-64(s0)
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    800039c8:	4741                	li	a4,16
    800039ca:	86a6                	mv	a3,s1
    800039cc:	fc040613          	addi	a2,s0,-64
    800039d0:	4581                	li	a1,0
    800039d2:	854a                	mv	a0,s2
    800039d4:	ca9ff0ef          	jal	8000367c <writei>
    800039d8:	1541                	addi	a0,a0,-16
    800039da:	00a03533          	snez	a0,a0
    800039de:	40a00533          	neg	a0,a0
    800039e2:	74a2                	ld	s1,40(sp)
}
    800039e4:	70e2                	ld	ra,56(sp)
    800039e6:	7442                	ld	s0,48(sp)
    800039e8:	7902                	ld	s2,32(sp)
    800039ea:	69e2                	ld	s3,24(sp)
    800039ec:	6a42                	ld	s4,16(sp)
    800039ee:	6121                	addi	sp,sp,64
    800039f0:	8082                	ret
    iput(ip);
    800039f2:	981ff0ef          	jal	80003372 <iput>
    return -1;
    800039f6:	557d                	li	a0,-1
    800039f8:	b7f5                	j	800039e4 <dirlink+0x78>
      panic("dirlink read");
    800039fa:	00004517          	auipc	a0,0x4
    800039fe:	ace50513          	addi	a0,a0,-1330 # 800074c8 <etext+0x4c8>
    80003a02:	ddffc0ef          	jal	800007e0 <panic>

0000000080003a06 <namei>:
...
namei(char *path)
{
  ...
  return namex(path, 0, name);
    80003a0e:	fe040613          	addi	a2,s0,-32
    80003a12:	4581                	li	a1,0
    80003a14:	e29ff0ef          	jal	8000383c <namex>
}
...
0000000080003a20 <nameiparent>:

struct inode*
nameiparent(char *path, char *name)
{
    80003a20:	1141                	addi	sp,sp,-16
    80003a22:	e406                	sd	ra,8(sp)
    80003a24:	e022                	sd	s0,0(sp)
    80003a26:	0800                	addi	s0,sp,16
    80003a28:	862e                	mv	a2,a1
  return namex(path, 1, name);
    80003a2a:	4585                	li	a1,1
    80003a2c:	e11ff0ef          	jal	8000383c <namex>
}
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    80003a44:	0001c917          	auipc	s2,0x1c
    80003a48:	0e490913          	addi	s2,s2,228 # 8001fb28 <log>
    80003a4c:	01892583          	lw	a1,24(s2)
    80003a50:	02492503          	lw	a0,36(s2)
    80003a54:	8d0ff0ef          	jal	80002b24 <bread>
    80003a58:	84aa                	mv	s1,a0
  struct logheader *hb = (struct logheader *) (buf->data);
  int i;
  hb->n = log.lh.n;
    80003a5a:	02892603          	lw	a2,40(s2)
    80003a5e:	cd30                	sw	a2,88(a0)
  for (i = 0; i < log.lh.n; i++) {
    80003a60:	00c05f63          	blez	a2,80003a7e <write_head+0x46>
    80003a64:	0001c717          	auipc	a4,0x1c
    80003a68:	0f070713          	addi	a4,a4,240 # 8001fb54 <log+0x2c>
    80003a6c:	87aa                	mv	a5,a0
    80003a6e:	060a                	slli	a2,a2,0x2
    80003a70:	962a                	add	a2,a2,a0
    hb->block[i] = log.lh.block[i];
    80003a72:	4314                	lw	a3,0(a4)
    80003a74:	cff4                	sw	a3,92(a5)
  for (i = 0; i < log.lh.n; i++) {
    80003a76:	0711                	addi	a4,a4,4
    80003a78:	0791                	addi	a5,a5,4
    80003a7a:	fec79ce3          	bne	a5,a2,80003a72 <write_head+0x3a>
  }
  bwrite(buf);
    80003a7e:	8526                	mv	a0,s1
    80003a80:	97aff0ef          	jal	80002bfa <bwrite>
  brelse(buf);
    80003a84:	8526                	mv	a0,s1
    80003a86:	9a6ff0ef          	jal	80002c2c <brelse>
}
...
0000000080003a96 <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    80003a96:	0001c797          	auipc	a5,0x1c
    80003a9a:	0ba7a783          	lw	a5,186(a5) # 8001fb50 <log+0x28>
    80003a9e:	0af05e63          	blez	a5,80003b5a <install_trans+0xc4>
{
    ...
    80003aba:	0001ca97          	auipc	s5,0x1c
    80003abe:	09aa8a93          	addi	s5,s5,154 # 8001fb54 <log+0x2c>
  for (tail = 0; tail < log.lh.n; tail++) {
    80003ac2:	4981                	li	s3,0
      printf("recovering tail %d dst %d\n", tail, log.lh.block[tail]);
    80003ac4:	00004b97          	auipc	s7,0x4
    80003ac8:	a14b8b93          	addi	s7,s7,-1516 # 800074d8 <etext+0x4d8>
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80003acc:	0001ca17          	auipc	s4,0x1c
    80003ad0:	05ca0a13          	addi	s4,s4,92 # 8001fb28 <log>
    80003ad4:	a025                	j	80003afc <install_trans+0x66>
      printf("recovering tail %d dst %d\n", tail, log.lh.block[tail]);
    80003ad6:	000aa603          	lw	a2,0(s5)
    80003ada:	85ce                	mv	a1,s3
    80003adc:	855e                	mv	a0,s7
    80003ade:	a1dfc0ef          	jal	800004fa <printf>
    80003ae2:	a839                	j	80003b00 <install_trans+0x6a>
    brelse(lbuf);
    80003ae4:	854a                	mv	a0,s2
    80003ae6:	946ff0ef          	jal	80002c2c <brelse>
    brelse(dbuf);
    80003aea:	8526                	mv	a0,s1
    80003aec:	940ff0ef          	jal	80002c2c <brelse>
  for (tail = 0; tail < log.lh.n; tail++) {
    80003af0:	2985                	addiw	s3,s3,1
    80003af2:	0a91                	addi	s5,s5,4
    80003af4:	028a2783          	lw	a5,40(s4)
    80003af8:	04f9d663          	bge	s3,a5,80003b44 <install_trans+0xae>
    if(recovering) {
    80003afc:	fc0b1de3          	bnez	s6,80003ad6 <install_trans+0x40>
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80003b00:	018a2583          	lw	a1,24(s4)
    80003b04:	013585bb          	addw	a1,a1,s3
    80003b08:	2585                	addiw	a1,a1,1
    80003b0a:	024a2503          	lw	a0,36(s4)
    80003b0e:	816ff0ef          	jal	80002b24 <bread>
    80003b12:	892a                	mv	s2,a0
    struct buf *dbuf = bread(log.dev, log.lh.block[tail]); // read dst
    80003b14:	000aa583          	lw	a1,0(s5)
    80003b18:	024a2503          	lw	a0,36(s4)
    80003b1c:	808ff0ef          	jal	80002b24 <bread>
    80003b20:	84aa                	mv	s1,a0
    memmove(dbuf->data, lbuf->data, BSIZE);  // copy block to dst
    80003b22:	40000613          	li	a2,1024
    80003b26:	05890593          	addi	a1,s2,88
    80003b2a:	05850513          	addi	a0,a0,88
    80003b2e:	9d0fd0ef          	jal	80000cfe <memmove>
    bwrite(dbuf);  // write dst to disk
    80003b32:	8526                	mv	a0,s1
    80003b34:	8c6ff0ef          	jal	80002bfa <bwrite>
    if(recovering == 0)
    80003b38:	fa0b16e3          	bnez	s6,80003ae4 <install_trans+0x4e>
      bunpin(dbuf);
    80003b3c:	8526                	mv	a0,s1
    80003b3e:	9aaff0ef          	jal	80002ce8 <bunpin>
    80003b42:	b74d                	j	80003ae4 <install_trans+0x4e>
}
...
0000000080003b5c <initlog>:
{
    80003b5c:	7179                	addi	sp,sp,-48
  ...
  initlock(&log.lock, "log");
    80003b6e:	0001c497          	auipc	s1,0x1c
    80003b72:	fba48493          	addi	s1,s1,-70 # 8001fb28 <log>
    80003b76:	00004597          	auipc	a1,0x4
    80003b7a:	98258593          	addi	a1,a1,-1662 # 800074f8 <etext+0x4f8>
    80003b7e:	8526                	mv	a0,s1
    80003b80:	fcffc0ef          	jal	80000b4e <initlock>
  log.start = sb->logstart;
    80003b84:	0149a583          	lw	a1,20(s3)
    80003b88:	cc8c                	sw	a1,24(s1)
  log.dev = dev;
    80003b8a:	0324a223          	sw	s2,36(s1)
  struct buf *buf = bread(log.dev, log.start);
    80003b8e:	854a                	mv	a0,s2
    80003b90:	f95fe0ef          	jal	80002b24 <bread>
  log.lh.n = lh->n;
    80003b94:	4d30                	lw	a2,88(a0)
    80003b96:	d490                	sw	a2,40(s1)
  for (i = 0; i < log.lh.n; i++) {
    80003b98:	00c05f63          	blez	a2,80003bb6 <initlog+0x5a>
    80003b9c:	87aa                	mv	a5,a0
    80003b9e:	0001c717          	auipc	a4,0x1c
    80003ba2:	fb670713          	addi	a4,a4,-74 # 8001fb54 <log+0x2c>
    80003ba6:	060a                	slli	a2,a2,0x2
    80003ba8:	962a                	add	a2,a2,a0
    log.lh.block[i] = lh->block[i];
    80003baa:	4ff4                	lw	a3,92(a5)
    80003bac:	c314                	sw	a3,0(a4)
  for (i = 0; i < log.lh.n; i++) {
    80003bae:	0791                	addi	a5,a5,4
    80003bb0:	0711                	addi	a4,a4,4
    80003bb2:	fec79ce3          	bne	a5,a2,80003baa <initlog+0x4e>
  brelse(buf);
    80003bb6:	876ff0ef          	jal	80002c2c <brelse>
...
recover_from_log(void)
{
  ...
  install_trans(1); // if committed, copy from log to disk
    80003bba:	4505                	li	a0,1
    80003bbc:	edbff0ef          	jal	80003a96 <install_trans>
  log.lh.n = 0;
    80003bc0:	0001c797          	auipc	a5,0x1c
    80003bc4:	f807a823          	sw	zero,-112(a5) # 8001fb50 <log+0x28>
  write_head(); // clear the log
    80003bc8:	e71ff0ef          	jal	80003a38 <write_head>
}
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80003bea:	f4250513          	addi	a0,a0,-190 # 8001fb28 <log>
    80003bee:	fe1fc0ef          	jal	80000bce <acquire>
  while(1){
    if(log.committing){
    80003bf2:	0001c497          	auipc	s1,0x1c
    80003bf6:	f3648493          	addi	s1,s1,-202 # 8001fb28 <log>
      sleep(&log, &log.lock);
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGBLOCKS){
    80003bfa:	4979                	li	s2,30
    80003bfc:	a029                	j	80003c06 <begin_op+0x2c>
      sleep(&log, &log.lock);
    80003bfe:	85a6                	mv	a1,s1
    80003c00:	8526                	mv	a0,s1
    80003c02:	adefe0ef          	jal	80001ee0 <sleep>
    if(log.committing){
    80003c06:	509c                	lw	a5,32(s1)
    80003c08:	fbfd                	bnez	a5,80003bfe <begin_op+0x24>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGBLOCKS){
    80003c0a:	4cd8                	lw	a4,28(s1)
    80003c0c:	2705                	addiw	a4,a4,1
    80003c0e:	0027179b          	slliw	a5,a4,0x2
    80003c12:	9fb9                	addw	a5,a5,a4
    80003c14:	0017979b          	slliw	a5,a5,0x1
    80003c18:	5494                	lw	a3,40(s1)
    80003c1a:	9fb5                	addw	a5,a5,a3
    80003c1c:	00f95763          	bge	s2,a5,80003c2a <begin_op+0x50>
      // this op might exhaust log space; wait for commit.
      sleep(&log, &log.lock);
    80003c20:	85a6                	mv	a1,s1
    80003c22:	8526                	mv	a0,s1
    80003c24:	abcfe0ef          	jal	80001ee0 <sleep>
    80003c28:	bff9                	j	80003c06 <begin_op+0x2c>
    } else {
      log.outstanding += 1;
    80003c2a:	0001c517          	auipc	a0,0x1c
    80003c2e:	efe50513          	addi	a0,a0,-258 # 8001fb28 <log>
    80003c32:	cd58                	sw	a4,28(a0)
      release(&log.lock);
    80003c34:	832fd0ef          	jal	80000c66 <release>
      break;
    }
  }
}
...
end_op(void)
{
    ...
    80003c4e:	0080                	addi	s0,sp,64
  int do_commit = 0;

  acquire(&log.lock);
    80003c50:	0001c497          	auipc	s1,0x1c
    80003c54:	ed848493          	addi	s1,s1,-296 # 8001fb28 <log>
    80003c58:	8526                	mv	a0,s1
    80003c5a:	f75fc0ef          	jal	80000bce <acquire>
  log.outstanding -= 1;
    80003c5e:	4cdc                	lw	a5,28(s1)
    80003c60:	37fd                	addiw	a5,a5,-1
    80003c62:	0007891b          	sext.w	s2,a5
    80003c66:	ccdc                	sw	a5,28(s1)
  if(log.committing)
    80003c68:	509c                	lw	a5,32(s1)
    80003c6a:	ef9d                	bnez	a5,80003ca8 <end_op+0x64>
    panic("log.committing");
  if(log.outstanding == 0){
    80003c6c:	04091763          	bnez	s2,80003cba <end_op+0x76>
    do_commit = 1;
    log.committing = 1;
    80003c70:	0001c497          	auipc	s1,0x1c
    80003c74:	eb848493          	addi	s1,s1,-328 # 8001fb28 <log>
  ...
  release(&log.lock);
    ...
    80003c7e:	fe9fc0ef          	jal	80000c66 <release>
}
...
commit()
{
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    80003ce0:	0001ca97          	auipc	s5,0x1c
    80003ce4:	e74a8a93          	addi	s5,s5,-396 # 8001fb54 <log+0x2c>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    80003ce8:	0001ca17          	auipc	s4,0x1c
    80003cec:	e40a0a13          	addi	s4,s4,-448 # 8001fb28 <log>
    80003cf0:	018a2583          	lw	a1,24(s4)
    80003cf4:	012585bb          	addw	a1,a1,s2
    80003cf8:	2585                	addiw	a1,a1,1
    80003cfa:	024a2503          	lw	a0,36(s4)
    80003cfe:	e27fe0ef          	jal	80002b24 <bread>
    80003d02:	84aa                	mv	s1,a0
    struct buf *from = bread(log.dev, log.lh.block[tail]); // cache block
    80003d04:	000aa583          	lw	a1,0(s5)
    80003d08:	024a2503          	lw	a0,36(s4)
    80003d0c:	e19fe0ef          	jal	80002b24 <bread>
    80003d10:	89aa                	mv	s3,a0
    memmove(to->data, from->data, BSIZE);
    80003d12:	40000613          	li	a2,1024
    80003d16:	05850593          	addi	a1,a0,88
    80003d1a:	05848513          	addi	a0,s1,88
    80003d1e:	fe1fc0ef          	jal	80000cfe <memmove>
    bwrite(to);  // write the log
    80003d22:	8526                	mv	a0,s1
    80003d24:	ed7fe0ef          	jal	80002bfa <bwrite>
    brelse(from);
    80003d28:	854e                	mv	a0,s3
    80003d2a:	f03fe0ef          	jal	80002c2c <brelse>
    brelse(to);
    80003d2e:	8526                	mv	a0,s1
    80003d30:	efdfe0ef          	jal	80002c2c <brelse>
  for (tail = 0; tail < log.lh.n; tail++) {
    80003d34:	2905                	addiw	s2,s2,1
    80003d36:	0a91                	addi	s5,s5,4
    80003d38:	028a2783          	lw	a5,40(s4)
    80003d3c:	faf94ae3          	blt	s2,a5,80003cf0 <end_op+0xac>
    write_log();     // Write modified blocks from cache to log
    write_head();    // Write header to disk -- the real commit
    80003d40:	cf9ff0ef          	jal	80003a38 <write_head>
    install_trans(0); // Now install writes to home locations
    80003d44:	4501                	li	a0,0
    80003d46:	d51ff0ef          	jal	80003a96 <install_trans>
    log.lh.n = 0;
    80003d4a:	0001c797          	auipc	a5,0x1c
    80003d4e:	e007a323          	sw	zero,-506(a5) # 8001fb50 <log+0x28>
    write_head();    // Erase the transaction from the log
    80003d52:	ce7ff0ef          	jal	80003a38 <write_head>
    80003d56:	69e2                	ld	s3,24(sp)
    80003d58:	6a42                	ld	s4,16(sp)
    80003d5a:	6aa2                	ld	s5,8(sp)
    80003d5c:	b735                	j	80003c88 <end_op+0x44>

0000000080003d5e <log_write>:
//   modify bp->data[]
//   log_write(bp)
//   brelse(bp)
void
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    80003d6c:	0001c917          	auipc	s2,0x1c
    80003d70:	dbc90913          	addi	s2,s2,-580 # 8001fb28 <log>
    80003d74:	854a                	mv	a0,s2
    80003d76:	e59fc0ef          	jal	80000bce <acquire>
  if (log.lh.n >= LOGBLOCKS)
    80003d7a:	02892603          	lw	a2,40(s2)
    80003d7e:	47f5                	li	a5,29
    80003d80:	04c7cc63          	blt	a5,a2,80003dd8 <log_write+0x7a>
    panic("too big a transaction");
  if (log.outstanding < 1)
    80003d84:	0001c797          	auipc	a5,0x1c
    80003d88:	dc07a783          	lw	a5,-576(a5) # 8001fb44 <log+0x1c>
    80003d8c:	04f05c63          	blez	a5,80003de4 <log_write+0x86>
    panic("log_write outside of trans");

  for (i = 0; i < log.lh.n; i++) {
    80003d90:	4781                	li	a5,0
    80003d92:	04c05f63          	blez	a2,80003df0 <log_write+0x92>
    if (log.lh.block[i] == b->blockno)   // log absorption
    80003d96:	44cc                	lw	a1,12(s1)
    80003d98:	0001c717          	auipc	a4,0x1c
    80003d9c:	dbc70713          	addi	a4,a4,-580 # 8001fb54 <log+0x2c>
  for (i = 0; i < log.lh.n; i++) {
    80003da0:	4781                	li	a5,0
    if (log.lh.block[i] == b->blockno)   // log absorption
    80003da2:	4314                	lw	a3,0(a4)
    80003da4:	04b68663          	beq	a3,a1,80003df0 <log_write+0x92>
  for (i = 0; i < log.lh.n; i++) {
    80003da8:	2785                	addiw	a5,a5,1
    80003daa:	0711                	addi	a4,a4,4
    80003dac:	fef61be3          	bne	a2,a5,80003da2 <log_write+0x44>
      break;
  }
  log.lh.block[i] = b->blockno;
    80003db0:	0621                	addi	a2,a2,8
    80003db2:	060a                	slli	a2,a2,0x2
    80003db4:	0001c797          	auipc	a5,0x1c
    80003db8:	d7478793          	addi	a5,a5,-652 # 8001fb28 <log>
    80003dbc:	97b2                	add	a5,a5,a2
    80003dbe:	44d8                	lw	a4,12(s1)
    80003dc0:	c7d8                	sw	a4,12(a5)
  if (i == log.lh.n) {  // Add new block to log?
    bpin(b);
    80003dc2:	8526                	mv	a0,s1
    80003dc4:	ef1fe0ef          	jal	80002cb4 <bpin>
    log.lh.n++;
    80003dc8:	0001c717          	auipc	a4,0x1c
    80003dcc:	d6070713          	addi	a4,a4,-672 # 8001fb28 <log>
    80003dd0:	571c                	lw	a5,40(a4)
    80003dd2:	2785                	addiw	a5,a5,1
    80003dd4:	d71c                	sw	a5,40(a4)
    80003dd6:	a80d                	j	80003e08 <log_write+0xaa>
    panic("too big a transaction");
    80003dd8:	00003517          	auipc	a0,0x3
    80003ddc:	73850513          	addi	a0,a0,1848 # 80007510 <etext+0x510>
    80003de0:	a01fc0ef          	jal	800007e0 <panic>
    panic("log_write outside of trans");
    80003de4:	00003517          	auipc	a0,0x3
    80003de8:	74450513          	addi	a0,a0,1860 # 80007528 <etext+0x528>
    80003dec:	9f5fc0ef          	jal	800007e0 <panic>
  log.lh.block[i] = b->blockno;
    80003df0:	00878693          	addi	a3,a5,8
    80003df4:	068a                	slli	a3,a3,0x2
    80003df6:	0001c717          	auipc	a4,0x1c
    80003dfa:	d3270713          	addi	a4,a4,-718 # 8001fb28 <log>
    80003dfe:	9736                	add	a4,a4,a3
    80003e00:	44d4                	lw	a3,12(s1)
    80003e02:	c754                	sw	a3,12(a4)
  if (i == log.lh.n) {  // Add new block to log?
    80003e04:	faf60fe3          	beq	a2,a5,80003dc2 <log_write+0x64>
  }
  release(&log.lock);
    80003e08:	0001c517          	auipc	a0,0x1c
    80003e0c:	d2050513          	addi	a0,a0,-736 # 8001fb28 <log>
    80003e10:	e57fc0ef          	jal	80000c66 <release>
}
...
0000000080003e20 <initsleeplock>:
#include "proc.h"
#include "sleeplock.h"
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    80003e34:	71858593          	addi	a1,a1,1816 # 80007548 <etext+0x548>
    80003e38:	0521                	addi	a0,a0,8
    80003e3a:	d15fc0ef          	jal	80000b4e <initlock>
  lk->name = name;
    80003e3e:	0324b023          	sd	s2,32(s1)
  lk->locked = 0;
    80003e42:	0004a023          	sw	zero,0(s1)
  lk->pid = 0;
    80003e46:	0204a423          	sw	zero,40(s1)
}
...
acquiresleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80003e6a:	d65fc0ef          	jal	80000bce <acquire>
  while (lk->locked) {
    80003e6e:	409c                	lw	a5,0(s1)
    80003e70:	c799                	beqz	a5,80003e7e <acquiresleep+0x28>
    sleep(lk, &lk->lk);
    80003e72:	85ca                	mv	a1,s2
    80003e74:	8526                	mv	a0,s1
    80003e76:	86afe0ef          	jal	80001ee0 <sleep>
  while (lk->locked) {
    80003e7a:	409c                	lw	a5,0(s1)
    80003e7c:	fbfd                	bnez	a5,80003e72 <acquiresleep+0x1c>
  }
  lk->locked = 1;
    80003e7e:	4785                	li	a5,1
    80003e80:	c09c                	sw	a5,0(s1)
  lk->pid = myproc()->pid;
    80003e82:	a4dfd0ef          	jal	800018ce <myproc>
    80003e86:	591c                	lw	a5,48(a0)
    80003e88:	d49c                	sw	a5,40(s1)
  release(&lk->lk);
    80003e8a:	854a                	mv	a0,s2
    80003e8c:	ddbfc0ef          	jal	80000c66 <release>
}
...
releasesleep(struct sleeplock *lk)
{
  ...
  wakeup(lk);
    ...
    80003ebe:	86efe0ef          	jal	80001f2c <wakeup>
  release(&lk->lk);
...
holdingsleep(struct sleeplock *lk)
{
  ...
  r = lk->locked && (lk->pid == myproc()->pid);
    ...
    80003eee:	ef81                	bnez	a5,80003f06 <holdingsleep+0x32>
    80003ef0:	4481                	li	s1,0
  release(&lk->lk);
    80003ef2:	854a                	mv	a0,s2
    80003ef4:	d73fc0ef          	jal	80000c66 <release>
  return r;
}
    ...
    80003f00:	6942                	ld	s2,16(sp)
    80003f02:	6145                	addi	sp,sp,48
    80003f04:	8082                	ret
    80003f06:	e44e                	sd	s3,8(sp)
  r = lk->locked && (lk->pid == myproc()->pid);
    80003f08:	0284a983          	lw	s3,40(s1)
    80003f0c:	9c3fd0ef          	jal	800018ce <myproc>
    80003f10:	5904                	lw	s1,48(a0)
    80003f12:	413484b3          	sub	s1,s1,s3
    80003f16:	0014b493          	seqz	s1,s1
    80003f1a:	69a2                	ld	s3,8(sp)
    80003f1c:	bfd9                	j	80003ef2 <holdingsleep+0x1e>

0000000080003f1e <fileinit>:
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    80003f26:	00003597          	auipc	a1,0x3
    80003f2a:	63258593          	addi	a1,a1,1586 # 80007558 <etext+0x558>
    80003f2e:	0001c517          	auipc	a0,0x1c
    80003f32:	d4250513          	addi	a0,a0,-702 # 8001fc70 <ftable>
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    80003f50:	d2450513          	addi	a0,a0,-732 # 8001fc70 <ftable>
    80003f54:	c7bfc0ef          	jal	80000bce <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    80003f58:	0001c497          	auipc	s1,0x1c
    80003f5c:	d3048493          	addi	s1,s1,-720 # 8001fc88 <ftable+0x18>
    80003f60:	0001d717          	auipc	a4,0x1d
    80003f64:	cc870713          	addi	a4,a4,-824 # 80020c28 <disk>
    if(f->ref == 0){
    80003f68:	40dc                	lw	a5,4(s1)
    80003f6a:	cf89                	beqz	a5,80003f84 <filealloc+0x42>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    80003f6c:	02848493          	addi	s1,s1,40
    80003f70:	fee49ce3          	bne	s1,a4,80003f68 <filealloc+0x26>
      f->ref = 1;
      release(&ftable.lock);
      return f;
    }
  ...
  release(&ftable.lock);
    ...
    80003f78:	cfc50513          	addi	a0,a0,-772 # 8001fc70 <ftable>
    80003f7c:	cebfc0ef          	jal	80000c66 <release>
  return 0;
    80003f80:	4481                	li	s1,0
    80003f82:	a809                	j	80003f94 <filealloc+0x52>
      f->ref = 1;
    80003f84:	4785                	li	a5,1
    80003f86:	c0dc                	sw	a5,4(s1)
      release(&ftable.lock);
    80003f88:	0001c517          	auipc	a0,0x1c
    80003f8c:	ce850513          	addi	a0,a0,-792 # 8001fc70 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003fb0:	cc450513          	addi	a0,a0,-828 # 8001fc70 <ftable>
  ...
  release(&ftable.lock);
    ...
    80003fc6:	cae50513          	addi	a0,a0,-850 # 8001fc70 <ftable>
  ...
  return f;
    ...
    80003fde:	58650513          	addi	a0,a0,1414 # 80007560 <etext+0x560>
    80003fe2:	ffefc0ef          	jal	800007e0 <panic>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003ff6:	c7e50513          	addi	a0,a0,-898 # 8001fc70 <ftable>
    80003ffa:	bd5fc0ef          	jal	80000bce <acquire>
  if(f->ref < 1)
    80003ffe:	40dc                	lw	a5,4(s1)
    80004000:	04f05a63          	blez	a5,80004054 <fileclose+0x6e>
    panic("fileclose");
  if(--f->ref > 0){
    80004004:	37fd                	addiw	a5,a5,-1
    80004006:	0007871b          	sext.w	a4,a5
    8000400a:	c0dc                	sw	a5,4(s1)
    8000400c:	04e04e63          	bgtz	a4,80004068 <fileclose+0x82>
  ...
  release(&ftable.lock);
    ...
    80004034:	c4050513          	addi	a0,a0,-960 # 8001fc70 <ftable>
    80004038:	c2ffc0ef          	jal	80000c66 <release>

  if(ff.type == FD_PIPE){
    8000403c:	4785                	li	a5,1
    8000403e:	04f90063          	beq	s2,a5,8000407e <fileclose+0x98>
    pipeclose(ff.pipe, ff.writable);
  } else if(ff.type == FD_INODE || ff.type == FD_DEVICE){
    80004042:	3979                	addiw	s2,s2,-2
    80004044:	4785                	li	a5,1
    80004046:	0527f563          	bgeu	a5,s2,80004090 <fileclose+0xaa>
    8000404a:	7902                	ld	s2,32(sp)
    8000404c:	69e2                	ld	s3,24(sp)
    8000404e:	6a42                	ld	s4,16(sp)
    80004050:	6aa2                	ld	s5,8(sp)
    80004052:	a00d                	j	80004074 <fileclose+0x8e>
    ...
    80004060:	50c50513          	addi	a0,a0,1292 # 80007568 <etext+0x568>
    80004064:	f7cfc0ef          	jal	800007e0 <panic>
    release(&ftable.lock);
    80004068:	0001c517          	auipc	a0,0x1c
    8000406c:	c0850513          	addi	a0,a0,-1016 # 8001fc70 <ftable>
    ...
    80004082:	336000ef          	jal	800043b8 <pipeclose>
    80004086:	7902                	ld	s2,32(sp)
    80004088:	69e2                	ld	s3,24(sp)
    8000408a:	6a42                	ld	s4,16(sp)
    8000408c:	6aa2                	ld	s5,8(sp)
    8000408e:	b7dd                	j	80004074 <fileclose+0x8e>
    begin_op();
    80004090:	b4bff0ef          	jal	80003bda <begin_op>
    iput(ff.ip);
    80004094:	854e                	mv	a0,s3
    80004096:	adcff0ef          	jal	80003372 <iput>
    end_op();
    8000409a:	babff0ef          	jal	80003c44 <end_op>
    8000409e:	7902                	ld	s2,32(sp)
    800040a0:	69e2                	ld	s3,24(sp)
    800040a2:	6a42                	ld	s4,16(sp)
    800040a4:	6aa2                	ld	s5,8(sp)
    800040a6:	b7f9                	j	80004074 <fileclose+0x8e>

00000000800040a8 <filestat>:
...
filestat(struct file *f, uint64 addr)
{
  ...
  if(f->type == FD_INODE || f->type == FD_DEVICE){
    800040bc:	409c                	lw	a5,0(s1)
    800040be:	37f9                	addiw	a5,a5,-2
    800040c0:	4705                	li	a4,1
    800040c2:	04f76063          	bltu	a4,a5,80004102 <filestat+0x5a>
    800040c6:	f84a                	sd	s2,48(sp)
    800040c8:	892a                	mv	s2,a0
    ilock(f->ip);
    800040ca:	6c88                	ld	a0,24(s1)
    800040cc:	924ff0ef          	jal	800031f0 <ilock>
    stati(f->ip, &st);
    800040d0:	fb840593          	addi	a1,s0,-72
    800040d4:	6c88                	ld	a0,24(s1)
    800040d6:	c80ff0ef          	jal	80003556 <stati>
    iunlock(f->ip);
    800040da:	6c88                	ld	a0,24(s1)
    800040dc:	9c2ff0ef          	jal	8000329e <iunlock>
    if(copyout(p->pagetable, addr, (char *)&st, sizeof(st)) < 0)
    800040e0:	46e1                	li	a3,24
    800040e2:	fb840613          	addi	a2,s0,-72
    800040e6:	85ce                	mv	a1,s3
    800040e8:	05093503          	ld	a0,80(s2)
    800040ec:	cf6fd0ef          	jal	800015e2 <copyout>
    800040f0:	41f5551b          	sraiw	a0,a0,0x1f
  ...
  return -1;
    ...
    80004104:	bfcd                	j	800040f6 <filestat+0x4e>

0000000080004106 <fileread>:
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  if(f->readable == 0)
    80004110:	00854783          	lbu	a5,8(a0)
    80004114:	cfd1                	beqz	a5,800041b0 <fileread+0xaa>
    80004116:	ec26                	sd	s1,24(sp)
    80004118:	e44e                	sd	s3,8(sp)
    8000411a:	84aa                	mv	s1,a0
    8000411c:	89ae                	mv	s3,a1
    8000411e:	8932                	mv	s2,a2
    return -1;

  if(f->type == FD_PIPE){
    80004120:	411c                	lw	a5,0(a0)
    80004122:	4705                	li	a4,1
    80004124:	04e78363          	beq	a5,a4,8000416a <fileread+0x64>
#if PIPE_TRACE
    printf("[TRACE R5] fileread()    : FD_PIPE n=%d -> piperead()\n", n);
#endif
    r = piperead(f->pipe, addr, n);
  } else if(f->type == FD_DEVICE){
    80004128:	470d                	li	a4,3
    8000412a:	04e78763          	beq	a5,a4,80004178 <fileread+0x72>
    if(f->major < 0 || f->major >= NDEV || !devsw[f->major].read)
      return -1;
    r = devsw[f->major].read(1, addr, n);
  } else if(f->type == FD_INODE){
    8000412e:	4709                	li	a4,2
    80004130:	06e79a63          	bne	a5,a4,800041a4 <fileread+0x9e>
    ilock(f->ip);
    80004134:	6d08                	ld	a0,24(a0)
    80004136:	8baff0ef          	jal	800031f0 <ilock>
    if((r = readi(f->ip, 1, addr, f->off, n)) > 0)
    8000413a:	874a                	mv	a4,s2
    8000413c:	5094                	lw	a3,32(s1)
    8000413e:	864e                	mv	a2,s3
    80004140:	4585                	li	a1,1
    80004142:	6c88                	ld	a0,24(s1)
    80004144:	c3cff0ef          	jal	80003580 <readi>
    80004148:	892a                	mv	s2,a0
    8000414a:	00a05563          	blez	a0,80004154 <fileread+0x4e>
      f->off += r;
    8000414e:	509c                	lw	a5,32(s1)
    80004150:	9fa9                	addw	a5,a5,a0
    80004152:	d09c                	sw	a5,32(s1)
    iunlock(f->ip);
    80004154:	6c88                	ld	a0,24(s1)
    80004156:	948ff0ef          	jal	8000329e <iunlock>
  ...
  return r;
    ...
    80004164:	6942                	ld	s2,16(sp)
    80004166:	6145                	addi	sp,sp,48
    80004168:	8082                	ret
    r = piperead(f->pipe, addr, n);
    8000416a:	6908                	ld	a0,16(a0)
    8000416c:	388000ef          	jal	800044f4 <piperead>
    80004170:	892a                	mv	s2,a0
    80004172:	64e2                	ld	s1,24(sp)
    80004174:	69a2                	ld	s3,8(sp)
    80004176:	b7e5                	j	8000415e <fileread+0x58>
    if(f->major < 0 || f->major >= NDEV || !devsw[f->major].read)
    80004178:	02451783          	lh	a5,36(a0)
    8000417c:	03079693          	slli	a3,a5,0x30
    80004180:	92c1                	srli	a3,a3,0x30
    80004182:	4725                	li	a4,9
    80004184:	02d76863          	bltu	a4,a3,800041b4 <fileread+0xae>
    80004188:	0792                	slli	a5,a5,0x4
    8000418a:	0001c717          	auipc	a4,0x1c
    8000418e:	a4670713          	addi	a4,a4,-1466 # 8001fbd0 <devsw>
    80004192:	97ba                	add	a5,a5,a4
    80004194:	639c                	ld	a5,0(a5)
    80004196:	c39d                	beqz	a5,800041bc <fileread+0xb6>
    r = devsw[f->major].read(1, addr, n);
    ...
    800041a2:	bf75                	j	8000415e <fileread+0x58>
    panic("fileread");
    800041a4:	00003517          	auipc	a0,0x3
    800041a8:	3d450513          	addi	a0,a0,980 # 80007578 <etext+0x578>
    800041ac:	e34fc0ef          	jal	800007e0 <panic>
    return -1;
    800041b0:	597d                	li	s2,-1
    800041b2:	b775                	j	8000415e <fileread+0x58>
      return -1;
    800041b4:	597d                	li	s2,-1
    800041b6:	64e2                	ld	s1,24(sp)
    800041b8:	69a2                	ld	s3,8(sp)
    800041ba:	b755                	j	8000415e <fileread+0x58>
    800041bc:	597d                	li	s2,-1
    800041be:	64e2                	ld	s1,24(sp)
    800041c0:	69a2                	ld	s3,8(sp)
    800041c2:	bf71                	j	8000415e <fileread+0x58>

00000000800041c4 <filewrite>:
int
filewrite(struct file *f, uint64 addr, int n)
{
  ...
  if(f->writable == 0)
    800041c4:	00954783          	lbu	a5,9(a0)
    800041c8:	10078b63          	beqz	a5,800042de <filewrite+0x11a>
{
    800041cc:	715d                	addi	sp,sp,-80
    800041ce:	e486                	sd	ra,72(sp)
    800041d0:	e0a2                	sd	s0,64(sp)
    800041d2:	f84a                	sd	s2,48(sp)
    800041d4:	f052                	sd	s4,32(sp)
    800041d6:	e85a                	sd	s6,16(sp)
    800041d8:	0880                	addi	s0,sp,80
    800041da:	892a                	mv	s2,a0
    800041dc:	8b2e                	mv	s6,a1
    800041de:	8a32                	mv	s4,a2
    return -1;

  if(f->type == FD_PIPE){
    800041e0:	411c                	lw	a5,0(a0)
    800041e2:	4705                	li	a4,1
    800041e4:	02e78763          	beq	a5,a4,80004212 <filewrite+0x4e>
#if PIPE_TRACE
    ...
    800041ea:	02e78863          	beq	a5,a4,8000421a <filewrite+0x56>
    if(f->major < 0 || f->major >= NDEV || !devsw[f->major].write)
      return -1;
    ret = devsw[f->major].write(1, addr, n);
  } else if(f->type == FD_INODE){
    800041ee:	4709                	li	a4,2
    800041f0:	0ce79c63          	bne	a5,a4,800042c8 <filewrite+0x104>
    ...
    int i = 0;
    while(i < n){
    800041f6:	0ac05863          	blez	a2,800042a6 <filewrite+0xe2>
    800041fa:	fc26                	sd	s1,56(sp)
    800041fc:	ec56                	sd	s5,24(sp)
    800041fe:	e45e                	sd	s7,8(sp)
    80004200:	e062                	sd	s8,0(sp)
    int i = 0;
    ...
    8000420a:	6c05                	lui	s8,0x1
    8000420c:	c00c0c1b          	addiw	s8,s8,-1024 # c00 <_entry-0x7ffff400>
    80004210:	a8b5                	j	8000428c <filewrite+0xc8>
    ret = pipewrite(f->pipe, addr, n);
    80004212:	6908                	ld	a0,16(a0)
    80004214:	1fc000ef          	jal	80004410 <pipewrite>
    80004218:	a04d                	j	800042ba <filewrite+0xf6>
    if(f->major < 0 || f->major >= NDEV || !devsw[f->major].write)
    8000421a:	02451783          	lh	a5,36(a0)
    8000421e:	03079693          	slli	a3,a5,0x30
    80004222:	92c1                	srli	a3,a3,0x30
    80004224:	4725                	li	a4,9
    80004226:	0ad76e63          	bltu	a4,a3,800042e2 <filewrite+0x11e>
    8000422a:	0792                	slli	a5,a5,0x4
    8000422c:	0001c717          	auipc	a4,0x1c
    80004230:	9a470713          	addi	a4,a4,-1628 # 8001fbd0 <devsw>
    80004234:	97ba                	add	a5,a5,a4
    80004236:	679c                	ld	a5,8(a5)
    80004238:	c7dd                	beqz	a5,800042e6 <filewrite+0x122>
    ret = devsw[f->major].write(1, addr, n);
    8000423a:	4505                	li	a0,1
    8000423c:	9782                	jalr	a5
    8000423e:	a8b5                	j	800042ba <filewrite+0xf6>
      if(n1 > max)
    80004240:	00048a9b          	sext.w	s5,s1
        n1 = max;

      begin_op();
    80004244:	997ff0ef          	jal	80003bda <begin_op>
      ilock(f->ip);
    80004248:	01893503          	ld	a0,24(s2)
    8000424c:	fa5fe0ef          	jal	800031f0 <ilock>
      if ((r = writei(f->ip, 1, addr + i, f->off, n1)) > 0)
    80004250:	8756                	mv	a4,s5
    80004252:	02092683          	lw	a3,32(s2)
    80004256:	01698633          	add	a2,s3,s6
    8000425a:	4585                	li	a1,1
    8000425c:	01893503          	ld	a0,24(s2)
    80004260:	c1cff0ef          	jal	8000367c <writei>
    80004264:	84aa                	mv	s1,a0
    80004266:	00a05763          	blez	a0,80004274 <filewrite+0xb0>
        f->off += r;
    ...
    80004278:	826ff0ef          	jal	8000329e <iunlock>
      end_op();
    8000427c:	9c9ff0ef          	jal	80003c44 <end_op>

      if(r != n1){
    80004280:	029a9563          	bne	s5,s1,800042aa <filewrite+0xe6>
        // error from writei
        break;
      }
      i += r;
    80004284:	013489bb          	addw	s3,s1,s3
    while(i < n){
    80004288:	0149da63          	bge	s3,s4,8000429c <filewrite+0xd8>
      int n1 = n - i;
    8000428c:	413a04bb          	subw	s1,s4,s3
      if(n1 > max)
    80004290:	0004879b          	sext.w	a5,s1
    80004294:	fafbd6e3          	bge	s7,a5,80004240 <filewrite+0x7c>
    80004298:	84e2                	mv	s1,s8
    8000429a:	b75d                	j	80004240 <filewrite+0x7c>
    8000429c:	74e2                	ld	s1,56(sp)
    8000429e:	6ae2                	ld	s5,24(sp)
    800042a0:	6ba2                	ld	s7,8(sp)
    800042a2:	6c02                	ld	s8,0(sp)
    800042a4:	a039                	j	800042b2 <filewrite+0xee>
    int i = 0;
    800042a6:	4981                	li	s3,0
    800042a8:	a029                	j	800042b2 <filewrite+0xee>
    800042aa:	74e2                	ld	s1,56(sp)
    800042ac:	6ae2                	ld	s5,24(sp)
    800042ae:	6ba2                	ld	s7,8(sp)
    800042b0:	6c02                	ld	s8,0(sp)
    }
    ret = (i == n ? n : -1);
    800042b2:	033a1c63          	bne	s4,s3,800042ea <filewrite+0x126>
    800042b6:	8552                	mv	a0,s4
    800042b8:	79a2                	ld	s3,40(sp)
  } else {
    panic("filewrite");
  }
  ...
  return ret;
    ...
    800042c0:	7a02                	ld	s4,32(sp)
    800042c2:	6b42                	ld	s6,16(sp)
    800042c4:	6161                	addi	sp,sp,80
    800042c6:	8082                	ret
    800042c8:	fc26                	sd	s1,56(sp)
    800042ca:	f44e                	sd	s3,40(sp)
    800042cc:	ec56                	sd	s5,24(sp)
    800042ce:	e45e                	sd	s7,8(sp)
    800042d0:	e062                	sd	s8,0(sp)
    panic("filewrite");
    800042d2:	00003517          	auipc	a0,0x3
    800042d6:	2b650513          	addi	a0,a0,694 # 80007588 <etext+0x588>
    800042da:	d06fc0ef          	jal	800007e0 <panic>
    return -1;
    ...
    800042e4:	bfd9                	j	800042ba <filewrite+0xf6>
    800042e6:	557d                	li	a0,-1
    800042e8:	bfc9                	j	800042ba <filewrite+0xf6>
    ret = (i == n ? n : -1);
    800042ea:	557d                	li	a0,-1
    800042ec:	79a2                	ld	s3,40(sp)
    800042ee:	b7f1                	j	800042ba <filewrite+0xf6>

00000000800042f0 <pipealloc>:
...
pipealloc(struct file **f0, struct file **f1)
{
    ...
    800042f8:	e052                	sd	s4,0(sp)
    800042fa:	1800                	addi	s0,sp,48
    800042fc:	84aa                	mv	s1,a0
    800042fe:	8a2e                	mv	s4,a1
  struct pipe *pi;

  pi = 0;
  *f0 = *f1 = 0;
    80004300:	0005b023          	sd	zero,0(a1)
    80004304:	00053023          	sd	zero,0(a0)
  if((*f0 = filealloc()) == 0 || (*f1 = filealloc()) == 0)
    80004308:	c3bff0ef          	jal	80003f42 <filealloc>
    8000430c:	e088                	sd	a0,0(s1)
    8000430e:	c549                	beqz	a0,80004398 <pipealloc+0xa8>
    80004310:	c33ff0ef          	jal	80003f42 <filealloc>
    80004314:	00aa3023          	sd	a0,0(s4)
    80004318:	cd25                	beqz	a0,80004390 <pipealloc+0xa0>
    8000431a:	e84a                	sd	s2,16(sp)
    goto bad;
  if((pi = (struct pipe*)kalloc()) == 0)
    8000431c:	fe2fc0ef          	jal	80000afe <kalloc>
    80004320:	892a                	mv	s2,a0
    80004322:	c12d                	beqz	a0,80004384 <pipealloc+0x94>
    80004324:	e44e                	sd	s3,8(sp)
    pi = 0;
    goto bad;
  }
#endif
  ...
  pi->readopen  = 1;
    80004326:	4985                	li	s3,1
    80004328:	23352023          	sw	s3,544(a0)
  pi->writeopen = 1;
    8000432c:	23352223          	sw	s3,548(a0)
  pi->nwrite    = 0;
    80004330:	20052e23          	sw	zero,540(a0)
  pi->nread     = 0;
    80004334:	20052c23          	sw	zero,536(a0)
  initlock(&pi->lock, "pipe");
    80004338:	00003597          	auipc	a1,0x3
    8000433c:	26058593          	addi	a1,a1,608 # 80007598 <etext+0x598>
    80004340:	80ffc0ef          	jal	80000b4e <initlock>
  (*f0)->type = FD_PIPE;
    80004344:	609c                	ld	a5,0(s1)
    80004346:	0137a023          	sw	s3,0(a5)
  (*f0)->readable = 1;
    8000434a:	609c                	ld	a5,0(s1)
    8000434c:	01378423          	sb	s3,8(a5)
  (*f0)->writable = 0;
    80004350:	609c                	ld	a5,0(s1)
    80004352:	000784a3          	sb	zero,9(a5)
  (*f0)->pipe = pi;
    80004356:	609c                	ld	a5,0(s1)
    80004358:	0127b823          	sd	s2,16(a5)
  (*f1)->type = FD_PIPE;
    8000435c:	000a3783          	ld	a5,0(s4)
    80004360:	0137a023          	sw	s3,0(a5)
  (*f1)->readable = 0;
    80004364:	000a3783          	ld	a5,0(s4)
    80004368:	00078423          	sb	zero,8(a5)
  (*f1)->writable = 1;
    8000436c:	000a3783          	ld	a5,0(s4)
    80004370:	013784a3          	sb	s3,9(a5)
  (*f1)->pipe = pi;
    80004374:	000a3783          	ld	a5,0(s4)
    80004378:	0127b823          	sd	s2,16(a5)
  return 0;
    8000437c:	4501                	li	a0,0
    8000437e:	6942                	ld	s2,16(sp)
    80004380:	69a2                	ld	s3,8(sp)
    80004382:	a01d                	j	800043a8 <pipealloc+0xb8>
 ...
 bad:
  ...
  if(*f0)
    ...
    80004386:	c119                	beqz	a0,8000438c <pipealloc+0x9c>
    80004388:	6942                	ld	s2,16(sp)
    8000438a:	a029                	j	80004394 <pipealloc+0xa4>
    8000438c:	6942                	ld	s2,16(sp)
    8000438e:	a029                	j	80004398 <pipealloc+0xa8>
    80004390:	6088                	ld	a0,0(s1)
    80004392:	c10d                	beqz	a0,800043b4 <pipealloc+0xc4>
    fileclose(*f0);
    80004394:	c53ff0ef          	jal	80003fe6 <fileclose>
  if(*f1)
  ...
  if(*f1)
    8000439e:	c789                	beqz	a5,800043a8 <pipealloc+0xb8>
    fileclose(*f1);
    800043a0:	853e                	mv	a0,a5
    800043a2:	c45ff0ef          	jal	80003fe6 <fileclose>
  return -1;
    ...
    800043ae:	6a02                	ld	s4,0(sp)
    800043b0:	6145                	addi	sp,sp,48
    800043b2:	8082                	ret
  return -1;
    800043b4:	557d                	li	a0,-1
    800043b6:	bfcd                	j	800043a8 <pipealloc+0xb8>

00000000800043b8 <pipeclose>:
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  acquire(&pi->lock);
    800043c8:	807fc0ef          	jal	80000bce <acquire>
  if(writable){
    800043cc:	02090763          	beqz	s2,800043fa <pipeclose+0x42>
    pi->writeopen = 0;
    800043d0:	2204a223          	sw	zero,548(s1)
    wakeup(&pi->nread);
    800043d4:	21848513          	addi	a0,s1,536
    800043d8:	b55fd0ef          	jal	80001f2c <wakeup>
  } else {
    pi->readopen = 0;
    wakeup(&pi->nwrite);
  }
  if(pi->readopen == 0 && pi->writeopen == 0){
    800043dc:	2204b783          	ld	a5,544(s1)
    800043e0:	e785                	bnez	a5,80004408 <pipeclose+0x50>
    release(&pi->lock);
    ...
    800043ea:	e32fc0ef          	jal	80000a1c <kfree>
  } else
    release(&pi->lock);
}
    ...
    800043f8:	8082                	ret
    pi->readopen = 0;
    800043fa:	2204a023          	sw	zero,544(s1)
    wakeup(&pi->nwrite);
    800043fe:	21c48513          	addi	a0,s1,540
    80004402:	b2bfd0ef          	jal	80001f2c <wakeup>
    80004406:	bfd9                	j	800043dc <pipeclose+0x24>
    release(&pi->lock);
    80004408:	8526                	mv	a0,s1
    8000440a:	85dfc0ef          	jal	80000c66 <release>
}
    8000440e:	b7c5                	j	800043ee <pipeclose+0x36>

0000000080004410 <pipewrite>:
// ----------------------------------------------------------------------------
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
    ...
    80004420:	1080                	addi	s0,sp,96
    80004422:	84aa                	mv	s1,a0
    80004424:	8aae                	mv	s5,a1
    80004426:	8a32                	mv	s4,a2
  int i = 0;
  struct proc *pr = myproc();
    80004428:	ca6fd0ef          	jal	800018ce <myproc>
  ...
  while(i < n){
    80004434:	0b405a63          	blez	s4,800044e8 <pipewrite+0xd8>
    80004438:	f05a                	sd	s6,32(sp)
    8000443a:	ec5e                	sd	s7,24(sp)
    8000443c:	e862                	sd	s8,16(sp)
  int i = 0;
    ...
    80004440:	5b7d                	li	s6,-1
      wakeup(&pi->nread);
    80004442:	21848c13          	addi	s8,s1,536
      sleep(&pi->nwrite, &pi->lock);
    80004446:	21c48b93          	addi	s7,s1,540
    8000444a:	a81d                	j	80004480 <pipewrite+0x70>
      release(&pi->lock);
    8000444c:	8526                	mv	a0,s1
    8000444e:	819fc0ef          	jal	80000c66 <release>
      return -1;
    80004452:	597d                	li	s2,-1
    80004454:	7b02                	ld	s6,32(sp)
    80004456:	6be2                	ld	s7,24(sp)
    80004458:	6c42                	ld	s8,16(sp)
#if PIPE_TRACE
  ...
  return i;
    ...
    8000445c:	60e6                	ld	ra,88(sp)
    8000445e:	6446                	ld	s0,80(sp)
    80004460:	64a6                	ld	s1,72(sp)
    80004462:	6906                	ld	s2,64(sp)
    80004464:	79e2                	ld	s3,56(sp)
    80004466:	7a42                	ld	s4,48(sp)
    80004468:	7aa2                	ld	s5,40(sp)
    8000446a:	6125                	addi	sp,sp,96
    8000446c:	8082                	ret
      wakeup(&pi->nread);
    8000446e:	8562                	mv	a0,s8
    80004470:	abdfd0ef          	jal	80001f2c <wakeup>
      sleep(&pi->nwrite, &pi->lock);
    80004474:	85a6                	mv	a1,s1
    80004476:	855e                	mv	a0,s7
    80004478:	a69fd0ef          	jal	80001ee0 <sleep>
  while(i < n){
    8000447c:	05495b63          	bge	s2,s4,800044d2 <pipewrite+0xc2>
    if(pi->readopen == 0 || killed(pr)){
    80004480:	2204a783          	lw	a5,544(s1)
    80004484:	d7e1                	beqz	a5,8000444c <pipewrite+0x3c>
    80004486:	854e                	mv	a0,s3
    80004488:	c91fd0ef          	jal	80002118 <killed>
    8000448c:	f161                	bnez	a0,8000444c <pipewrite+0x3c>
    if(pi->nwrite == pi->nread + PIPESIZE){
    8000448e:	2184a783          	lw	a5,536(s1)
    80004492:	21c4a703          	lw	a4,540(s1)
    80004496:	2007879b          	addiw	a5,a5,512
    8000449a:	fcf70ae3          	beq	a4,a5,8000446e <pipewrite+0x5e>
      if(copyin(pr->pagetable, &ch, addr + i, 1) == -1)
    8000449e:	4685                	li	a3,1
    800044a0:	01590633          	add	a2,s2,s5
    800044a4:	faf40593          	addi	a1,s0,-81
    800044a8:	0509b503          	ld	a0,80(s3)
    800044ac:	a1afd0ef          	jal	800016c6 <copyin>
    800044b0:	03650e63          	beq	a0,s6,800044ec <pipewrite+0xdc>
      pi->data[pi->nwrite++ % PIPESIZE] = ch;
    800044b4:	21c4a783          	lw	a5,540(s1)
    800044b8:	0017871b          	addiw	a4,a5,1
    800044bc:	20e4ae23          	sw	a4,540(s1)
    800044c0:	1ff7f793          	andi	a5,a5,511
    800044c4:	97a6                	add	a5,a5,s1
    800044c6:	faf44703          	lbu	a4,-81(s0)
    800044ca:	00e78c23          	sb	a4,24(a5)
      i++;
    800044ce:	2905                	addiw	s2,s2,1
    800044d0:	b775                	j	8000447c <pipewrite+0x6c>
    800044d2:	7b02                	ld	s6,32(sp)
    800044d4:	6be2                	ld	s7,24(sp)
    800044d6:	6c42                	ld	s8,16(sp)
  wakeup(&pi->nread);   // unconditional
    800044d8:	21848513          	addi	a0,s1,536
    800044dc:	a51fd0ef          	jal	80001f2c <wakeup>
  release(&pi->lock);
    800044e0:	8526                	mv	a0,s1
    800044e2:	f84fc0ef          	jal	80000c66 <release>
  return i;
    800044e6:	bf95                	j	8000445a <pipewrite+0x4a>
  int i = 0;
    800044e8:	4901                	li	s2,0
    800044ea:	b7fd                	j	800044d8 <pipewrite+0xc8>
    800044ec:	7b02                	ld	s6,32(sp)
    800044ee:	6be2                	ld	s7,24(sp)
    800044f0:	6c42                	ld	s8,16(sp)
    800044f2:	b7dd                	j	800044d8 <pipewrite+0xc8>

00000000800044f4 <piperead>:
...
piperead(struct pipe *pi, uint64 addr, int n)
{
    ...
    8000450a:	8ab2                	mv	s5,a2
  int i;
  struct proc *pr = myproc();
    8000450c:	bc2fd0ef          	jal	800018ce <myproc>
  ...
  acquire(&pi->lock);
    ...
    80004514:	ebafc0ef          	jal	80000bce <acquire>
  while(pi->nread == pi->nwrite && pi->writeopen){
    80004518:	2184a703          	lw	a4,536(s1)
    ...
    80004520:	21848993          	addi	s3,s1,536
  while(pi->nread == pi->nwrite && pi->writeopen){
    80004524:	02f71563          	bne	a4,a5,8000454e <piperead+0x5a>
    80004528:	2244a783          	lw	a5,548(s1)
    8000452c:	cb85                	beqz	a5,8000455c <piperead+0x68>
    if(killed(pr)){
    8000452e:	8552                	mv	a0,s4
    80004530:	be9fd0ef          	jal	80002118 <killed>
    80004534:	ed19                	bnez	a0,80004552 <piperead+0x5e>
    sleep(&pi->nread, &pi->lock);
    80004536:	85a6                	mv	a1,s1
    80004538:	854e                	mv	a0,s3
    8000453a:	9a7fd0ef          	jal	80001ee0 <sleep>
  while(pi->nread == pi->nwrite && pi->writeopen){
    8000453e:	2184a703          	lw	a4,536(s1)
    80004542:	21c4a783          	lw	a5,540(s1)
    80004546:	fef701e3          	beq	a4,a5,80004528 <piperead+0x34>
    8000454a:	e85a                	sd	s6,16(sp)
    8000454c:	a809                	j	8000455e <piperead+0x6a>
    8000454e:	e85a                	sd	s6,16(sp)
    80004550:	a039                	j	8000455e <piperead+0x6a>
      release(&pi->lock);
    80004552:	8526                	mv	a0,s1
    80004554:	f12fc0ef          	jal	80000c66 <release>
      return -1;
    80004558:	59fd                	li	s3,-1
    8000455a:	a8b1                	j	800045b6 <piperead+0xc2>
  ...
  for(i = 0; i < n; i++){
    80004562:	05505263          	blez	s5,800045a6 <piperead+0xb2>
    if(pi->nread == pi->nwrite)
    80004566:	2184a783          	lw	a5,536(s1)
    8000456a:	21c4a703          	lw	a4,540(s1)
    8000456e:	02f70c63          	beq	a4,a5,800045a6 <piperead+0xb2>
    ch = pi->data[pi->nread++ % PIPESIZE];
    ...
    80004594:	84efd0ef          	jal	800015e2 <copyout>
    80004598:	01650763          	beq	a0,s6,800045a6 <piperead+0xb2>
  for(i = 0; i < n; i++){
    8000459c:	2985                	addiw	s3,s3,1
    8000459e:	0905                	addi	s2,s2,1
    800045a0:	fd3a93e3          	bne	s5,s3,80004566 <piperead+0x72>
    800045a4:	89d6                	mv	s3,s5
#if PIPE_TRACE
...
#endif
  wakeup(&pi->nwrite);
    800045a6:	21c48513          	addi	a0,s1,540
    800045aa:	983fd0ef          	jal	80001f2c <wakeup>
#if PIPE_TRACE
...
int flags2perm(int flags)
{
    ...
    800045cc:	e422                	sd	s0,8(sp)
    800045ce:	0800                	addi	s0,sp,16
    800045d0:	87aa                	mv	a5,a0
    int perm = 0;
    if(flags & 0x1)
    800045d2:	8905                	andi	a0,a0,1
    800045d4:	050e                	slli	a0,a0,0x3
      perm = PTE_X;
    if(flags & 0x2)
    800045d6:	8b89                	andi	a5,a5,2
    800045d8:	c399                	beqz	a5,800045de <flags2perm+0x14>
      perm |= PTE_W;
    800045da:	00456513          	ori	a0,a0,4
    return perm;
}
...
{
    800045e4:	df010113          	addi	sp,sp,-528
    800045e8:	20113423          	sd	ra,520(sp)
    800045ec:	20813023          	sd	s0,512(sp)
    800045f0:	ffa6                	sd	s1,504(sp)
    800045f2:	fbca                	sd	s2,496(sp)
    800045f4:	0c00                	addi	s0,sp,528
    800045f6:	892a                	mv	s2,a0
    800045f8:	dea43c23          	sd	a0,-520(s0)
    800045fc:	e0b43023          	sd	a1,-512(s0)
  ...
  struct proc *p = myproc();
    80004600:	acefd0ef          	jal	800018ce <myproc>
    80004604:	84aa                	mv	s1,a0

  begin_op();
    80004606:	dd4ff0ef          	jal	80003bda <begin_op>

  // Open the executable file.
  if((ip = namei(path)) == 0){
    8000460a:	854a                	mv	a0,s2
    8000460c:	bfaff0ef          	jal	80003a06 <namei>
    80004610:	c931                	beqz	a0,80004664 <kexec+0x80>
    80004612:	f3d2                	sd	s4,480(sp)
    80004614:	8a2a                	mv	s4,a0
    end_op();
    return -1;
  }
  ilock(ip);
    80004616:	bdbfe0ef          	jal	800031f0 <ilock>

  // Read the ELF header.
  if(readi(ip, 0, (uint64)&elf, 0, sizeof(elf)) != sizeof(elf))
    8000461a:	04000713          	li	a4,64
    8000461e:	4681                	li	a3,0
    80004620:	e5040613          	addi	a2,s0,-432
    80004624:	4581                	li	a1,0
    80004626:	8552                	mv	a0,s4
    80004628:	f59fe0ef          	jal	80003580 <readi>
    8000462c:	04000793          	li	a5,64
    80004630:	00f51a63          	bne	a0,a5,80004644 <kexec+0x60>
    goto bad;

  // Is this really an ELF file?
  if(elf.magic != ELF_MAGIC)
    80004634:	e5042703          	lw	a4,-432(s0)
    80004638:	464c47b7          	lui	a5,0x464c4
    8000463c:	57f78793          	addi	a5,a5,1407 # 464c457f <_entry-0x39b3ba81>
    80004640:	02f70663          	beq	a4,a5,8000466c <kexec+0x88>
 ...
 bad:
  ...
  if(ip){
    ...
    80004646:	db5fe0ef          	jal	800033fa <iunlockput>
    end_op();
    8000464a:	dfaff0ef          	jal	80003c44 <end_op>
  }
  return -1;
    8000464e:	557d                	li	a0,-1
    80004650:	7a1e                	ld	s4,480(sp)
}
    80004652:	20813083          	ld	ra,520(sp)
    80004656:	20013403          	ld	s0,512(sp)
    8000465a:	74fe                	ld	s1,504(sp)
    8000465c:	795e                	ld	s2,496(sp)
    8000465e:	21010113          	addi	sp,sp,528
    80004662:	8082                	ret
    end_op();
    80004664:	de0ff0ef          	jal	80003c44 <end_op>
    return -1;
    80004668:	557d                	li	a0,-1
    8000466a:	b7e5                	j	80004652 <kexec+0x6e>
    8000466c:	ebda                	sd	s6,464(sp)
  if((pagetable = proc_pagetable(p)) == 0)
    8000466e:	8526                	mv	a0,s1
    80004670:	b64fd0ef          	jal	800019d4 <proc_pagetable>
    80004674:	8b2a                	mv	s6,a0
    80004676:	2c050b63          	beqz	a0,8000494c <kexec+0x368>
    8000467a:	f7ce                	sd	s3,488(sp)
    8000467c:	efd6                	sd	s5,472(sp)
    8000467e:	e7de                	sd	s7,456(sp)
    80004680:	e3e2                	sd	s8,448(sp)
    80004682:	ff66                	sd	s9,440(sp)
    80004684:	fb6a                	sd	s10,432(sp)
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    80004686:	e7042d03          	lw	s10,-400(s0)
    8000468a:	e8845783          	lhu	a5,-376(s0)
    8000468e:	12078963          	beqz	a5,800047c0 <kexec+0x1dc>
    80004692:	f76e                	sd	s11,424(sp)
  uint64 argc, sz = 0, sp, ustack[MAXARG], stackbase;
    80004694:	4901                	li	s2,0
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    80004696:	4d81                	li	s11,0
    if(ph.vaddr % PGSIZE != 0)
    80004698:	6c85                	lui	s9,0x1
    8000469a:	fffc8793          	addi	a5,s9,-1 # fff <_entry-0x7ffff001>
    8000469e:	def43823          	sd	a5,-528(s0)
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    if(sz - i < PGSIZE)
    800046a2:	6a85                	lui	s5,0x1
    800046a4:	a085                	j	80004704 <kexec+0x120>
      panic("loadseg: address should exist");
    800046a6:	00003517          	auipc	a0,0x3
    800046aa:	efa50513          	addi	a0,a0,-262 # 800075a0 <etext+0x5a0>
    800046ae:	932fc0ef          	jal	800007e0 <panic>
    if(sz - i < PGSIZE)
    800046b2:	2481                	sext.w	s1,s1
      n = sz - i;
    else
      n = PGSIZE;
    if(readi(ip, 0, (uint64)pa, offset+i, n) != n)
    800046b4:	8726                	mv	a4,s1
    800046b6:	012c06bb          	addw	a3,s8,s2
    800046ba:	4581                	li	a1,0
    800046bc:	8552                	mv	a0,s4
    800046be:	ec3fe0ef          	jal	80003580 <readi>
    800046c2:	2501                	sext.w	a0,a0
    800046c4:	24a49a63          	bne	s1,a0,80004918 <kexec+0x334>
  for(i = 0; i < sz; i += PGSIZE){
    800046c8:	012a893b          	addw	s2,s5,s2
    800046cc:	03397363          	bgeu	s2,s3,800046f2 <kexec+0x10e>
    pa = walkaddr(pagetable, va + i);
    800046d0:	02091593          	slli	a1,s2,0x20
    800046d4:	9181                	srli	a1,a1,0x20
    800046d6:	95de                	add	a1,a1,s7
    800046d8:	855a                	mv	a0,s6
    800046da:	8d7fc0ef          	jal	80000fb0 <walkaddr>
    800046de:	862a                	mv	a2,a0
    if(pa == 0)
    800046e0:	d179                	beqz	a0,800046a6 <kexec+0xc2>
    if(sz - i < PGSIZE)
    800046e2:	412984bb          	subw	s1,s3,s2
    800046e6:	0004879b          	sext.w	a5,s1
    800046ea:	fcfcf4e3          	bgeu	s9,a5,800046b2 <kexec+0xce>
    800046ee:	84d6                	mv	s1,s5
    800046f0:	b7c9                	j	800046b2 <kexec+0xce>
    sz = sz1;
    800046f2:	e0843903          	ld	s2,-504(s0)
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    800046f6:	2d85                	addiw	s11,s11,1
    800046f8:	038d0d1b          	addiw	s10,s10,56 # 1038 <_entry-0x7fffefc8>
    800046fc:	e8845783          	lhu	a5,-376(s0)
    80004700:	08fdd063          	bge	s11,a5,80004780 <kexec+0x19c>
    if(readi(ip, 0, (uint64)&ph, off, sizeof(ph)) != sizeof(ph))
    80004704:	2d01                	sext.w	s10,s10
    80004706:	03800713          	li	a4,56
    8000470a:	86ea                	mv	a3,s10
    8000470c:	e1840613          	addi	a2,s0,-488
    80004710:	4581                	li	a1,0
    80004712:	8552                	mv	a0,s4
    80004714:	e6dfe0ef          	jal	80003580 <readi>
    80004718:	03800793          	li	a5,56
    8000471c:	1cf51663          	bne	a0,a5,800048e8 <kexec+0x304>
    if(ph.type != ELF_PROG_LOAD)
    80004720:	e1842783          	lw	a5,-488(s0)
    80004724:	4705                	li	a4,1
    80004726:	fce798e3          	bne	a5,a4,800046f6 <kexec+0x112>
    if(ph.memsz < ph.filesz)
    8000472a:	e4043483          	ld	s1,-448(s0)
    8000472e:	e3843783          	ld	a5,-456(s0)
    80004732:	1af4ef63          	bltu	s1,a5,800048f0 <kexec+0x30c>
    if(ph.vaddr + ph.memsz < ph.vaddr)
    80004736:	e2843783          	ld	a5,-472(s0)
    8000473a:	94be                	add	s1,s1,a5
    8000473c:	1af4ee63          	bltu	s1,a5,800048f8 <kexec+0x314>
    if(ph.vaddr % PGSIZE != 0)
    80004740:	df043703          	ld	a4,-528(s0)
    80004744:	8ff9                	and	a5,a5,a4
    80004746:	1a079d63          	bnez	a5,80004900 <kexec+0x31c>
    if((sz1 = uvmalloc(pagetable, sz, ph.vaddr + ph.memsz, flags2perm(ph.flags))) == 0)
    8000474a:	e1c42503          	lw	a0,-484(s0)
    8000474e:	e7dff0ef          	jal	800045ca <flags2perm>
    80004752:	86aa                	mv	a3,a0
    80004754:	8626                	mv	a2,s1
    80004756:	85ca                	mv	a1,s2
    80004758:	855a                	mv	a0,s6
    8000475a:	b2ffc0ef          	jal	80001288 <uvmalloc>
    8000475e:	e0a43423          	sd	a0,-504(s0)
    80004762:	1a050363          	beqz	a0,80004908 <kexec+0x324>
    if(loadseg(pagetable, ph.vaddr, ip, ph.off, ph.filesz) < 0)
    80004766:	e2843b83          	ld	s7,-472(s0)
    8000476a:	e2042c03          	lw	s8,-480(s0)
    8000476e:	e3842983          	lw	s3,-456(s0)
  for(i = 0; i < sz; i += PGSIZE){
    80004772:	00098463          	beqz	s3,8000477a <kexec+0x196>
    80004776:	4901                	li	s2,0
    80004778:	bfa1                	j	800046d0 <kexec+0xec>
    sz = sz1;
    8000477a:	e0843903          	ld	s2,-504(s0)
    8000477e:	bfa5                	j	800046f6 <kexec+0x112>
    80004780:	7dba                	ld	s11,424(sp)
  iunlockput(ip);
    80004782:	8552                	mv	a0,s4
    80004784:	c77fe0ef          	jal	800033fa <iunlockput>
  end_op();
    80004788:	cbcff0ef          	jal	80003c44 <end_op>
  p = myproc();
    8000478c:	942fd0ef          	jal	800018ce <myproc>
    80004790:	8aaa                	mv	s5,a0
  uint64 oldsz = p->sz;
    80004792:	04853c83          	ld	s9,72(a0)
  sz = PGROUNDUP(sz);
    80004796:	6985                	lui	s3,0x1
    80004798:	19fd                	addi	s3,s3,-1 # fff <_entry-0x7ffff001>
    8000479a:	99ca                	add	s3,s3,s2
    8000479c:	77fd                	lui	a5,0xfffff
    8000479e:	00f9f9b3          	and	s3,s3,a5
  if((sz1 = uvmalloc(pagetable, sz, sz + (USERSTACK+1)*PGSIZE, PTE_W)) == 0)
    800047a2:	4691                	li	a3,4
    800047a4:	6609                	lui	a2,0x2
    800047a6:	964e                	add	a2,a2,s3
    800047a8:	85ce                	mv	a1,s3
    800047aa:	855a                	mv	a0,s6
    800047ac:	addfc0ef          	jal	80001288 <uvmalloc>
    800047b0:	892a                	mv	s2,a0
    800047b2:	e0a43423          	sd	a0,-504(s0)
    800047b6:	e519                	bnez	a0,800047c4 <kexec+0x1e0>
  if(pagetable)
    800047b8:	e1343423          	sd	s3,-504(s0)
    800047bc:	4a01                	li	s4,0
    800047be:	aab1                	j	8000491a <kexec+0x336>
  uint64 argc, sz = 0, sp, ustack[MAXARG], stackbase;
    800047c0:	4901                	li	s2,0
    800047c2:	b7c1                	j	80004782 <kexec+0x19e>
  uvmclear(pagetable, sz-(USERSTACK+1)*PGSIZE);
    800047c4:	75f9                	lui	a1,0xffffe
    800047c6:	95aa                	add	a1,a1,a0
    800047c8:	855a                	mv	a0,s6
    800047ca:	c95fc0ef          	jal	8000145e <uvmclear>
  stackbase = sp - USERSTACK*PGSIZE;
    800047ce:	7bfd                	lui	s7,0xfffff
    800047d0:	9bca                	add	s7,s7,s2
  for(argc = 0; argv[argc]; argc++) {
    800047d2:	e0043783          	ld	a5,-512(s0)
    800047d6:	6388                	ld	a0,0(a5)
    800047d8:	cd39                	beqz	a0,80004836 <kexec+0x252>
    800047da:	e9040993          	addi	s3,s0,-368
    800047de:	f9040c13          	addi	s8,s0,-112
    800047e2:	4481                	li	s1,0
    sp -= strlen(argv[argc]) + 1;
    800047e4:	e2efc0ef          	jal	80000e12 <strlen>
    800047e8:	0015079b          	addiw	a5,a0,1
    800047ec:	40f907b3          	sub	a5,s2,a5
    sp -= sp % 16; // riscv sp must be 16-byte aligned
    800047f0:	ff07f913          	andi	s2,a5,-16
    if(sp < stackbase)
    800047f4:	11796e63          	bltu	s2,s7,80004910 <kexec+0x32c>
    if(copyout(pagetable, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
    800047f8:	e0043d03          	ld	s10,-512(s0)
    800047fc:	000d3a03          	ld	s4,0(s10)
    80004800:	8552                	mv	a0,s4
    80004802:	e10fc0ef          	jal	80000e12 <strlen>
    80004806:	0015069b          	addiw	a3,a0,1
    8000480a:	8652                	mv	a2,s4
    8000480c:	85ca                	mv	a1,s2
    8000480e:	855a                	mv	a0,s6
    80004810:	dd3fc0ef          	jal	800015e2 <copyout>
    80004814:	10054063          	bltz	a0,80004914 <kexec+0x330>
    ustack[argc] = sp;
    80004818:	0129b023          	sd	s2,0(s3)
  for(argc = 0; argv[argc]; argc++) {
    8000481c:	0485                	addi	s1,s1,1
    8000481e:	008d0793          	addi	a5,s10,8
    80004822:	e0f43023          	sd	a5,-512(s0)
    80004826:	008d3503          	ld	a0,8(s10)
    8000482a:	c909                	beqz	a0,8000483c <kexec+0x258>
    if(argc >= MAXARG)
    8000482c:	09a1                	addi	s3,s3,8
    8000482e:	fb899be3          	bne	s3,s8,800047e4 <kexec+0x200>
  ip = 0;
    80004832:	4a01                	li	s4,0
    80004834:	a0dd                	j	8000491a <kexec+0x336>
  sp = sz;
    80004836:	e0843903          	ld	s2,-504(s0)
  for(argc = 0; argv[argc]; argc++) {
    8000483a:	4481                	li	s1,0
  ustack[argc] = 0;
    8000483c:	00349793          	slli	a5,s1,0x3
    80004840:	f9078793          	addi	a5,a5,-112 # ffffffffffffef90 <end+0xffffffff7ffde228>
  ...
  if(sp < stackbase)
    8000485c:	f5796ee3          	bltu	s2,s7,800047b8 <kexec+0x1d4>
  if(copyout(pagetable, sp, (char *)ustack, (argc+1)*sizeof(uint64)) < 0)
    80004860:	e9040613          	addi	a2,s0,-368
    80004864:	85ca                	mv	a1,s2
    80004866:	855a                	mv	a0,s6
    80004868:	d7bfc0ef          	jal	800015e2 <copyout>
    8000486c:	0e054263          	bltz	a0,80004950 <kexec+0x36c>
  p->trapframe->a1 = sp;
    80004870:	058ab783          	ld	a5,88(s5) # 1058 <_entry-0x7fffefa8>
    80004874:	0727bc23          	sd	s2,120(a5)
  for(last=s=path; *s; s++)
    80004878:	df843783          	ld	a5,-520(s0)
    8000487c:	0007c703          	lbu	a4,0(a5)
    80004880:	cf11                	beqz	a4,8000489c <kexec+0x2b8>
    80004882:	0785                	addi	a5,a5,1
    if(*s == '/')
    80004884:	02f00693          	li	a3,47
    80004888:	a039                	j	80004896 <kexec+0x2b2>
      last = s+1;
    8000488a:	def43c23          	sd	a5,-520(s0)
  for(last=s=path; *s; s++)
    8000488e:	0785                	addi	a5,a5,1
    80004890:	fff7c703          	lbu	a4,-1(a5)
    80004894:	c701                	beqz	a4,8000489c <kexec+0x2b8>
    if(*s == '/')
    80004896:	fed71ce3          	bne	a4,a3,8000488e <kexec+0x2aa>
    8000489a:	bfc5                	j	8000488a <kexec+0x2a6>
  safestrcpy(p->name, last, sizeof(p->name));
    8000489c:	4641                	li	a2,16
    8000489e:	df843583          	ld	a1,-520(s0)
    800048a2:	158a8513          	addi	a0,s5,344
    800048a6:	d3afc0ef          	jal	80000de0 <safestrcpy>
  oldpagetable = p->pagetable;
    800048aa:	050ab503          	ld	a0,80(s5)
  p->pagetable = pagetable;
    800048ae:	056ab823          	sd	s6,80(s5)
  p->sz = sz;
    800048b2:	e0843783          	ld	a5,-504(s0)
    800048b6:	04fab423          	sd	a5,72(s5)
  p->trapframe->epc = elf.entry;  // initial program counter = ulib.c:start()
    800048ba:	058ab783          	ld	a5,88(s5)
    800048be:	e6843703          	ld	a4,-408(s0)
    800048c2:	ef98                	sd	a4,24(a5)
  p->trapframe->sp = sp; // initial stack pointer
    800048c4:	058ab783          	ld	a5,88(s5)
    800048c8:	0327b823          	sd	s2,48(a5)
  proc_freepagetable(oldpagetable, oldsz);
    800048cc:	85e6                	mv	a1,s9
    800048ce:	98afd0ef          	jal	80001a58 <proc_freepagetable>
  return argc; // this ends up in a0, the first argument to main(argc, argv)
    800048d2:	0004851b          	sext.w	a0,s1
    800048d6:	79be                	ld	s3,488(sp)
    800048d8:	7a1e                	ld	s4,480(sp)
    800048da:	6afe                	ld	s5,472(sp)
    800048dc:	6b5e                	ld	s6,464(sp)
    800048de:	6bbe                	ld	s7,456(sp)
    800048e0:	6c1e                	ld	s8,448(sp)
    800048e2:	7cfa                	ld	s9,440(sp)
    800048e4:	7d5a                	ld	s10,432(sp)
    800048e6:	b3b5                	j	80004652 <kexec+0x6e>
    800048e8:	e1243423          	sd	s2,-504(s0)
    800048ec:	7dba                	ld	s11,424(sp)
    800048ee:	a035                	j	8000491a <kexec+0x336>
    800048f0:	e1243423          	sd	s2,-504(s0)
    800048f4:	7dba                	ld	s11,424(sp)
    800048f6:	a015                	j	8000491a <kexec+0x336>
    800048f8:	e1243423          	sd	s2,-504(s0)
    800048fc:	7dba                	ld	s11,424(sp)
    800048fe:	a831                	j	8000491a <kexec+0x336>
    80004900:	e1243423          	sd	s2,-504(s0)
    80004904:	7dba                	ld	s11,424(sp)
    80004906:	a811                	j	8000491a <kexec+0x336>
    80004908:	e1243423          	sd	s2,-504(s0)
    8000490c:	7dba                	ld	s11,424(sp)
    8000490e:	a031                	j	8000491a <kexec+0x336>
  ip = 0;
    80004910:	4a01                	li	s4,0
    80004912:	a021                	j	8000491a <kexec+0x336>
    80004914:	4a01                	li	s4,0
  if(pagetable)
    80004916:	a011                	j	8000491a <kexec+0x336>
    80004918:	7dba                	ld	s11,424(sp)
    proc_freepagetable(pagetable, sz);
    8000491a:	e0843583          	ld	a1,-504(s0)
    8000491e:	855a                	mv	a0,s6
    80004920:	938fd0ef          	jal	80001a58 <proc_freepagetable>
  return -1;
    80004924:	557d                	li	a0,-1
  if(ip){
    80004926:	000a1b63          	bnez	s4,8000493c <kexec+0x358>
    8000492a:	79be                	ld	s3,488(sp)
    8000492c:	7a1e                	ld	s4,480(sp)
    8000492e:	6afe                	ld	s5,472(sp)
    80004930:	6b5e                	ld	s6,464(sp)
    80004932:	6bbe                	ld	s7,456(sp)
    80004934:	6c1e                	ld	s8,448(sp)
    80004936:	7cfa                	ld	s9,440(sp)
    80004938:	7d5a                	ld	s10,432(sp)
    8000493a:	bb21                	j	80004652 <kexec+0x6e>
    8000493c:	79be                	ld	s3,488(sp)
    ...
    8000494a:	b9ed                	j	80004644 <kexec+0x60>
    8000494c:	6b5e                	ld	s6,464(sp)
    8000494e:	b9dd                	j	80004644 <kexec+0x60>
  sz = sz1;
    80004950:	e0843983          	ld	s3,-504(s0)
    80004954:	b595                	j	800047b8 <kexec+0x1d4>

0000000080004956 <argfd>:
...
argfd(int n, int *pfd, struct file **pf)
{
    ...
    80004964:	84b2                	mv	s1,a2
  int fd;
  struct file *f;

  argint(n, &fd);
    80004966:	fdc40593          	addi	a1,s0,-36
    8000496a:	e81fd0ef          	jal	800027ea <argint>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
    8000496e:	fdc42703          	lw	a4,-36(s0)
    80004972:	47bd                	li	a5,15
    80004974:	02e7e963          	bltu	a5,a4,800049a6 <argfd+0x50>
    80004978:	f57fc0ef          	jal	800018ce <myproc>
    8000497c:	fdc42703          	lw	a4,-36(s0)
    80004980:	01a70793          	addi	a5,a4,26
    80004984:	078e                	slli	a5,a5,0x3
    80004986:	953e                	add	a0,a0,a5
    80004988:	611c                	ld	a5,0(a0)
    8000498a:	c385                	beqz	a5,800049aa <argfd+0x54>
    return -1;
  if(pfd)
    8000498c:	00090463          	beqz	s2,80004994 <argfd+0x3e>
    *pfd = fd;
    80004990:	00e92023          	sw	a4,0(s2)
  if(pf)
    *pf = f;
  return 0;
    80004994:	4501                	li	a0,0
  if(pf)
    80004996:	c091                	beqz	s1,8000499a <argfd+0x44>
    *pf = f;
    80004998:	e09c                	sd	a5,0(s1)
}
    ...
    800049a8:	bfcd                	j	8000499a <argfd+0x44>
    800049aa:	557d                	li	a0,-1
    800049ac:	b7fd                	j	8000499a <argfd+0x44>

00000000800049ae <fdalloc>:
...
fdalloc(struct file *f)
{
  ...
  struct proc *p = myproc();
    ...
    800049be:	862a                	mv	a2,a0

  for(fd = 0; fd < NOFILE; fd++){
    800049c0:	0d050793          	addi	a5,a0,208
    800049c4:	4501                	li	a0,0
    800049c6:	46c1                	li	a3,16
    if(p->ofile[fd] == 0){
    800049c8:	6398                	ld	a4,0(a5)
    800049ca:	cb19                	beqz	a4,800049e0 <fdalloc+0x32>
  for(fd = 0; fd < NOFILE; fd++){
    800049cc:	2505                	addiw	a0,a0,1
    800049ce:	07a1                	addi	a5,a5,8
    800049d0:	fed51ce3          	bne	a0,a3,800049c8 <fdalloc+0x1a>
      p->ofile[fd] = f;
      return fd;
    }
  }
  return -1;
    ...
    800049de:	8082                	ret
      p->ofile[fd] = f;
    800049e0:	01a50793          	addi	a5,a0,26
    800049e4:	078e                	slli	a5,a5,0x3
    800049e6:	963e                	add	a2,a2,a5
    800049e8:	e204                	sd	s1,0(a2)
      return fd;
    800049ea:	b7f5                	j	800049d6 <fdalloc+0x28>

00000000800049ec <create>:
  return -1;
}
...
{
    800049ec:	715d                	addi	sp,sp,-80
    800049ee:	e486                	sd	ra,72(sp)
    800049f0:	e0a2                	sd	s0,64(sp)
    800049f2:	fc26                	sd	s1,56(sp)
    800049f4:	f84a                	sd	s2,48(sp)
    ...
    80004a00:	89b2                	mv	s3,a2
    80004a02:	8936                	mv	s2,a3
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
    80004a04:	fb040593          	addi	a1,s0,-80
    80004a08:	818ff0ef          	jal	80003a20 <nameiparent>
    80004a0c:	84aa                	mv	s1,a0
    80004a0e:	10050a63          	beqz	a0,80004b22 <create+0x136>
    return 0;

  ilock(dp);
    80004a12:	fdefe0ef          	jal	800031f0 <ilock>

  if((ip = dirlookup(dp, name, 0)) != 0){
    80004a16:	4601                	li	a2,0
    80004a18:	fb040593          	addi	a1,s0,-80
    80004a1c:	8526                	mv	a0,s1
    80004a1e:	d83fe0ef          	jal	800037a0 <dirlookup>
    80004a22:	8aaa                	mv	s5,a0
    80004a24:	c129                	beqz	a0,80004a66 <create+0x7a>
    iunlockput(dp);
    80004a26:	8526                	mv	a0,s1
    80004a28:	9d3fe0ef          	jal	800033fa <iunlockput>
    ilock(ip);
    80004a2c:	8556                	mv	a0,s5
    80004a2e:	fc2fe0ef          	jal	800031f0 <ilock>
    if(type == T_FILE && (ip->type == T_FILE || ip->type == T_DEVICE))
    80004a32:	4789                	li	a5,2
    80004a34:	02fb1463          	bne	s6,a5,80004a5c <create+0x70>
    80004a38:	044ad783          	lhu	a5,68(s5)
    80004a3c:	37f9                	addiw	a5,a5,-2
    80004a3e:	17c2                	slli	a5,a5,0x30
    80004a40:	93c1                	srli	a5,a5,0x30
    80004a42:	4705                	li	a4,1
    80004a44:	00f76c63          	bltu	a4,a5,80004a5c <create+0x70>
  ip->nlink = 0;
  iupdate(ip);
  iunlockput(ip);
  iunlockput(dp);
  return 0;
    ...
    80004a5e:	99dfe0ef          	jal	800033fa <iunlockput>
    return 0;
    80004a62:	4a81                	li	s5,0
    80004a64:	b7d5                	j	80004a48 <create+0x5c>
    80004a66:	f052                	sd	s4,32(sp)
  if((ip = ialloc(dp->dev, type)) == 0){
    80004a68:	85da                	mv	a1,s6
    80004a6a:	4088                	lw	a0,0(s1)
    80004a6c:	e14fe0ef          	jal	80003080 <ialloc>
    80004a70:	8a2a                	mv	s4,a0
    80004a72:	cd15                	beqz	a0,80004aae <create+0xc2>
  ilock(ip);
    80004a74:	f7cfe0ef          	jal	800031f0 <ilock>
  ip->major = major;
    80004a78:	053a1323          	sh	s3,70(s4)
  ip->minor = minor;
    80004a7c:	052a1423          	sh	s2,72(s4)
  ip->nlink = 1;
    80004a80:	4905                	li	s2,1
    80004a82:	052a1523          	sh	s2,74(s4)
  iupdate(ip);
    80004a86:	8552                	mv	a0,s4
    80004a88:	eb4fe0ef          	jal	8000313c <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
    80004a8c:	032b0763          	beq	s6,s2,80004aba <create+0xce>
  if(dirlink(dp, name, ip->inum) < 0)
    80004a90:	004a2603          	lw	a2,4(s4)
    80004a94:	fb040593          	addi	a1,s0,-80
    80004a98:	8526                	mv	a0,s1
    80004a9a:	ed3fe0ef          	jal	8000396c <dirlink>
    80004a9e:	06054563          	bltz	a0,80004b08 <create+0x11c>
  iunlockput(dp);
    80004aa2:	8526                	mv	a0,s1
    80004aa4:	957fe0ef          	jal	800033fa <iunlockput>
  return ip;
    80004aa8:	8ad2                	mv	s5,s4
    80004aaa:	7a02                	ld	s4,32(sp)
    80004aac:	bf71                	j	80004a48 <create+0x5c>
    iunlockput(dp);
    80004aae:	8526                	mv	a0,s1
    80004ab0:	94bfe0ef          	jal	800033fa <iunlockput>
    return 0;
    80004ab4:	8ad2                	mv	s5,s4
    80004ab6:	7a02                	ld	s4,32(sp)
    80004ab8:	bf41                	j	80004a48 <create+0x5c>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
    80004aba:	004a2603          	lw	a2,4(s4)
    80004abe:	00003597          	auipc	a1,0x3
    80004ac2:	b0258593          	addi	a1,a1,-1278 # 800075c0 <etext+0x5c0>
    80004ac6:	8552                	mv	a0,s4
    80004ac8:	ea5fe0ef          	jal	8000396c <dirlink>
    80004acc:	02054e63          	bltz	a0,80004b08 <create+0x11c>
    80004ad0:	40d0                	lw	a2,4(s1)
    80004ad2:	00003597          	auipc	a1,0x3
    80004ad6:	af658593          	addi	a1,a1,-1290 # 800075c8 <etext+0x5c8>
    80004ada:	8552                	mv	a0,s4
    80004adc:	e91fe0ef          	jal	8000396c <dirlink>
    80004ae0:	02054463          	bltz	a0,80004b08 <create+0x11c>
  if(dirlink(dp, name, ip->inum) < 0)
    80004ae4:	004a2603          	lw	a2,4(s4)
    80004ae8:	fb040593          	addi	a1,s0,-80
    80004aec:	8526                	mv	a0,s1
    80004aee:	e7ffe0ef          	jal	8000396c <dirlink>
    80004af2:	00054b63          	bltz	a0,80004b08 <create+0x11c>
    dp->nlink++;  // for ".."
    ...
    80004b02:	e3afe0ef          	jal	8000313c <iupdate>
    80004b06:	bf71                	j	80004aa2 <create+0xb6>
  ip->nlink = 0;
    80004b08:	040a1523          	sh	zero,74(s4)
  iupdate(ip);
    80004b0c:	8552                	mv	a0,s4
    80004b0e:	e2efe0ef          	jal	8000313c <iupdate>
  iunlockput(ip);
    80004b12:	8552                	mv	a0,s4
    80004b14:	8e7fe0ef          	jal	800033fa <iunlockput>
  iunlockput(dp);
    80004b18:	8526                	mv	a0,s1
    80004b1a:	8e1fe0ef          	jal	800033fa <iunlockput>
  return 0;
    80004b1e:	7a02                	ld	s4,32(sp)
    80004b20:	b725                	j	80004a48 <create+0x5c>
    return 0;
    80004b22:	8aaa                	mv	s5,a0
    80004b24:	b715                	j	80004a48 <create+0x5c>

0000000080004b26 <sys_dup>:
{
  ...
  if(argfd(0, 0, &f) < 0)
    80004b2e:	fd840613          	addi	a2,s0,-40
    80004b32:	4581                	li	a1,0
    80004b34:	4501                	li	a0,0
    80004b36:	e21ff0ef          	jal	80004956 <argfd>
    return -1;
    80004b3a:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0)
    80004b3c:	02054363          	bltz	a0,80004b62 <sys_dup+0x3c>
    80004b40:	ec26                	sd	s1,24(sp)
    80004b42:	e84a                	sd	s2,16(sp)
  if((fd=fdalloc(f)) < 0)
    80004b44:	fd843903          	ld	s2,-40(s0)
    80004b48:	854a                	mv	a0,s2
    80004b4a:	e65ff0ef          	jal	800049ae <fdalloc>
    80004b4e:	84aa                	mv	s1,a0
    return -1;
    80004b50:	57fd                	li	a5,-1
  if((fd=fdalloc(f)) < 0)
    80004b52:	00054d63          	bltz	a0,80004b6c <sys_dup+0x46>
  filedup(f);
    80004b56:	854a                	mv	a0,s2
    80004b58:	c48ff0ef          	jal	80003fa0 <filedup>
  return fd;
    80004b5c:	87a6                	mv	a5,s1
    ...
    80004b70:	bfcd                	j	80004b62 <sys_dup+0x3c>

0000000080004b72 <sys_read>:
{
  ...
  argaddr(1, &p);
    80004b7a:	fd840593          	addi	a1,s0,-40
    80004b7e:	4505                	li	a0,1
    80004b80:	c87fd0ef          	jal	80002806 <argaddr>
  argint(2, &n);
    80004b84:	fe440593          	addi	a1,s0,-28
    80004b88:	4509                	li	a0,2
    80004b8a:	c61fd0ef          	jal	800027ea <argint>
  if(argfd(0, 0, &f) < 0)
    80004b8e:	fe840613          	addi	a2,s0,-24
    80004b92:	4581                	li	a1,0
    80004b94:	4501                	li	a0,0
    80004b96:	dc1ff0ef          	jal	80004956 <argfd>
    80004b9a:	87aa                	mv	a5,a0
    return -1;
    80004b9c:	557d                	li	a0,-1
  if(argfd(0, 0, &f) < 0)
    80004b9e:	0007ca63          	bltz	a5,80004bb2 <sys_read+0x40>
  return fileread(f, p, n);
    80004ba2:	fe442603          	lw	a2,-28(s0)
    80004ba6:	fd843583          	ld	a1,-40(s0)
    80004baa:	fe843503          	ld	a0,-24(s0)
    80004bae:	d58ff0ef          	jal	80004106 <fileread>
}
...
0000000080004bba <sys_write>:
{
  ...
  argaddr(1, &p);
    80004bc2:	fd840593          	addi	a1,s0,-40
    80004bc6:	4505                	li	a0,1
    80004bc8:	c3ffd0ef          	jal	80002806 <argaddr>
  argint(2, &n);
    80004bcc:	fe440593          	addi	a1,s0,-28
    80004bd0:	4509                	li	a0,2
    80004bd2:	c19fd0ef          	jal	800027ea <argint>
  if(argfd(0, 0, &f) < 0)
    80004bd6:	fe840613          	addi	a2,s0,-24
    80004bda:	4581                	li	a1,0
    80004bdc:	4501                	li	a0,0
    80004bde:	d79ff0ef          	jal	80004956 <argfd>
    80004be2:	87aa                	mv	a5,a0
    return -1;
    80004be4:	557d                	li	a0,-1
  if(argfd(0, 0, &f) < 0)
    80004be6:	0007ca63          	bltz	a5,80004bfa <sys_write+0x40>
  return filewrite(f, p, n);
    80004bea:	fe442603          	lw	a2,-28(s0)
    80004bee:	fd843583          	ld	a1,-40(s0)
    80004bf2:	fe843503          	ld	a0,-24(s0)
    80004bf6:	dceff0ef          	jal	800041c4 <filewrite>
}
...
0000000080004c02 <sys_close>:
{
  ...
  if(argfd(0, &fd, &f) < 0)
    80004c0a:	fe040613          	addi	a2,s0,-32
    80004c0e:	fec40593          	addi	a1,s0,-20
    80004c12:	4501                	li	a0,0
    80004c14:	d43ff0ef          	jal	80004956 <argfd>
    return -1;
    80004c18:	57fd                	li	a5,-1
  if(argfd(0, &fd, &f) < 0)
    80004c1a:	02054063          	bltz	a0,80004c3a <sys_close+0x38>
  myproc()->ofile[fd] = 0;
    80004c1e:	cb1fc0ef          	jal	800018ce <myproc>
    80004c22:	fec42783          	lw	a5,-20(s0)
    80004c26:	07e9                	addi	a5,a5,26
    80004c28:	078e                	slli	a5,a5,0x3
    80004c2a:	953e                	add	a0,a0,a5
    80004c2c:	00053023          	sd	zero,0(a0)
  fileclose(f);
    80004c30:	fe043503          	ld	a0,-32(s0)
    80004c34:	bb2ff0ef          	jal	80003fe6 <fileclose>
  return 0;
...
0000000080004c44 <sys_fstat>:
{
  ...
  argaddr(1, &st);
    80004c4c:	fe040593          	addi	a1,s0,-32
    80004c50:	4505                	li	a0,1
    80004c52:	bb5fd0ef          	jal	80002806 <argaddr>
  if(argfd(0, 0, &f) < 0)
    80004c56:	fe840613          	addi	a2,s0,-24
    80004c5a:	4581                	li	a1,0
    80004c5c:	4501                	li	a0,0
    80004c5e:	cf9ff0ef          	jal	80004956 <argfd>
    80004c62:	87aa                	mv	a5,a0
    return -1;
    80004c64:	557d                	li	a0,-1
  if(argfd(0, 0, &f) < 0)
    80004c66:	0007c863          	bltz	a5,80004c76 <sys_fstat+0x32>
  return filestat(f, st);
    80004c6a:	fe043583          	ld	a1,-32(s0)
    80004c6e:	fe843503          	ld	a0,-24(s0)
    80004c72:	c36ff0ef          	jal	800040a8 <filestat>
}
...
0000000080004c7e <sys_link>:
{
    80004c7e:	7169                	addi	sp,sp,-304
    80004c80:	f606                	sd	ra,296(sp)
    80004c82:	f222                	sd	s0,288(sp)
    80004c84:	1a00                	addi	s0,sp,304
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    80004c86:	08000613          	li	a2,128
    80004c8a:	ed040593          	addi	a1,s0,-304
    80004c8e:	4501                	li	a0,0
    80004c90:	b93fd0ef          	jal	80002822 <argstr>
    return -1;
    80004c94:	57fd                	li	a5,-1
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    80004c96:	0c054e63          	bltz	a0,80004d72 <sys_link+0xf4>
    80004c9a:	08000613          	li	a2,128
    80004c9e:	f5040593          	addi	a1,s0,-176
    80004ca2:	4505                	li	a0,1
    80004ca4:	b7ffd0ef          	jal	80002822 <argstr>
    return -1;
    80004ca8:	57fd                	li	a5,-1
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    80004caa:	0c054463          	bltz	a0,80004d72 <sys_link+0xf4>
    80004cae:	ee26                	sd	s1,280(sp)
  begin_op();
    80004cb0:	f2bfe0ef          	jal	80003bda <begin_op>
  if((ip = namei(old)) == 0){
    80004cb4:	ed040513          	addi	a0,s0,-304
    80004cb8:	d4ffe0ef          	jal	80003a06 <namei>
    80004cbc:	84aa                	mv	s1,a0
    80004cbe:	c53d                	beqz	a0,80004d2c <sys_link+0xae>
  ilock(ip);
    80004cc0:	d30fe0ef          	jal	800031f0 <ilock>
  if(ip->type == T_DIR){
    80004cc4:	04449703          	lh	a4,68(s1)
    80004cc8:	4785                	li	a5,1
    80004cca:	06f70663          	beq	a4,a5,80004d36 <sys_link+0xb8>
    80004cce:	ea4a                	sd	s2,272(sp)
  ip->nlink++;
  ...
  iupdate(ip);
    ...
    80004cdc:	c60fe0ef          	jal	8000313c <iupdate>
  iunlock(ip);
    80004ce0:	8526                	mv	a0,s1
    80004ce2:	dbcfe0ef          	jal	8000329e <iunlock>
  if((dp = nameiparent(new, name)) == 0)
    80004ce6:	fd040593          	addi	a1,s0,-48
    80004cea:	f5040513          	addi	a0,s0,-176
    80004cee:	d33fe0ef          	jal	80003a20 <nameiparent>
    80004cf2:	892a                	mv	s2,a0
    80004cf4:	cd21                	beqz	a0,80004d4c <sys_link+0xce>
  ilock(dp);
    80004cf6:	cfafe0ef          	jal	800031f0 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
    80004cfa:	00092703          	lw	a4,0(s2)
    80004cfe:	409c                	lw	a5,0(s1)
    80004d00:	04f71363          	bne	a4,a5,80004d46 <sys_link+0xc8>
    80004d04:	40d0                	lw	a2,4(s1)
    80004d06:	fd040593          	addi	a1,s0,-48
    80004d0a:	854a                	mv	a0,s2
    80004d0c:	c61fe0ef          	jal	8000396c <dirlink>
    80004d10:	02054b63          	bltz	a0,80004d46 <sys_link+0xc8>
  iunlockput(dp);
    80004d14:	854a                	mv	a0,s2
    80004d16:	ee4fe0ef          	jal	800033fa <iunlockput>
  iput(ip);
    80004d1a:	8526                	mv	a0,s1
    80004d1c:	e56fe0ef          	jal	80003372 <iput>
  end_op();
    80004d20:	f25fe0ef          	jal	80003c44 <end_op>
  return 0;
    80004d24:	4781                	li	a5,0
    80004d26:	64f2                	ld	s1,280(sp)
    80004d28:	6952                	ld	s2,272(sp)
    80004d2a:	a0a1                	j	80004d72 <sys_link+0xf4>
    end_op();
    80004d2c:	f19fe0ef          	jal	80003c44 <end_op>
    return -1;
    80004d30:	57fd                	li	a5,-1
    80004d32:	64f2                	ld	s1,280(sp)
    80004d34:	a83d                	j	80004d72 <sys_link+0xf4>
    iunlockput(ip);
    80004d36:	8526                	mv	a0,s1
    80004d38:	ec2fe0ef          	jal	800033fa <iunlockput>
    end_op();
    80004d3c:	f09fe0ef          	jal	80003c44 <end_op>
    return -1;
    80004d40:	57fd                	li	a5,-1
    80004d42:	64f2                	ld	s1,280(sp)
    80004d44:	a03d                	j	80004d72 <sys_link+0xf4>
    iunlockput(dp);
    80004d46:	854a                	mv	a0,s2
    80004d48:	eb2fe0ef          	jal	800033fa <iunlockput>
  ilock(ip);
    80004d4c:	8526                	mv	a0,s1
    80004d4e:	ca2fe0ef          	jal	800031f0 <ilock>
  ip->nlink--;
  ...
  iupdate(ip);
    ...
    80004d5e:	bdefe0ef          	jal	8000313c <iupdate>
  iunlockput(ip);
    80004d62:	8526                	mv	a0,s1
    80004d64:	e96fe0ef          	jal	800033fa <iunlockput>
  end_op();
    80004d68:	eddfe0ef          	jal	80003c44 <end_op>
  return -1;
    80004d6c:	57fd                	li	a5,-1
    80004d6e:	64f2                	ld	s1,280(sp)
    80004d70:	6952                	ld	s2,272(sp)
}
    80004d72:	853e                	mv	a0,a5
    80004d74:	70b2                	ld	ra,296(sp)
    80004d76:	7412                	ld	s0,288(sp)
    80004d78:	6155                	addi	sp,sp,304
    80004d7a:	8082                	ret

0000000080004d7c <sys_unlink>:
{
    80004d7c:	7151                	addi	sp,sp,-240
    80004d7e:	f586                	sd	ra,232(sp)
    80004d80:	f1a2                	sd	s0,224(sp)
    80004d82:	1980                	addi	s0,sp,240
  if(argstr(0, path, MAXPATH) < 0)
    80004d84:	08000613          	li	a2,128
    80004d88:	f3040593          	addi	a1,s0,-208
    80004d8c:	4501                	li	a0,0
    80004d8e:	a95fd0ef          	jal	80002822 <argstr>
    80004d92:	16054063          	bltz	a0,80004ef2 <sys_unlink+0x176>
    80004d96:	eda6                	sd	s1,216(sp)
  begin_op();
    80004d98:	e43fe0ef          	jal	80003bda <begin_op>
  if((dp = nameiparent(path, name)) == 0){
    80004d9c:	fb040593          	addi	a1,s0,-80
    80004da0:	f3040513          	addi	a0,s0,-208
    80004da4:	c7dfe0ef          	jal	80003a20 <nameiparent>
    80004da8:	84aa                	mv	s1,a0
    80004daa:	c945                	beqz	a0,80004e5a <sys_unlink+0xde>
  ilock(dp);
    80004dac:	c44fe0ef          	jal	800031f0 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    80004db0:	00003597          	auipc	a1,0x3
    80004db4:	81058593          	addi	a1,a1,-2032 # 800075c0 <etext+0x5c0>
    80004db8:	fb040513          	addi	a0,s0,-80
    80004dbc:	9cffe0ef          	jal	8000378a <namecmp>
    80004dc0:	10050e63          	beqz	a0,80004edc <sys_unlink+0x160>
    80004dc4:	00003597          	auipc	a1,0x3
    80004dc8:	80458593          	addi	a1,a1,-2044 # 800075c8 <etext+0x5c8>
    80004dcc:	fb040513          	addi	a0,s0,-80
    80004dd0:	9bbfe0ef          	jal	8000378a <namecmp>
    80004dd4:	10050463          	beqz	a0,80004edc <sys_unlink+0x160>
    80004dd8:	e9ca                	sd	s2,208(sp)
  if((ip = dirlookup(dp, name, &off)) == 0)
    80004dda:	f2c40613          	addi	a2,s0,-212
    80004dde:	fb040593          	addi	a1,s0,-80
    80004de2:	8526                	mv	a0,s1
    80004de4:	9bdfe0ef          	jal	800037a0 <dirlookup>
    80004de8:	892a                	mv	s2,a0
    80004dea:	0e050863          	beqz	a0,80004eda <sys_unlink+0x15e>
  ilock(ip);
    80004dee:	c02fe0ef          	jal	800031f0 <ilock>
  if(ip->nlink < 1)
    80004df2:	04a91783          	lh	a5,74(s2)
    80004df6:	06f05763          	blez	a5,80004e64 <sys_unlink+0xe8>
  if(ip->type == T_DIR && !isdirempty(ip)){
    80004dfa:	04491703          	lh	a4,68(s2)
    80004dfe:	4785                	li	a5,1
    80004e00:	06f70963          	beq	a4,a5,80004e72 <sys_unlink+0xf6>
  memset(&de, 0, sizeof(de));
    80004e04:	4641                	li	a2,16
    80004e06:	4581                	li	a1,0
    80004e08:	fc040513          	addi	a0,s0,-64
    80004e0c:	e97fb0ef          	jal	80000ca2 <memset>
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    80004e10:	4741                	li	a4,16
    80004e12:	f2c42683          	lw	a3,-212(s0)
    80004e16:	fc040613          	addi	a2,s0,-64
    80004e1a:	4581                	li	a1,0
    80004e1c:	8526                	mv	a0,s1
    80004e1e:	85ffe0ef          	jal	8000367c <writei>
    80004e22:	47c1                	li	a5,16
    80004e24:	08f51b63          	bne	a0,a5,80004eba <sys_unlink+0x13e>
  if(ip->type == T_DIR){
    80004e28:	04491703          	lh	a4,68(s2)
    80004e2c:	4785                	li	a5,1
    80004e2e:	08f70d63          	beq	a4,a5,80004ec8 <sys_unlink+0x14c>
  iunlockput(dp);
    80004e32:	8526                	mv	a0,s1
    80004e34:	dc6fe0ef          	jal	800033fa <iunlockput>
  ip->nlink--;
    80004e38:	04a95783          	lhu	a5,74(s2)
    80004e3c:	37fd                	addiw	a5,a5,-1
    80004e3e:	04f91523          	sh	a5,74(s2)
  iupdate(ip);
    80004e42:	854a                	mv	a0,s2
    80004e44:	af8fe0ef          	jal	8000313c <iupdate>
  iunlockput(ip);
    80004e48:	854a                	mv	a0,s2
    80004e4a:	db0fe0ef          	jal	800033fa <iunlockput>
  end_op();
    80004e4e:	df7fe0ef          	jal	80003c44 <end_op>
  return 0;
    80004e52:	4501                	li	a0,0
    80004e54:	64ee                	ld	s1,216(sp)
    80004e56:	694e                	ld	s2,208(sp)
    80004e58:	a849                	j	80004eea <sys_unlink+0x16e>
    end_op();
    80004e5a:	debfe0ef          	jal	80003c44 <end_op>
    return -1;
    80004e5e:	557d                	li	a0,-1
    80004e60:	64ee                	ld	s1,216(sp)
    80004e62:	a061                	j	80004eea <sys_unlink+0x16e>
    80004e64:	e5ce                	sd	s3,200(sp)
    panic("unlink: nlink < 1");
    80004e66:	00002517          	auipc	a0,0x2
    80004e6a:	76a50513          	addi	a0,a0,1898 # 800075d0 <etext+0x5d0>
    80004e6e:	973fb0ef          	jal	800007e0 <panic>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    80004e72:	04c92703          	lw	a4,76(s2)
    80004e76:	02000793          	li	a5,32
    80004e7a:	f8e7f5e3          	bgeu	a5,a4,80004e04 <sys_unlink+0x88>
    80004e7e:	e5ce                	sd	s3,200(sp)
    80004e80:	02000993          	li	s3,32
    if(readi(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    80004e84:	4741                	li	a4,16
    80004e86:	86ce                	mv	a3,s3
    80004e88:	f1840613          	addi	a2,s0,-232
    80004e8c:	4581                	li	a1,0
    80004e8e:	854a                	mv	a0,s2
    80004e90:	ef0fe0ef          	jal	80003580 <readi>
    80004e94:	47c1                	li	a5,16
    80004e96:	00f51c63          	bne	a0,a5,80004eae <sys_unlink+0x132>
    if(de.inum != 0)
    80004e9a:	f1845783          	lhu	a5,-232(s0)
    80004e9e:	efa1                	bnez	a5,80004ef6 <sys_unlink+0x17a>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    80004ea0:	29c1                	addiw	s3,s3,16
    80004ea2:	04c92783          	lw	a5,76(s2)
    80004ea6:	fcf9efe3          	bltu	s3,a5,80004e84 <sys_unlink+0x108>
    80004eaa:	69ae                	ld	s3,200(sp)
    80004eac:	bfa1                	j	80004e04 <sys_unlink+0x88>
      panic("isdirempty: readi");
    80004eae:	00002517          	auipc	a0,0x2
    80004eb2:	73a50513          	addi	a0,a0,1850 # 800075e8 <etext+0x5e8>
    80004eb6:	92bfb0ef          	jal	800007e0 <panic>
    80004eba:	e5ce                	sd	s3,200(sp)
    panic("unlink: writei");
    80004ebc:	00002517          	auipc	a0,0x2
    80004ec0:	74450513          	addi	a0,a0,1860 # 80007600 <etext+0x600>
    80004ec4:	91dfb0ef          	jal	800007e0 <panic>
    dp->nlink--;
    80004ec8:	04a4d783          	lhu	a5,74(s1)
    80004ecc:	37fd                	addiw	a5,a5,-1
    80004ece:	04f49523          	sh	a5,74(s1)
    iupdate(dp);
    80004ed2:	8526                	mv	a0,s1
    80004ed4:	a68fe0ef          	jal	8000313c <iupdate>
    80004ed8:	bfa9                	j	80004e32 <sys_unlink+0xb6>
    80004eda:	694e                	ld	s2,208(sp)
  iunlockput(dp);
    80004edc:	8526                	mv	a0,s1
    80004ede:	d1cfe0ef          	jal	800033fa <iunlockput>
  end_op();
    80004ee2:	d63fe0ef          	jal	80003c44 <end_op>
  return -1;
    80004ee6:	557d                	li	a0,-1
    80004ee8:	64ee                	ld	s1,216(sp)
}
    80004eea:	70ae                	ld	ra,232(sp)
    80004eec:	740e                	ld	s0,224(sp)
    80004eee:	616d                	addi	sp,sp,240
    80004ef0:	8082                	ret
    return -1;
    80004ef2:	557d                	li	a0,-1
    80004ef4:	bfdd                	j	80004eea <sys_unlink+0x16e>
    iunlockput(ip);
    80004ef6:	854a                	mv	a0,s2
    80004ef8:	d02fe0ef          	jal	800033fa <iunlockput>
    goto bad;
    80004efc:	694e                	ld	s2,208(sp)
    80004efe:	69ae                	ld	s3,200(sp)
    80004f00:	bff1                	j	80004edc <sys_unlink+0x160>

0000000080004f02 <sys_open>:

uint64
sys_open(void)
{
    80004f02:	7131                	addi	sp,sp,-192
    80004f04:	fd06                	sd	ra,184(sp)
    80004f06:	f922                	sd	s0,176(sp)
  ...
  argint(1, &omode);
    ...
    80004f10:	8dbfd0ef          	jal	800027ea <argint>
  if((n = argstr(0, path, MAXPATH)) < 0)
    80004f14:	08000613          	li	a2,128
    80004f18:	f5040593          	addi	a1,s0,-176
    80004f1c:	4501                	li	a0,0
    80004f1e:	905fd0ef          	jal	80002822 <argstr>
    80004f22:	87aa                	mv	a5,a0
    return -1;
    80004f24:	557d                	li	a0,-1
  if((n = argstr(0, path, MAXPATH)) < 0)
    80004f26:	0a07c263          	bltz	a5,80004fca <sys_open+0xc8>
    80004f2a:	f526                	sd	s1,168(sp)

  begin_op();
    80004f2c:	caffe0ef          	jal	80003bda <begin_op>

  if(omode & O_CREATE){
    80004f30:	f4c42783          	lw	a5,-180(s0)
    80004f34:	2007f793          	andi	a5,a5,512
    80004f38:	c3d5                	beqz	a5,80004fdc <sys_open+0xda>
    ip = create(path, T_FILE, 0, 0);
    80004f3a:	4681                	li	a3,0
    80004f3c:	4601                	li	a2,0
    80004f3e:	4589                	li	a1,2
    80004f40:	f5040513          	addi	a0,s0,-176
    80004f44:	aa9ff0ef          	jal	800049ec <create>
    80004f48:	84aa                	mv	s1,a0
    if(ip == 0){
    80004f4a:	c541                	beqz	a0,80004fd2 <sys_open+0xd0>
      end_op();
      return -1;
    }
  }
  ...
  if(ip->type == T_DEVICE && (ip->major < 0 || ip->major >= NDEV)){
    ...
    80004f50:	478d                	li	a5,3
    80004f52:	00f71763          	bne	a4,a5,80004f60 <sys_open+0x5e>
    80004f56:	0464d703          	lhu	a4,70(s1)
    80004f5a:	47a5                	li	a5,9
    80004f5c:	0ae7ed63          	bltu	a5,a4,80005016 <sys_open+0x114>
    80004f60:	f14a                	sd	s2,160(sp)
    iunlockput(ip);
    end_op();
    return -1;
  }
  ...
  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
    80004f62:	fe1fe0ef          	jal	80003f42 <filealloc>
    80004f66:	892a                	mv	s2,a0
    80004f68:	c179                	beqz	a0,8000502e <sys_open+0x12c>
    80004f6a:	ed4e                	sd	s3,152(sp)
    80004f6c:	a43ff0ef          	jal	800049ae <fdalloc>
    80004f70:	89aa                	mv	s3,a0
    80004f72:	0a054a63          	bltz	a0,80005026 <sys_open+0x124>
    iunlockput(ip);
    end_op();
    return -1;
  }
  ...
  if(ip->type == T_DEVICE){
    ...
    80004f7c:	0cf70263          	beq	a4,a5,80005040 <sys_open+0x13e>
    f->type = FD_DEVICE;
    f->major = ip->major;
  } else {
    f->type = FD_INODE;
    ...
    f->off = 0;
    80004f86:	02092023          	sw	zero,32(s2)
  }
  f->ip = ip;
    80004f8a:	00993c23          	sd	s1,24(s2)
  f->readable = !(omode & O_WRONLY);
    80004f8e:	f4c42783          	lw	a5,-180(s0)
    80004f92:	0017c713          	xori	a4,a5,1
    80004f96:	8b05                	andi	a4,a4,1
    80004f98:	00e90423          	sb	a4,8(s2)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
    80004f9c:	0037f713          	andi	a4,a5,3
    80004fa0:	00e03733          	snez	a4,a4
    80004fa4:	00e904a3          	sb	a4,9(s2)

  if((omode & O_TRUNC) && ip->type == T_FILE){
    80004fa8:	4007f793          	andi	a5,a5,1024
    80004fac:	c791                	beqz	a5,80004fb8 <sys_open+0xb6>
    80004fae:	04449703          	lh	a4,68(s1)
    80004fb2:	4789                	li	a5,2
    80004fb4:	08f70d63          	beq	a4,a5,8000504e <sys_open+0x14c>
    itrunc(ip);
  }

  iunlock(ip);
    80004fb8:	8526                	mv	a0,s1
    80004fba:	ae4fe0ef          	jal	8000329e <iunlock>
  end_op();
    80004fbe:	c87fe0ef          	jal	80003c44 <end_op>

  return fd;
    80004fc2:	854e                	mv	a0,s3
    80004fc4:	74aa                	ld	s1,168(sp)
    80004fc6:	790a                	ld	s2,160(sp)
    80004fc8:	69ea                	ld	s3,152(sp)
}
    80004fca:	70ea                	ld	ra,184(sp)
    80004fcc:	744a                	ld	s0,176(sp)
    80004fce:	6129                	addi	sp,sp,192
    80004fd0:	8082                	ret
      end_op();
    80004fd2:	c73fe0ef          	jal	80003c44 <end_op>
      return -1;
    80004fd6:	557d                	li	a0,-1
    80004fd8:	74aa                	ld	s1,168(sp)
    80004fda:	bfc5                	j	80004fca <sys_open+0xc8>
    if((ip = namei(path)) == 0){
    80004fdc:	f5040513          	addi	a0,s0,-176
    80004fe0:	a27fe0ef          	jal	80003a06 <namei>
    80004fe4:	84aa                	mv	s1,a0
    80004fe6:	c11d                	beqz	a0,8000500c <sys_open+0x10a>
    ilock(ip);
    80004fe8:	a08fe0ef          	jal	800031f0 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
    80004fec:	04449703          	lh	a4,68(s1)
    80004ff0:	4785                	li	a5,1
    80004ff2:	f4f71de3          	bne	a4,a5,80004f4c <sys_open+0x4a>
    80004ff6:	f4c42783          	lw	a5,-180(s0)
    80004ffa:	d3bd                	beqz	a5,80004f60 <sys_open+0x5e>
      iunlockput(ip);
    80004ffc:	8526                	mv	a0,s1
    80004ffe:	bfcfe0ef          	jal	800033fa <iunlockput>
      end_op();
    80005002:	c43fe0ef          	jal	80003c44 <end_op>
      return -1;
    80005006:	557d                	li	a0,-1
    80005008:	74aa                	ld	s1,168(sp)
    8000500a:	b7c1                	j	80004fca <sys_open+0xc8>
      end_op();
    8000500c:	c39fe0ef          	jal	80003c44 <end_op>
      return -1;
    80005010:	557d                	li	a0,-1
    80005012:	74aa                	ld	s1,168(sp)
    80005014:	bf5d                	j	80004fca <sys_open+0xc8>
    iunlockput(ip);
    80005016:	8526                	mv	a0,s1
    80005018:	be2fe0ef          	jal	800033fa <iunlockput>
    end_op();
    8000501c:	c29fe0ef          	jal	80003c44 <end_op>
    return -1;
    80005020:	557d                	li	a0,-1
    80005022:	74aa                	ld	s1,168(sp)
    80005024:	b75d                	j	80004fca <sys_open+0xc8>
      fileclose(f);
    80005026:	854a                	mv	a0,s2
    80005028:	fbffe0ef          	jal	80003fe6 <fileclose>
    8000502c:	69ea                	ld	s3,152(sp)
    iunlockput(ip);
    8000502e:	8526                	mv	a0,s1
    80005030:	bcafe0ef          	jal	800033fa <iunlockput>
    end_op();
    80005034:	c11fe0ef          	jal	80003c44 <end_op>
    return -1;
    80005038:	557d                	li	a0,-1
    8000503a:	74aa                	ld	s1,168(sp)
    8000503c:	790a                	ld	s2,160(sp)
    8000503e:	b771                	j	80004fca <sys_open+0xc8>
    f->type = FD_DEVICE;
    80005040:	00f92023          	sw	a5,0(s2)
    f->major = ip->major;
    80005044:	04649783          	lh	a5,70(s1)
    80005048:	02f91223          	sh	a5,36(s2)
    8000504c:	bf3d                	j	80004f8a <sys_open+0x88>
    itrunc(ip);
    8000504e:	8526                	mv	a0,s1
    80005050:	a8efe0ef          	jal	800032de <itrunc>
    80005054:	b795                	j	80004fb8 <sys_open+0xb6>

0000000080005056 <sys_mkdir>:

uint64
sys_mkdir(void)
{
    80005056:	7175                	addi	sp,sp,-144
    80005058:	e506                	sd	ra,136(sp)
    8000505a:	e122                	sd	s0,128(sp)
    8000505c:	0900                	addi	s0,sp,144
  char path[MAXPATH];
  struct inode *ip;

  begin_op();
    8000505e:	b7dfe0ef          	jal	80003bda <begin_op>
  if(argstr(0, path, MAXPATH) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    80005062:	08000613          	li	a2,128
    80005066:	f7040593          	addi	a1,s0,-144
    8000506a:	4501                	li	a0,0
    8000506c:	fb6fd0ef          	jal	80002822 <argstr>
    80005070:	02054363          	bltz	a0,80005096 <sys_mkdir+0x40>
    80005074:	4681                	li	a3,0
    80005076:	4601                	li	a2,0
    80005078:	4585                	li	a1,1
    8000507a:	f7040513          	addi	a0,s0,-144
    8000507e:	96fff0ef          	jal	800049ec <create>
    80005082:	c911                	beqz	a0,80005096 <sys_mkdir+0x40>
    end_op();
    return -1;
  }
  iunlockput(ip);
    80005084:	b76fe0ef          	jal	800033fa <iunlockput>
  end_op();
    80005088:	bbdfe0ef          	jal	80003c44 <end_op>
  return 0;
    8000508c:	4501                	li	a0,0
}
    8000508e:	60aa                	ld	ra,136(sp)
    80005090:	640a                	ld	s0,128(sp)
    80005092:	6149                	addi	sp,sp,144
    80005094:	8082                	ret
    end_op();
    80005096:	baffe0ef          	jal	80003c44 <end_op>
    return -1;
    8000509a:	557d                	li	a0,-1
    8000509c:	bfcd                	j	8000508e <sys_mkdir+0x38>

000000008000509e <sys_mknod>:

uint64
sys_mknod(void)
{
    8000509e:	7135                	addi	sp,sp,-160
    800050a0:	ed06                	sd	ra,152(sp)
    800050a2:	e922                	sd	s0,144(sp)
  ...
  begin_op();
    800050a6:	b35fe0ef          	jal	80003bda <begin_op>
  argint(1, &major);
    800050aa:	f6c40593          	addi	a1,s0,-148
    800050ae:	4505                	li	a0,1
    800050b0:	f3afd0ef          	jal	800027ea <argint>
  argint(2, &minor);
    800050b4:	f6840593          	addi	a1,s0,-152
    800050b8:	4509                	li	a0,2
    800050ba:	f30fd0ef          	jal	800027ea <argint>
  if((argstr(0, path, MAXPATH)) < 0 ||
    800050be:	08000613          	li	a2,128
    800050c2:	f7040593          	addi	a1,s0,-144
    800050c6:	4501                	li	a0,0
    800050c8:	f5afd0ef          	jal	80002822 <argstr>
    800050cc:	02054563          	bltz	a0,800050f6 <sys_mknod+0x58>
     (ip = create(path, T_DEVICE, major, minor)) == 0){
    800050d0:	f6841683          	lh	a3,-152(s0)
    800050d4:	f6c41603          	lh	a2,-148(s0)
    800050d8:	458d                	li	a1,3
    800050da:	f7040513          	addi	a0,s0,-144
    800050de:	90fff0ef          	jal	800049ec <create>
  if((argstr(0, path, MAXPATH)) < 0 ||
    800050e2:	c911                	beqz	a0,800050f6 <sys_mknod+0x58>
    end_op();
    return -1;
  }
  iunlockput(ip);
    800050e4:	b16fe0ef          	jal	800033fa <iunlockput>
  end_op();
    800050e8:	b5dfe0ef          	jal	80003c44 <end_op>
  return 0;
    800050ec:	4501                	li	a0,0
}
    800050ee:	60ea                	ld	ra,152(sp)
    800050f0:	644a                	ld	s0,144(sp)
    800050f2:	610d                	addi	sp,sp,160
    800050f4:	8082                	ret
    end_op();
    800050f6:	b4ffe0ef          	jal	80003c44 <end_op>
    return -1;
    800050fa:	557d                	li	a0,-1
    800050fc:	bfcd                	j	800050ee <sys_mknod+0x50>

00000000800050fe <sys_chdir>:

uint64
sys_chdir(void)
{
    800050fe:	7135                	addi	sp,sp,-160
    80005100:	ed06                	sd	ra,152(sp)
    80005102:	e922                	sd	s0,144(sp)
    80005104:	e14a                	sd	s2,128(sp)
    80005106:	1100                	addi	s0,sp,160
  char path[MAXPATH];
  struct inode *ip;
  struct proc *p = myproc();
    80005108:	fc6fc0ef          	jal	800018ce <myproc>
    8000510c:	892a                	mv	s2,a0
  
  begin_op();
    8000510e:	acdfe0ef          	jal	80003bda <begin_op>
  if(argstr(0, path, MAXPATH) < 0 || (ip = namei(path)) == 0){
    80005112:	08000613          	li	a2,128
    80005116:	f6040593          	addi	a1,s0,-160
    8000511a:	4501                	li	a0,0
    8000511c:	f06fd0ef          	jal	80002822 <argstr>
    80005120:	04054363          	bltz	a0,80005166 <sys_chdir+0x68>
    80005124:	e526                	sd	s1,136(sp)
    80005126:	f6040513          	addi	a0,s0,-160
    8000512a:	8ddfe0ef          	jal	80003a06 <namei>
    8000512e:	84aa                	mv	s1,a0
    80005130:	c915                	beqz	a0,80005164 <sys_chdir+0x66>
    end_op();
    return -1;
  }
  ilock(ip);
    80005132:	8befe0ef          	jal	800031f0 <ilock>
  if(ip->type != T_DIR){
    80005136:	04449703          	lh	a4,68(s1)
    8000513a:	4785                	li	a5,1
    8000513c:	02f71963          	bne	a4,a5,8000516e <sys_chdir+0x70>
    iunlockput(ip);
    end_op();
    return -1;
  }
  iunlock(ip);
    ...
    80005142:	95cfe0ef          	jal	8000329e <iunlock>
  iput(p->cwd);
    80005146:	15093503          	ld	a0,336(s2)
    8000514a:	a28fe0ef          	jal	80003372 <iput>
  end_op();
    8000514e:	af7fe0ef          	jal	80003c44 <end_op>
  p->cwd = ip;
    80005152:	14993823          	sd	s1,336(s2)
  return 0;
    80005156:	4501                	li	a0,0
    80005158:	64aa                	ld	s1,136(sp)
}
    8000515a:	60ea                	ld	ra,152(sp)
    8000515c:	644a                	ld	s0,144(sp)
    8000515e:	690a                	ld	s2,128(sp)
    80005160:	610d                	addi	sp,sp,160
    80005162:	8082                	ret
    80005164:	64aa                	ld	s1,136(sp)
    end_op();
    80005166:	adffe0ef          	jal	80003c44 <end_op>
    return -1;
    8000516a:	557d                	li	a0,-1
    8000516c:	b7fd                	j	8000515a <sys_chdir+0x5c>
    iunlockput(ip);
    8000516e:	8526                	mv	a0,s1
    80005170:	a8afe0ef          	jal	800033fa <iunlockput>
    end_op();
    80005174:	ad1fe0ef          	jal	80003c44 <end_op>
    return -1;
    80005178:	557d                	li	a0,-1
    8000517a:	64aa                	ld	s1,136(sp)
    8000517c:	bff9                	j	8000515a <sys_chdir+0x5c>
...
sys_exec(void)
{
    8000517e:	7121                	addi	sp,sp,-448
    80005180:	ff06                	sd	ra,440(sp)
    80005182:	fb22                	sd	s0,432(sp)
    80005184:	0380                	addi	s0,sp,448
  char path[MAXPATH], *argv[MAXARG];
  int i;
  uint64 uargv, uarg;

  argaddr(1, &uargv);
    80005186:	e4840593          	addi	a1,s0,-440
    8000518a:	4505                	li	a0,1
    8000518c:	e7afd0ef          	jal	80002806 <argaddr>
  if(argstr(0, path, MAXPATH) < 0) {
    80005190:	08000613          	li	a2,128
    80005194:	f5040593          	addi	a1,s0,-176
    80005198:	4501                	li	a0,0
    8000519a:	e88fd0ef          	jal	80002822 <argstr>
    8000519e:	87aa                	mv	a5,a0
    return -1;
    800051a0:	557d                	li	a0,-1
  if(argstr(0, path, MAXPATH) < 0) {
    800051a2:	0c07c463          	bltz	a5,8000526a <sys_exec+0xec>
    800051a6:	f726                	sd	s1,424(sp)
    800051a8:	f34a                	sd	s2,416(sp)
    800051aa:	ef4e                	sd	s3,408(sp)
    800051ac:	eb52                	sd	s4,400(sp)
  }
  memset(argv, 0, sizeof(argv));
    800051ae:	10000613          	li	a2,256
    800051b2:	4581                	li	a1,0
    800051b4:	e5040513          	addi	a0,s0,-432
    800051b8:	aebfb0ef          	jal	80000ca2 <memset>
  for(i=0;; i++){
    if(i >= NELEM(argv)){
    800051bc:	e5040493          	addi	s1,s0,-432
  memset(argv, 0, sizeof(argv));
    ...
    800051c8:	00391513          	slli	a0,s2,0x3
    800051cc:	e4040593          	addi	a1,s0,-448
    800051d0:	e4843783          	ld	a5,-440(s0)
    800051d4:	953e                	add	a0,a0,a5
    800051d6:	d8afd0ef          	jal	80002760 <fetchaddr>
    800051da:	02054663          	bltz	a0,80005206 <sys_exec+0x88>
      goto bad;
    }
    if(uarg == 0){
    800051de:	e4043783          	ld	a5,-448(s0)
    800051e2:	c3a9                	beqz	a5,80005224 <sys_exec+0xa6>
      argv[i] = 0;
      break;
    }
    argv[i] = kalloc();
    800051e4:	91bfb0ef          	jal	80000afe <kalloc>
    800051e8:	85aa                	mv	a1,a0
    800051ea:	00a9b023          	sd	a0,0(s3)
    if(argv[i] == 0)
    800051ee:	cd01                	beqz	a0,80005206 <sys_exec+0x88>
      goto bad;
    if(fetchstr(uarg, argv[i], PGSIZE) < 0)
    800051f0:	6605                	lui	a2,0x1
    800051f2:	e4043503          	ld	a0,-448(s0)
    800051f6:	db4fd0ef          	jal	800027aa <fetchstr>
    800051fa:	00054663          	bltz	a0,80005206 <sys_exec+0x88>
    if(i >= NELEM(argv)){
    800051fe:	0905                	addi	s2,s2,1
    80005200:	09a1                	addi	s3,s3,8
    80005202:	fd4913e3          	bne	s2,s4,800051c8 <sys_exec+0x4a>
    kfree(argv[i]);
 ...
 bad:
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80005206:	f5040913          	addi	s2,s0,-176
    8000520a:	6088                	ld	a0,0(s1)
    8000520c:	c931                	beqz	a0,80005260 <sys_exec+0xe2>
    kfree(argv[i]);
    8000520e:	80ffb0ef          	jal	80000a1c <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80005212:	04a1                	addi	s1,s1,8
    80005214:	ff249be3          	bne	s1,s2,8000520a <sys_exec+0x8c>
  return -1;
    80005218:	557d                	li	a0,-1
    8000521a:	74ba                	ld	s1,424(sp)
    8000521c:	791a                	ld	s2,416(sp)
    8000521e:	69fa                	ld	s3,408(sp)
    80005220:	6a5a                	ld	s4,400(sp)
    80005222:	a0a1                	j	8000526a <sys_exec+0xec>
      argv[i] = 0;
    80005224:	0009079b          	sext.w	a5,s2
    80005228:	078e                	slli	a5,a5,0x3
    8000522a:	fd078793          	addi	a5,a5,-48
    8000522e:	97a2                	add	a5,a5,s0
    80005230:	e807b023          	sd	zero,-384(a5)
  int ret = kexec(path, argv);
    80005234:	e5040593          	addi	a1,s0,-432
    80005238:	f5040513          	addi	a0,s0,-176
    8000523c:	ba8ff0ef          	jal	800045e4 <kexec>
    80005240:	892a                	mv	s2,a0
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80005242:	f5040993          	addi	s3,s0,-176
    80005246:	6088                	ld	a0,0(s1)
    80005248:	c511                	beqz	a0,80005254 <sys_exec+0xd6>
    kfree(argv[i]);
    8000524a:	fd2fb0ef          	jal	80000a1c <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    8000524e:	04a1                	addi	s1,s1,8
    80005250:	ff349be3          	bne	s1,s3,80005246 <sys_exec+0xc8>
  return ret;
    80005254:	854a                	mv	a0,s2
    80005256:	74ba                	ld	s1,424(sp)
    80005258:	791a                	ld	s2,416(sp)
    8000525a:	69fa                	ld	s3,408(sp)
    8000525c:	6a5a                	ld	s4,400(sp)
    8000525e:	a031                	j	8000526a <sys_exec+0xec>
  return -1;
    80005260:	557d                	li	a0,-1
    80005262:	74ba                	ld	s1,424(sp)
    80005264:	791a                	ld	s2,416(sp)
    80005266:	69fa                	ld	s3,408(sp)
    80005268:	6a5a                	ld	s4,400(sp)
}
    8000526a:	70fa                	ld	ra,440(sp)
    8000526c:	745a                	ld	s0,432(sp)
    8000526e:	6139                	addi	sp,sp,448
    80005270:	8082                	ret

0000000080005272 <sys_pipe>:

uint64
sys_pipe(void)
{
    80005272:	7139                	addi	sp,sp,-64
    80005274:	fc06                	sd	ra,56(sp)
    80005276:	f822                	sd	s0,48(sp)
    80005278:	f426                	sd	s1,40(sp)
    8000527a:	0080                	addi	s0,sp,64
  uint64 fdarray; // user pointer to array of two integers
  struct file *rf, *wf;
  int fd0, fd1;
  struct proc *p = myproc();
    8000527c:	e52fc0ef          	jal	800018ce <myproc>
    80005280:	84aa                	mv	s1,a0

  argaddr(0, &fdarray);
    80005282:	fd840593          	addi	a1,s0,-40
    80005286:	4501                	li	a0,0
    80005288:	d7efd0ef          	jal	80002806 <argaddr>
  if(pipealloc(&rf, &wf) < 0)
    8000528c:	fc840593          	addi	a1,s0,-56
    80005290:	fd040513          	addi	a0,s0,-48
    80005294:	85cff0ef          	jal	800042f0 <pipealloc>
    return -1;
    80005298:	57fd                	li	a5,-1
  if(pipealloc(&rf, &wf) < 0)
    8000529a:	0a054463          	bltz	a0,80005342 <sys_pipe+0xd0>
  fd0 = -1;
    8000529e:	fcf42223          	sw	a5,-60(s0)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    800052a2:	fd043503          	ld	a0,-48(s0)
    800052a6:	f08ff0ef          	jal	800049ae <fdalloc>
    800052aa:	fca42223          	sw	a0,-60(s0)
    800052ae:	08054163          	bltz	a0,80005330 <sys_pipe+0xbe>
    800052b2:	fc843503          	ld	a0,-56(s0)
    800052b6:	ef8ff0ef          	jal	800049ae <fdalloc>
    800052ba:	fca42023          	sw	a0,-64(s0)
    800052be:	06054063          	bltz	a0,8000531e <sys_pipe+0xac>
      p->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    800052c4:	fc440613          	addi	a2,s0,-60
    800052c8:	fd843583          	ld	a1,-40(s0)
    800052cc:	68a8                	ld	a0,80(s1)
    800052ce:	b14fc0ef          	jal	800015e2 <copyout>
    800052d2:	00054e63          	bltz	a0,800052ee <sys_pipe+0x7c>
     copyout(p->pagetable, fdarray+sizeof(fd0), (char *)&fd1, sizeof(fd1)) < 0){
    800052d6:	4691                	li	a3,4
    800052d8:	fc040613          	addi	a2,s0,-64
    800052dc:	fd843583          	ld	a1,-40(s0)
    800052e0:	0591                	addi	a1,a1,4
    800052e2:	68a8                	ld	a0,80(s1)
    800052e4:	afefc0ef          	jal	800015e2 <copyout>
    p->ofile[fd1] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    800052ea:	04055c63          	bgez	a0,80005342 <sys_pipe+0xd0>
    p->ofile[fd0] = 0;
    ...
    80005304:	94be                	add	s1,s1,a5
    80005306:	0004b023          	sd	zero,0(s1)
    fileclose(rf);
    8000530a:	fd043503          	ld	a0,-48(s0)
    8000530e:	cd9fe0ef          	jal	80003fe6 <fileclose>
    fileclose(wf);
    80005312:	fc843503          	ld	a0,-56(s0)
    80005316:	cd1fe0ef          	jal	80003fe6 <fileclose>
    return -1;
    8000531a:	57fd                	li	a5,-1
    8000531c:	a01d                	j	80005342 <sys_pipe+0xd0>
    if(fd0 >= 0)
    8000531e:	fc442783          	lw	a5,-60(s0)
    80005322:	0007c763          	bltz	a5,80005330 <sys_pipe+0xbe>
      p->ofile[fd0] = 0;
    ...
    80005334:	cb3fe0ef          	jal	80003fe6 <fileclose>
    fileclose(wf);
    80005338:	fc843503          	ld	a0,-56(s0)
    8000533c:	cabfe0ef          	jal	80003fe6 <fileclose>
    return -1;
...
kernelvec:
    ...
    80005374:	f9fe                	sd	t6,240(sp)
        ...
        call kerneltrap
    80005376:	afafd0ef          	jal	80002670 <kerneltrap>
...
free_desc(int i)
{
  ...
  if(disk.free[i])
    ...
    80005454:	7d878793          	addi	a5,a5,2008 # 80020c28 <disk>
  ...
  disk.desc[i].addr = 0;
    ...
    80005468:	7c478793          	addi	a5,a5,1988 # 80020c28 <disk>
  ...
  wakeup(&disk.free[0]);
    ...
    80005490:	7b450513          	addi	a0,a0,1972 # 80020c40 <disk+0x18>
    80005494:	a99fc0ef          	jal	80001f2c <wakeup>
}
...
00000000800054b8 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    800054cc:	0001c517          	auipc	a0,0x1c
    800054d0:	88450513          	addi	a0,a0,-1916 # 80020d50 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_STATUS) = status;
  ...
  features &= ~(1 << VIRTIO_RING_F_INDIRECT_DESC);
    ...
    80005538:	75f70713          	addi	a4,a4,1887 # ffffffffc7ffe75f <end+0xffffffff47fdd9f7>
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  disk.desc = kalloc();
    ...
    8000558e:	69e48493          	addi	s1,s1,1694 # 80020c28 <disk>
  ...
  if(!disk.desc || !disk.avail || !disk.used)
    ...
    800055ac:	68873703          	ld	a4,1672(a4) # 80020c30 <disk+0x8>
  ...
  memset(disk.avail, 0, PGSIZE);
    ...
    800055c4:	66848493          	addi	s1,s1,1640 # 80020c28 <disk>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800056e0:	67450513          	addi	a0,a0,1652 # 80020d50 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    800056f0:	53cb0b13          	addi	s6,s6,1340 # 80020c28 <disk>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    800056fa:	65ac0c13          	addi	s8,s8,1626 # 80020d50 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    8000571c:	51070713          	addi	a4,a4,1296 # 80020c28 <disk>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80005754:	4f050513          	addi	a0,a0,1264 # 80020c40 <disk+0x18>
    80005758:	f88fc0ef          	jal	80001ee0 <sleep>
  for(int i = 0; i < 3; i++){
  ...
  if(write)
    ...
    80005770:	4bc78793          	addi	a5,a5,1212 # 80020c28 <disk>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    80005846:	50e90913          	addi	s2,s2,1294 # 80020d50 <disk+0x128>
  while(b->disk == 1) {
    ...
    80005854:	e8cfc0ef          	jal	80001ee0 <sleep>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    8000586e:	3be78793          	addi	a5,a5,958 # 80020c28 <disk>
    80005872:	97ba                	add	a5,a5,a4
    80005874:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    80005878:	0001b997          	auipc	s3,0x1b
    8000587c:	3b098993          	addi	s3,s3,944 # 80020c28 <disk>
  ...
  release(&disk.vdisk_lock);
    ...
    800058a0:	4b450513          	addi	a0,a0,1204 # 80020d50 <disk+0x128>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800058d0:	35c48493          	addi	s1,s1,860 # 80020c28 <disk>
    800058d4:	0001b517          	auipc	a0,0x1b
    800058d8:	47c50513          	addi	a0,a0,1148 # 80020d50 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  while(disk.used_idx != disk.used->idx){
    ...
    wakeup(b);
    8000592c:	e00fc0ef          	jal	80001f2c <wakeup>
  ...
  release(&disk.vdisk_lock);
    ...
    8000594c:	40850513          	addi	a0,a0,1032 # 80020d50 <disk+0x128>
